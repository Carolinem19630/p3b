...
int main(int argc, char *argv[])
{
  ...
  1b:	68 00 20 00 00       	push   $0x2000
   ppid = getpid();
  20:	a3 84 0e 00 00       	mov    %eax,0xe84
   void *stack, *p = malloc(PGSIZE * 2);
  ...
  4d:	e8 34 05 00 00       	call   586 <open>
   assert(fd == 3);
  ...
  8f:	5e                   	pop    %esi
  90:	ff 35 84 0e 00 00    	push   0xe84
  96:	e8 db 04 00 00       	call   576 <kill>
  9b:	e8 a6 04 00 00       	call   546 <exit>
     stack = p + (PGSIZE - (uint)p % PGSIZE);
  ...
  b6:	e8 2b 05 00 00       	call   5e6 <clone>
   assert(clone_pid > 0);
  ...
  cf:	90                   	nop
   while(!newfd);
  d0:	a1 80 0e 00 00       	mov    0xe80,%eax
  d5:	85 c0                	test   %eax,%eax
  d7:	74 f7                	je     d0 <main+0xd0>
   assert(write(newfd, "goodbye\n", 8) == -1);
  d9:	a1 80 0e 00 00       	mov    0xe80,%eax
  de:	52                   	push   %edx
  df:	6a 08                	push   $0x8
  e1:	68 56 0a 00 00       	push   $0xa56
  e6:	50                   	push   %eax
  e7:	e8 7a 04 00 00       	call   566 <write>
 ...
 128:	e8 c1 04 00 00       	call   5ee <join>
 ...
 198:	e8 b3 06 00 00       	call   850 <free>
   exit();
 19d:	e8 a4 03 00 00       	call   546 <exit>
...
worker(void *arg1, void *arg2) {
 ...
 1bd:	6a 03                	push   $0x3
 1bf:	e8 a2 03 00 00       	call   566 <write>
 ...
 201:	58                   	pop    %eax
 202:	ff 35 84 0e 00 00    	push   0xe84
 208:	e8 69 03 00 00       	call   576 <kill>
 20d:	e8 34 03 00 00       	call   546 <exit>
   xchg(&newfd, open("tmp2", O_WRONLY|O_CREATE));
 212:	50                   	push   %eax
 213:	50                   	push   %eax
 214:	68 01 02 00 00       	push   $0x201
 219:	68 2d 0a 00 00       	push   $0xa2d
 21e:	e8 63 03 00 00       	call   586 <open>
xchg(volatile uint *addr, uint newval)
{
 ...
 223:	f0 87 05 80 0e 00 00 	lock xchg %eax,0xe80
   exit();
 22a:	e8 17 03 00 00       	call   546 <exit>
 22f:	90                   	nop
 ...
 359:	31 db                	xor    %ebx,%ebx
{
 ...
 365:	57                   	push   %edi
 366:	6a 00                	push   $0x0
 368:	e8 f1 01 00 00       	call   55e <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 3cd:	e8 b4 01 00 00       	call   586 <open>
  if(fd < 0)
 ...
 3e1:	50                   	push   %eax
 3e2:	e8 b7 01 00 00       	call   59e <fstat>
  close(fd);
 3e7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 3ea:	89 c6                	mov    %eax,%esi
  close(fd);
 3ec:	e8 7d 01 00 00       	call   56e <close>
  return r;
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2) {
 ...
 4b2:	e8 2f 01 00 00       	call   5e6 <clone>
...
int thread_join() {
 4d7:	83 ec 20             	sub    $0x20,%esp
  int childpid = join(&stack);
 4da:	50                   	push   %eax
 4db:	e8 0e 01 00 00       	call   5ee <join>
 4e0:	89 c3                	mov    %eax,%ebx
  free(stack);
 4e2:	58                   	pop    %eax
 4e3:	ff 75 f4             	push   -0xc(%ebp)
 4e6:	e8 65 03 00 00       	call   850 <free>
  return childpid;
}
