...
int main(int argc, char *argv[])
{
  ...
  10:	83 ec 1c             	sub    $0x1c,%esp
   ppid = getpid();
  13:	e8 eb 04 00 00       	call   503 <getpid>
   void *stack, *p = malloc(PGSIZE * 2);
  18:	83 ec 0c             	sub    $0xc,%esp
  1b:	68 00 20 00 00       	push   $0x2000
   ppid = getpid();
  20:	a3 18 0d 00 00       	mov    %eax,0xd18
   void *stack, *p = malloc(PGSIZE * 2);
  ...
  48:	68 7c 09 00 00       	push   $0x97c
  4d:	e8 71 04 00 00       	call   4c3 <open>
   assert(fd == 3);
  52:	83 c4 10             	add    $0x10,%esp
  55:	83 f8 03             	cmp    $0x3,%eax
  58:	74 52                	je     ac <main+0xac>
  5a:	6a 24                	push   $0x24
  5c:	68 1f 09 00 00       	push   $0x91f
  61:	68 28 09 00 00       	push   $0x928
  66:	6a 01                	push   $0x1
  68:	e8 83 05 00 00       	call   5f0 <printf>
  6d:	83 c4 0c             	add    $0xc,%esp
  70:	68 80 09 00 00       	push   $0x980
  75:	68 4c 09 00 00       	push   $0x94c
  7a:	6a 01                	push   $0x1
  7c:	e8 6f 05 00 00       	call   5f0 <printf>
  81:	59                   	pop    %ecx
  82:	5b                   	pop    %ebx
  83:	68 60 09 00 00       	push   $0x960
  88:	6a 01                	push   $0x1
  8a:	e8 61 05 00 00       	call   5f0 <printf>
  8f:	5e                   	pop    %esi
  90:	ff 35 18 0d 00 00    	push   0xd18
  96:	e8 18 04 00 00       	call   4b3 <kill>
  9b:	e8 e3 03 00 00       	call   483 <exit>
     stack = p + (PGSIZE - (uint)p % PGSIZE);
  ...
  b6:	e8 68 04 00 00       	call   523 <clone>
   assert(clone_pid > 0);
...
worker(void *arg1, void *arg2) {
 ...
 1b6:	6a 06                	push   $0x6
 1b8:	68 18 09 00 00       	push   $0x918
 1bd:	6a 03                	push   $0x3
 1bf:	e8 df 02 00 00       	call   4a3 <write>
 1c4:	83 c4 10             	add    $0x10,%esp
 1c7:	83 f8 06             	cmp    $0x6,%eax
 1ca:	74 46                	je     212 <worker+0x62>
 1cc:	6a 34                	push   $0x34
 1ce:	68 1f 09 00 00       	push   $0x91f
 1d3:	68 28 09 00 00       	push   $0x928
 1d8:	6a 01                	push   $0x1
 1da:	e8 11 04 00 00       	call   5f0 <printf>
 1df:	83 c4 0c             	add    $0xc,%esp
 1e2:	68 30 09 00 00       	push   $0x930
 1e7:	68 4c 09 00 00       	push   $0x94c
 1ec:	6a 01                	push   $0x1
 1ee:	e8 fd 03 00 00       	call   5f0 <printf>
 1f3:	5a                   	pop    %edx
 1f4:	59                   	pop    %ecx
 1f5:	68 60 09 00 00       	push   $0x960
 1fa:	6a 01                	push   $0x1
 1fc:	e8 ef 03 00 00       	call   5f0 <printf>
 201:	58                   	pop    %eax
 202:	ff 35 18 0d 00 00    	push   0xd18
 208:	e8 a6 02 00 00       	call   4b3 <kill>
 20d:	e8 71 02 00 00       	call   483 <exit>
   xchg(&newfd, open("tmp2", O_WRONLY|O_CREATE));
 212:	50                   	push   %eax
 213:	50                   	push   %eax
 214:	68 01 02 00 00       	push   $0x201
 219:	68 6d 09 00 00       	push   $0x96d
 21e:	e8 a0 02 00 00       	call   4c3 <open>
xchg(volatile uint *addr, uint newval)
{
 ...
 223:	f0 87 05 14 0d 00 00 	lock xchg %eax,0xd14
   exit();
 22a:	e8 54 02 00 00       	call   483 <exit>
 22f:	90                   	nop
 ...
 54c:	89 d1                	mov    %edx,%ecx
{
 ...
 579:	0f b6 92 48 0a 00 00 	movzbl 0xa48(%edx),%edx
 ...
 5f9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 669:	ff 24 85 f0 09 00 00 	jmp    *0x9f0(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 777:	90                   	nop
          s = "(null)";
 778:	ba e7 09 00 00       	mov    $0x9e7,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 791:	a1 1c 0d 00 00       	mov    0xd1c,%eax
{
 ...
 7d1:	5b                   	pop    %ebx
  freep = p;
 7d2:	89 15 1c 0d 00 00    	mov    %edx,0xd1c
}
 7d8:	5e                   	pop    %esi
 7d9:	5f                   	pop    %edi
 7da:	5d                   	pop    %ebp
 ...
 809:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 80c:	89 15 1c 0d 00 00    	mov    %edx,0xd1c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 829:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 82c:	8b 3d 1c 0d 00 00    	mov    0xd1c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 86f:	73 4f                	jae    8c0 <malloc+0xa0>
    ...
    if(p == freep)
 871:	8b 3d 1c 0d 00 00    	mov    0xd1c,%edi
 ...
 89a:	e8 f1 fe ff ff       	call   790 <free>
  return freep;
 89f:	8b 15 1c 0d 00 00    	mov    0xd1c,%edx
 ...
 8df:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 8e0:	c7 05 1c 0d 00 00 20 	movl   $0xd20,0xd1c
 8e7:	0d 00 00 
    base.s.size = 0;
 8ea:	bf 20 0d 00 00       	mov    $0xd20,%edi
    base.s.ptr = freep = prevp = &base;
 8ef:	c7 05 20 0d 00 00 20 	movl   $0xd20,0xd20
 8f6:	0d 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 8f9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 8fb:	c7 05 24 0d 00 00 00 	movl   $0x0,0xd24
 902:	00 00 00 
    if(p->s.size >= nunits){
