...
main(int argc, char *argv[])
{
   ...
   ppid = getpid();
  11:	e8 60 04 00 00       	call   476 <getpid>
  16:	a3 a8 0c 00 00       	mov    %eax,0xca8

   int fork_pid = fork();
  1b:	e8 ce 03 00 00       	call   3ee <fork>
   if(fork_pid == 0) {
  ...
  2c:	50                   	push   %eax
  2d:	e8 6c 04 00 00       	call   49e <join>
   assert(join_pid == -1);
  ...
  6f:	58                   	pop    %eax
  70:	ff 35 a8 0c 00 00    	push   0xca8
  76:	e8 ab 03 00 00       	call   426 <kill>
  7b:	e8 76 03 00 00       	call   3f6 <exit>
   assert(fork_pid > 0);
  80:	6a 1e                	push   $0x1e
  ...
  9b:	eb b8                	jmp    55 <main+0x55>
     exit();
  9d:	e8 54 03 00 00       	call   3f6 <exit>

   assert(wait() > 0);
  a2:	e8 57 03 00 00       	call   3fe <wait>
  ...
  b4:	e8 a7 04 00 00       	call   560 <printf>
   exit();
  b9:	e8 38 03 00 00       	call   3f6 <exit>
   assert(wait() > 0);
  be:	6a 24                	push   $0x24
 ...
 209:	31 db                	xor    %ebx,%ebx
{
 ...
 215:	57                   	push   %edi
 216:	6a 00                	push   $0x0
 218:	e8 f1 01 00 00       	call   40e <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 27d:	e8 b4 01 00 00       	call   436 <open>
  if(fd < 0)
 ...
 291:	50                   	push   %eax
 292:	e8 b7 01 00 00       	call   44e <fstat>
  close(fd);
 297:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 29a:	89 c6                	mov    %eax,%esi
  close(fd);
 29c:	e8 7d 01 00 00       	call   41e <close>
  return r;
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2) {
 ...
 349:	81 e2 ff 0f 00 00    	and    $0xfff,%edx
 34f:	74 07                	je     358 <thread_create+0x28>
    stack = stack + (PGSIZE - (uint)stack % PGSIZE);
 351:	29 d0                	sub    %edx,%eax
 353:	05 00 10 00 00       	add    $0x1000,%eax
 ...
 362:	e8 2f 01 00 00       	call   496 <clone>
...
int thread_join() {
 387:	83 ec 20             	sub    $0x20,%esp
  int childpid = join(&stack);
 38a:	50                   	push   %eax
 38b:	e8 0e 01 00 00       	call   49e <join>
 390:	89 c3                	mov    %eax,%ebx
  free(stack);
 392:	58                   	pop    %eax
 393:	ff 75 f4             	push   -0xc(%ebp)
 396:	e8 65 03 00 00       	call   700 <free>
  return childpid;
}
 39b:	89 d8                	mov    %ebx,%eax
 39d:	8b 5d fc             	mov    -0x4(%ebp),%ebx
 3a0:	c9                   	leave  
 3a1:	c3                   	ret    
...
free(void *ap)
{
 ...
 701:	a1 ac 0c 00 00       	mov    0xcac,%eax
{
 ...
 741:	5b                   	pop    %ebx
  freep = p;
 742:	89 15 ac 0c 00 00    	mov    %edx,0xcac
}
 748:	5e                   	pop    %esi
 749:	5f                   	pop    %edi
 74a:	5d                   	pop    %ebp
 ...
 779:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 77c:	89 15 ac 0c 00 00    	mov    %edx,0xcac
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 799:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 79c:	8b 3d ac 0c 00 00    	mov    0xcac,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7df:	73 4f                	jae    830 <malloc+0xa0>
    ...
    if(p == freep)
 7e1:	8b 3d ac 0c 00 00    	mov    0xcac,%edi
 ...
 80a:	e8 f1 fe ff ff       	call   700 <free>
  return freep;
 80f:	8b 15 ac 0c 00 00    	mov    0xcac,%edx
 ...
 83c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 83f:	89 15 ac 0c 00 00    	mov    %edx,0xcac
}
 ...
 84f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 850:	c7 05 ac 0c 00 00 b0 	movl   $0xcb0,0xcac
 857:	0c 00 00 
    base.s.size = 0;
 85a:	bf b0 0c 00 00       	mov    $0xcb0,%edi
    base.s.ptr = freep = prevp = &base;
 85f:	c7 05 b0 0c 00 00 b0 	movl   $0xcb0,0xcb0
 866:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 869:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 86b:	c7 05 b4 0c 00 00 00 	movl   $0x0,0xcb4
 872:	00 00 00 
    if(p->s.size >= nunits){
