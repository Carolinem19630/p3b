...
main(int argc, char *argv[])
{
   ...
   ppid = getpid();
  11:	e8 9d 03 00 00       	call   3b3 <getpid>
  16:	a3 3c 0b 00 00       	mov    %eax,0xb3c

   int fork_pid = fork();
  1b:	e8 0b 03 00 00       	call   32b <fork>
   if(fork_pid == 0) {
  ...
  6f:	58                   	pop    %eax
  70:	ff 35 3c 0b 00 00    	push   0xb3c
  76:	e8 e8 02 00 00       	call   363 <kill>
  7b:	e8 b3 02 00 00       	call   333 <exit>
   assert(fork_pid > 0);
  80:	6a 1e                	push   $0x1e
  82:	68 c8 07 00 00       	push   $0x7c8
  87:	68 d1 07 00 00       	push   $0x7d1
  8c:	6a 01                	push   $0x1
  8e:	e8 0d 04 00 00       	call   4a0 <printf>
  93:	83 c4 0c             	add    $0xc,%esp
  96:	68 d9 07 00 00       	push   $0x7d9
  9b:	eb b8                	jmp    55 <main+0x55>
     exit();
  9d:	e8 91 02 00 00       	call   333 <exit>

   assert(wait() > 0);
  a2:	e8 94 02 00 00       	call   33b <wait>
  a7:	85 c0                	test   %eax,%eax
  a9:	7e 13                	jle    be <main+0xbe>
   printf(1, "TEST PASSED\n");
  ab:	50                   	push   %eax
  ac:	50                   	push   %eax
  ad:	68 21 08 00 00       	push   $0x821
  b2:	6a 01                	push   $0x1
  b4:	e8 e7 03 00 00       	call   4a0 <printf>
   exit();
  b9:	e8 75 02 00 00       	call   333 <exit>
   assert(wait() > 0);
  be:	6a 24                	push   $0x24
  c0:	68 c8 07 00 00       	push   $0x7c8
  c5:	68 d1 07 00 00       	push   $0x7d1
  ca:	6a 01                	push   $0x1
  cc:	e8 cf 03 00 00       	call   4a0 <printf>
  d1:	83 c4 0c             	add    $0xc,%esp
  d4:	68 16 08 00 00       	push   $0x816
 ...
 3fc:	89 d1                	mov    %edx,%ecx
{
 ...
 429:	0f b6 92 90 08 00 00 	movzbl 0x890(%edx),%edx
 ...
 4a9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 519:	ff 24 85 38 08 00 00 	jmp    *0x838(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 627:	90                   	nop
          s = "(null)";
 628:	ba 2e 08 00 00       	mov    $0x82e,%edx
        while(*s != 0){
