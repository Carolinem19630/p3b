...
main(int argc, char *argv[])
{
   ...
   ppid = getpid();
  11:	e8 6e 04 00 00       	call   484 <getpid>
  16:	a3 b8 0c 00 00       	mov    %eax,0xcb8

   int fork_pid = fork();
  1b:	e8 dc 03 00 00       	call   3fc <fork>
   if(fork_pid == 0) {
  ...
  2c:	50                   	push   %eax
  2d:	e8 7a 04 00 00       	call   4ac <join>
   assert(join_pid == -1);
  32:	83 c4 10             	add    $0x10,%esp
  35:	83 c0 01             	add    $0x1,%eax
  38:	74 68                	je     a2 <main+0xa2>
  3a:	6a 22                	push   $0x22
  3c:	68 98 08 00 00       	push   $0x898
  41:	68 a1 08 00 00       	push   $0x8a1
  46:	6a 01                	push   $0x1
  48:	e8 23 05 00 00       	call   570 <printf>
  4d:	83 c4 0c             	add    $0xc,%esp
  50:	68 d7 08 00 00       	push   $0x8d7
  55:	68 b6 08 00 00       	push   $0x8b6
  5a:	6a 01                	push   $0x1
  5c:	e8 0f 05 00 00       	call   570 <printf>
  61:	5a                   	pop    %edx
  62:	59                   	pop    %ecx
  63:	68 ca 08 00 00       	push   $0x8ca
  68:	6a 01                	push   $0x1
  6a:	e8 01 05 00 00       	call   570 <printf>
  6f:	58                   	pop    %eax
  70:	ff 35 b8 0c 00 00    	push   0xcb8
  76:	e8 b9 03 00 00       	call   434 <kill>
  7b:	e8 84 03 00 00       	call   404 <exit>
   assert(fork_pid > 0);
  80:	6a 1e                	push   $0x1e
  82:	68 98 08 00 00       	push   $0x898
  87:	68 a1 08 00 00       	push   $0x8a1
  8c:	6a 01                	push   $0x1
  8e:	e8 dd 04 00 00       	call   570 <printf>
  93:	83 c4 0c             	add    $0xc,%esp
  96:	68 a9 08 00 00       	push   $0x8a9
  9b:	eb b8                	jmp    55 <main+0x55>
     exit();
  9d:	e8 62 03 00 00       	call   404 <exit>

   assert(wait() > 0);
  a2:	e8 65 03 00 00       	call   40c <wait>
  a7:	85 c0                	test   %eax,%eax
  a9:	7e 13                	jle    be <main+0xbe>
   printf(1, "TEST PASSED\n");
  ab:	50                   	push   %eax
  ac:	50                   	push   %eax
  ad:	68 f1 08 00 00       	push   $0x8f1
  b2:	6a 01                	push   $0x1
  b4:	e8 b7 04 00 00       	call   570 <printf>
   exit();
  b9:	e8 46 03 00 00       	call   404 <exit>
   assert(wait() > 0);
  be:	6a 24                	push   $0x24
  c0:	68 98 08 00 00       	push   $0x898
  c5:	68 a1 08 00 00       	push   $0x8a1
  ca:	6a 01                	push   $0x1
  cc:	e8 9f 04 00 00       	call   570 <printf>
  d1:	83 c4 0c             	add    $0xc,%esp
  d4:	68 e6 08 00 00       	push   $0x8e6
 ...
 209:	31 db                	xor    %ebx,%ebx
{
 ...
 215:	57                   	push   %edi
 216:	6a 00                	push   $0x0
 218:	e8 ff 01 00 00       	call   41c <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 27d:	e8 c2 01 00 00       	call   444 <open>
  if(fd < 0)
 ...
 291:	50                   	push   %eax
 292:	e8 c5 01 00 00       	call   45c <fstat>
  close(fd);
 297:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 29a:	89 c6                	mov    %eax,%esi
  close(fd);
 29c:	e8 8b 01 00 00       	call   42c <close>
  return r;
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2) {
 ...
 33b:	e8 60 04 00 00       	call   7a0 <malloc>
 ...
 362:	e8 3d 01 00 00       	call   4a4 <clone>
...
int thread_join() {
 387:	83 ec 20             	sub    $0x20,%esp
  int childpid = join(&stack);
 38a:	50                   	push   %eax
 38b:	e8 1c 01 00 00       	call   4ac <join>
 390:	89 c3                	mov    %eax,%ebx
  free(stack);
 392:	58                   	pop    %eax
 393:	ff 75 f4             	push   -0xc(%ebp)
 396:	e8 75 03 00 00       	call   710 <free>
  return childpid;
}
...
void lock_acquire(lock_t *lock) {
 ...
 3d6:	8b 02                	mov    (%edx),%eax
 3d8:	f0 0f c1 02          	lock xadd %eax,(%edx)
  int myturn = FetchAndAdd(&lock->ticket, lock->ticket);
  while (lock->turn != myturn)  ; // spin
 3dc:	8b 52 04             	mov    0x4(%edx),%edx
 3df:	90                   	nop
 3e0:	39 c2                	cmp    %eax,%edx
 3e2:	75 fc                	jne    3e0 <lock_acquire+0x10>
}
 3e4:	5d                   	pop    %ebp
 3e5:	c3                   	ret    
...
void lock_release(lock_t *lock) {
 ...
 3f6:	83 40 04 01          	addl   $0x1,0x4(%eax)
 3fa:	5d                   	pop    %ebp
 3fb:	c3                   	ret    
 ...
 4cc:	89 d1                	mov    %edx,%ecx
{
 ...
 4f9:	0f b6 92 60 09 00 00 	movzbl 0x960(%edx),%edx
 ...
 53e:	56                   	push   %esi
 53f:	57                   	push   %edi
 540:	e8 df fe ff ff       	call   424 <write>
  while(--i >= 0)
 ...
 579:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5b5:	57                   	push   %edi
 5b6:	56                   	push   %esi
 5b7:	e8 68 fe ff ff       	call   424 <write>
 ...
 5e9:	ff 24 85 08 09 00 00 	jmp    *0x908(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 60e:	e8 11 fe ff ff       	call   424 <write>
        putc(fd, c);
 ...
 61f:	57                   	push   %edi
 620:	56                   	push   %esi
 621:	e8 fe fd ff ff       	call   424 <write>
        putc(fd, c);
 ...
 68b:	57                   	push   %edi
 68c:	56                   	push   %esi
 68d:	e8 92 fd ff ff       	call   424 <write>
        while(*s != 0){
 ...
 6cc:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 6cf:	e8 50 fd ff ff       	call   424 <write>
        ap++;
 ...
 6f7:	90                   	nop
          s = "(null)";
 6f8:	ba fe 08 00 00       	mov    $0x8fe,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 711:	a1 bc 0c 00 00       	mov    0xcbc,%eax
{
 ...
 751:	5b                   	pop    %ebx
  freep = p;
 752:	89 15 bc 0c 00 00    	mov    %edx,0xcbc
}
 758:	5e                   	pop    %esi
 759:	5f                   	pop    %edi
 75a:	5d                   	pop    %ebp
 ...
 789:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 78c:	89 15 bc 0c 00 00    	mov    %edx,0xcbc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7ac:	8b 3d bc 0c 00 00    	mov    0xcbc,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7ef:	73 4f                	jae    840 <malloc+0xa0>
    ...
    if(p == freep)
 7f1:	8b 3d bc 0c 00 00    	mov    0xcbc,%edi
 ...
 803:	e8 84 fc ff ff       	call   48c <sbrk>
  if(p == (char*)-1)
 ...
 81a:	e8 f1 fe ff ff       	call   710 <free>
  return freep;
 81f:	8b 15 bc 0c 00 00    	mov    0xcbc,%edx
 ...
 84c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 84f:	89 15 bc 0c 00 00    	mov    %edx,0xcbc
}
 ...
 85f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 860:	c7 05 bc 0c 00 00 c0 	movl   $0xcc0,0xcbc
 867:	0c 00 00 
    base.s.size = 0;
 86a:	bf c0 0c 00 00       	mov    $0xcc0,%edi
    base.s.ptr = freep = prevp = &base;
 86f:	c7 05 c0 0c 00 00 c0 	movl   $0xcc0,0xcc0
 876:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 879:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 87b:	c7 05 c4 0c 00 00 00 	movl   $0x0,0xcc4
 882:	00 00 00 
    if(p->s.size >= nunits){
