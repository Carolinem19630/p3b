...
main(int argc, char *argv[])
{
  ...
  11:	83 ec 18             	sub    $0x18,%esp
   ppid = getpid();
  14:	e8 ed 05 00 00       	call   606 <getpid>

   void *stack, *p = malloc(PGSIZE * 2);
  19:	83 ec 0c             	sub    $0xc,%esp
  1c:	68 00 20 00 00       	push   $0x2000
   ppid = getpid();
  21:	a3 b4 0e 00 00       	mov    %eax,0xeb4
   void *stack, *p = malloc(PGSIZE * 2);
  ...
  60:	c7 45 e0 18 00 00 00 	movl   $0x18,-0x20(%ebp)
   int clone_pid = clone(worker, &arg1, &arg2, stack);
  67:	e8 ba 05 00 00       	call   626 <clone>
   assert(clone_pid > 0);
  ...
  7d:	e8 94 05 00 00       	call   616 <sleep>
   assert(wait() == -1);
  82:	e8 07 05 00 00       	call   58e <wait>
  ...
  c8:	5b                   	pop    %ebx
  c9:	ff 35 b4 0e 00 00    	push   0xeb4
  cf:	e8 e2 04 00 00       	call   5b6 <kill>
  d4:	e8 ad 04 00 00       	call   586 <exit>
  d9:	6a 25                	push   $0x25
 ...
 119:	50                   	push   %eax
 11a:	e8 0f 05 00 00       	call   62e <join>
 ...
 166:	e9 43 ff ff ff       	jmp    ae <main+0xae>
   assert(global == 2);
 16b:	83 3d b0 0e 00 00 02 	cmpl   $0x2,0xeb0
 ...
 1a5:	e8 e6 06 00 00       	call   890 <free>
   exit();
 1aa:	e8 d7 03 00 00       	call   586 <exit>
 1af:	90                   	nop
...
worker(void *arg1, void *arg2) {
 ...
 1c6:	75 2a                	jne    1f2 <worker+0x42>
   assert(global == 1);
 1c8:	83 3d b0 0e 00 00 01 	cmpl   $0x1,0xeb0
 ...
 227:	59                   	pop    %ecx
 228:	ff 35 b4 0e 00 00    	push   0xeb4
 22e:	e8 83 03 00 00       	call   5b6 <kill>
 233:	e8 4e 03 00 00       	call   586 <exit>
   assert(tmp1 == 42);
 238:	6a 39                	push   $0x39
 ...
 253:	eb b8                	jmp    20d <worker+0x5d>
   global++;
 255:	c7 05 b0 0e 00 00 02 	movl   $0x2,0xeb0
 25c:	00 00 00 
   exit();
 25f:	e8 22 03 00 00       	call   586 <exit>
 ...
 399:	31 db                	xor    %ebx,%ebx
{
 ...
 3a5:	57                   	push   %edi
 3a6:	6a 00                	push   $0x0
 3a8:	e8 f1 01 00 00       	call   59e <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 40d:	e8 b4 01 00 00       	call   5c6 <open>
  if(fd < 0)
 ...
 421:	50                   	push   %eax
 422:	e8 b7 01 00 00       	call   5de <fstat>
  close(fd);
 427:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 42a:	89 c6                	mov    %eax,%esi
  close(fd);
 42c:	e8 7d 01 00 00       	call   5ae <close>
  return r;
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2) {
 ...
 4f2:	e8 2f 01 00 00       	call   626 <clone>
...
int thread_join() {
 517:	83 ec 20             	sub    $0x20,%esp
  int childpid = join(&stack);
 51a:	50                   	push   %eax
 51b:	e8 0e 01 00 00       	call   62e <join>
 520:	89 c3                	mov    %eax,%ebx
  free(stack);
 522:	58                   	pop    %eax
 523:	ff 75 f4             	push   -0xc(%ebp)
 526:	e8 65 03 00 00       	call   890 <free>
  return childpid;
}
...
free(void *ap)
{
 ...
 891:	a1 b8 0e 00 00       	mov    0xeb8,%eax
{
 ...
 8d1:	5b                   	pop    %ebx
  freep = p;
 8d2:	89 15 b8 0e 00 00    	mov    %edx,0xeb8
}
 8d8:	5e                   	pop    %esi
 8d9:	5f                   	pop    %edi
 8da:	5d                   	pop    %ebp
 ...
 909:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 90c:	89 15 b8 0e 00 00    	mov    %edx,0xeb8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 929:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 92c:	8b 3d b8 0e 00 00    	mov    0xeb8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 96f:	73 4f                	jae    9c0 <malloc+0xa0>
    ...
    if(p == freep)
 971:	8b 3d b8 0e 00 00    	mov    0xeb8,%edi
 ...
 99a:	e8 f1 fe ff ff       	call   890 <free>
  return freep;
 99f:	8b 15 b8 0e 00 00    	mov    0xeb8,%edx
 ...
 9cc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 9cf:	89 15 b8 0e 00 00    	mov    %edx,0xeb8
}
 ...
 9df:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 9e0:	c7 05 b8 0e 00 00 bc 	movl   $0xebc,0xeb8
 9e7:	0e 00 00 
    base.s.size = 0;
 9ea:	bf bc 0e 00 00       	mov    $0xebc,%edi
    base.s.ptr = freep = prevp = &base;
 9ef:	c7 05 bc 0e 00 00 bc 	movl   $0xebc,0xebc
 9f6:	0e 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 9f9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 9fb:	c7 05 c0 0e 00 00 00 	movl   $0x0,0xec0
 a02:	00 00 00 
    if(p->s.size >= nunits){
