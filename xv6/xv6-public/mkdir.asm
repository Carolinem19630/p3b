...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	push   (%ebx)
  35:	e8 d2 03 00 00       	call   40c <mkdir>
 ...
 6b1:	a1 30 0c 00 00       	mov    0xc30,%eax
{
 ...
 729:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 72c:	89 15 30 0c 00 00    	mov    %edx,0xc30
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 749:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 74c:	8b 3d 30 0c 00 00    	mov    0xc30,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 78f:	73 4f                	jae    7e0 <malloc+0xa0>
    ...
    if(p == freep)
 791:	8b 3d 30 0c 00 00    	mov    0xc30,%edi
 ...
 7ba:	e8 f1 fe ff ff       	call   6b0 <free>
  return freep;
 7bf:	8b 15 30 0c 00 00    	mov    0xc30,%edx
 ...
 7ec:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7ef:	89 15 30 0c 00 00    	mov    %edx,0xc30
}
 ...
 807:	0c 00 00 
    base.s.size = 0;
 80a:	bf 34 0c 00 00       	mov    $0xc34,%edi
    base.s.ptr = freep = prevp = &base;
 80f:	c7 05 34 0c 00 00 34 	movl   $0xc34,0xc34
 816:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 819:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 81b:	c7 05 38 0c 00 00 00 	movl   $0x0,0xc38
 822:	00 00 00 
    if(p->s.size >= nunits){
