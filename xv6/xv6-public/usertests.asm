...
main(int argc, char *argv[])
{
  ...
  if(open("usertests.ran", 0) >= 0){
      ...
      26:	e8 b9 39 00 00       	call   39e4 <open>
    ...
    exit();
      40:	e8 5f 39 00 00       	call   39a4 <exit>
  }
  close(open("usertests.ran", O_CREATE));
      ...
      51:	e8 8e 39 00 00       	call   39e4 <open>
      56:	89 04 24             	mov    %eax,(%esp)
      59:	e8 6e 39 00 00       	call   39cc <close>
  ...
  exit();
     10d:	e8 92 38 00 00       	call   39a4 <exit>
...
00000120 <iputtest>:
{
  ...
  if(chdir("iputdir") < 0){
     ...
     151:	e8 be 38 00 00       	call   3a14 <chdir>
  ...
  if(unlink("../iputdir") < 0){
     ...
     169:	e8 86 38 00 00       	call   39f4 <unlink>
  ...
  if(chdir("/") < 0){
     ...
     17d:	e8 92 38 00 00       	call   3a14 <chdir>
  ...
  printf(stdout, "iput test ok\n");
     ...
     191:	ff 35 d4 5f 00 00    	push   0x5fd4
    ...
    printf(stdout, "mkdir failed\n");
     ...
     1a8:	ff 35 d4 5f 00 00    	push   0x5fd4
     1ae:	e8 5d 39 00 00       	call   3b10 <printf>
    exit();
     1b3:	e8 ec 37 00 00       	call   39a4 <exit>
    printf(stdout, "chdir / failed\n");
     1b8:	50                   	push   %eax
     1b9:	50                   	push   %eax
     1ba:	68 83 3e 00 00       	push   $0x3e83
     1bf:	ff 35 d4 5f 00 00    	push   0x5fd4
     1c5:	e8 46 39 00 00       	call   3b10 <printf>
    exit();
     1ca:	e8 d5 37 00 00       	call   39a4 <exit>
    printf(stdout, "unlink ../iputdir failed\n");
     1cf:	52                   	push   %edx
     1d0:	52                   	push   %edx
     1d1:	68 67 3e 00 00       	push   $0x3e67
     1d6:	ff 35 d4 5f 00 00    	push   0x5fd4
     1dc:	e8 2f 39 00 00       	call   3b10 <printf>
    exit();
     1e1:	e8 be 37 00 00       	call   39a4 <exit>
    printf(stdout, "chdir iputdir failed\n");
     1e6:	51                   	push   %ecx
     1e7:	51                   	push   %ecx
     1e8:	68 46 3e 00 00       	push   $0x3e46
     1ed:	ff 35 d4 5f 00 00    	push   0x5fd4
     1f3:	e8 18 39 00 00       	call   3b10 <printf>
    exit();
     1f8:	e8 a7 37 00 00       	call   39a4 <exit>
...
00000200 <exitiputtest>:
{
  ...
  printf(stdout, "exitiput test\n");
     ...
     20b:	ff 35 d4 5f 00 00    	push   0x5fd4
     211:	e8 fa 38 00 00       	call   3b10 <printf>
  pid = fork();
     216:	e8 81 37 00 00       	call   399c <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     230:	e8 d7 37 00 00       	call   3a0c <mkdir>
    ...
    if(chdir("iputdir") < 0){
     ...
     248:	e8 c7 37 00 00       	call   3a14 <chdir>
    ...
    if(unlink("../iputdir") < 0){
     ...
     260:	e8 8f 37 00 00       	call   39f4 <unlink>
     265:	83 c4 10             	add    $0x10,%esp
     268:	85 c0                	test   %eax,%eax
     26a:	78 2c                	js     298 <exitiputtest+0x98>
    exit();
     26c:	e8 33 37 00 00       	call   39a4 <exit>
     271:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  wait();
     278:	e8 2f 37 00 00       	call   39ac <wait>
  printf(stdout, "exitiput test ok\n");
     27d:	83 ec 08             	sub    $0x8,%esp
     280:	68 b6 3e 00 00       	push   $0x3eb6
     285:	ff 35 d4 5f 00 00    	push   0x5fd4
     ...
     2a0:	ff 35 d4 5f 00 00    	push   0x5fd4
     2a6:	e8 65 38 00 00       	call   3b10 <printf>
      exit();
     2ab:	e8 f4 36 00 00       	call   39a4 <exit>
    printf(stdout, "fork failed\n");
     2b0:	51                   	push   %ecx
     2b1:	51                   	push   %ecx
     2b2:	68 79 4d 00 00       	push   $0x4d79
     2b7:	ff 35 d4 5f 00 00    	push   0x5fd4
     2bd:	e8 4e 38 00 00       	call   3b10 <printf>
    exit();
     2c2:	e8 dd 36 00 00       	call   39a4 <exit>
      printf(stdout, "mkdir failed\n");
     2c7:	52                   	push   %edx
     2c8:	52                   	push   %edx
     2c9:	68 38 3e 00 00       	push   $0x3e38
     2ce:	ff 35 d4 5f 00 00    	push   0x5fd4
     2d4:	e8 37 38 00 00       	call   3b10 <printf>
      exit();
     2d9:	e8 c6 36 00 00       	call   39a4 <exit>
      printf(stdout, "child chdir failed\n");
     2de:	50                   	push   %eax
     2df:	50                   	push   %eax
     2e0:	68 a2 3e 00 00       	push   $0x3ea2
     2e5:	ff 35 d4 5f 00 00    	push   0x5fd4
     2eb:	e8 20 38 00 00       	call   3b10 <printf>
      exit();
     2f0:	e8 af 36 00 00       	call   39a4 <exit>
...
00000300 <openiputtest>:
{
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     342:	e8 9d 36 00 00       	call   39e4 <open>
    if(fd >= 0){
  ...
  printf(stdout, "openiput test ok\n");
    ...
    exit();
     3b0:	e8 ef 35 00 00       	call   39a4 <exit>
    printf(stdout, "fork failed\n");
     3b5:	52                   	push   %edx
     3b6:	52                   	push   %edx
     3b7:	68 79 4d 00 00       	push   $0x4d79
     3bc:	ff 35 d4 5f 00 00    	push   0x5fd4
     3c2:	e8 49 37 00 00       	call   3b10 <printf>
    exit();
     3c7:	e8 d8 35 00 00       	call   39a4 <exit>
    printf(stdout, "mkdir oidir failed\n");
     3cc:	51                   	push   %ecx
     3cd:	51                   	push   %ecx
     3ce:	68 dd 3e 00 00       	push   $0x3edd
     3d3:	ff 35 d4 5f 00 00    	push   0x5fd4
     3d9:	e8 32 37 00 00       	call   3b10 <printf>
    exit();
     3de:	e8 c1 35 00 00       	call   39a4 <exit>
    printf(stdout, "unlink failed\n");
     3e3:	50                   	push   %eax
     3e4:	50                   	push   %eax
     3e5:	68 f1 3e 00 00       	push   $0x3ef1
     3ea:	ff 35 d4 5f 00 00    	push   0x5fd4
     3f0:	e8 1b 37 00 00       	call   3b10 <printf>
    exit();
     3f5:	e8 aa 35 00 00       	call   39a4 <exit>
...
00000400 <opentest>:
{
  ...
  printf(stdout, "open test\n");
     ...
     40b:	ff 35 d4 5f 00 00    	push   0x5fd4
  ...
  fd = open("echo", 0);
     ...
     41f:	e8 c0 35 00 00       	call   39e4 <open>
  if(fd < 0){
  ...
  close(fd);
     ...
     42e:	50                   	push   %eax
     42f:	e8 98 35 00 00       	call   39cc <close>
  fd = open("doesnotexist", 0);
     434:	5a                   	pop    %edx
     435:	59                   	pop    %ecx
     436:	6a 00                	push   $0x0
     438:	68 35 3f 00 00       	push   $0x3f35
     43d:	e8 a2 35 00 00       	call   39e4 <open>
  if(fd >= 0){
  ...
  printf(stdout, "open test ok\n");
     ...
     451:	ff 35 d4 5f 00 00    	push   0x5fd4
    ...
    printf(stdout, "open echo failed!\n");
     ...
     468:	ff 35 d4 5f 00 00    	push   0x5fd4
     46e:	e8 9d 36 00 00       	call   3b10 <printf>
    exit();
     473:	e8 2c 35 00 00       	call   39a4 <exit>
    printf(stdout, "open doesnotexist succeeded!\n");
     478:	50                   	push   %eax
     479:	50                   	push   %eax
     47a:	68 42 3f 00 00       	push   $0x3f42
     47f:	ff 35 d4 5f 00 00    	push   0x5fd4
     485:	e8 86 36 00 00       	call   3b10 <printf>
    exit();
     48a:	e8 15 35 00 00       	call   39a4 <exit>
     48f:	90                   	nop
...
00000490 <writetest>:
{
  ...
  printf(stdout, "small file test\n");
     ...
     49d:	ff 35 d4 5f 00 00    	push   0x5fd4
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     4b4:	e8 2b 35 00 00       	call   39e4 <open>
  if(fd >= 0){
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     ...
     4d0:	ff 35 d4 5f 00 00    	push   0x5fd4
    ...
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     4ea:	56                   	push   %esi
     4eb:	e8 d4 34 00 00       	call   39c4 <write>
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     506:	56                   	push   %esi
     507:	e8 b8 34 00 00       	call   39c4 <write>
  ...
  printf(stdout, "writes ok\n");
     ...
     528:	ff 35 d4 5f 00 00    	push   0x5fd4
     52e:	e8 dd 35 00 00       	call   3b10 <printf>
  close(fd);
     533:	89 34 24             	mov    %esi,(%esp)
     536:	e8 91 34 00 00       	call   39cc <close>
  fd = open("small", O_RDONLY);
     53b:	5b                   	pop    %ebx
     53c:	5e                   	pop    %esi
     53d:	6a 00                	push   $0x0
     53f:	68 7f 3f 00 00       	push   $0x3f7f
     544:	e8 9b 34 00 00       	call   39e4 <open>
  if(fd >= 0){
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     55e:	ff 35 d4 5f 00 00    	push   0x5fd4
  ...
  i = read(fd, buf, 2000);
     ...
     576:	53                   	push   %ebx
     577:	e8 40 34 00 00       	call   39bc <read>
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     592:	ff 35 d4 5f 00 00    	push   0x5fd4
     598:	e8 73 35 00 00       	call   3b10 <printf>
  close(fd);
     59d:	89 1c 24             	mov    %ebx,(%esp)
     5a0:	e8 27 34 00 00       	call   39cc <close>
  if(unlink("small") < 0){
     5a5:	c7 04 24 7f 3f 00 00 	movl   $0x3f7f,(%esp)
     5ac:	e8 43 34 00 00       	call   39f4 <unlink>
  ...
  printf(stdout, "small file test ok\n");
     ...
     5c0:	ff 35 d4 5f 00 00    	push   0x5fd4
...
00000670 <writetest1>:
{
  ...
  printf(stdout, "big files test\n");
     ...
     67d:	ff 35 d4 5f 00 00    	push   0x5fd4
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     694:	e8 4b 33 00 00       	call   39e4 <open>
  if(fd < 0){
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     6c3:	56                   	push   %esi
     6c4:	e8 fb 32 00 00       	call   39c4 <write>
  ...
  close(fd);
     ...
     6e5:	56                   	push   %esi
     6e6:	e8 e1 32 00 00       	call   39cc <close>
  fd = open("big", O_RDONLY);
     6eb:	5b                   	pop    %ebx
     6ec:	5e                   	pop    %esi
     6ed:	6a 00                	push   $0x0
     6ef:	68 c7 40 00 00       	push   $0x40c7
     6f4:	e8 eb 32 00 00       	call   39e4 <open>
  if(fd < 0){
  ...
  n = 0;
    ...
    i = read(fd, buf, 512);
     ...
     734:	53                   	push   %ebx
     735:	e8 82 32 00 00       	call   39bc <read>
    if(i == 0){
  ...
  close(fd);
     ...
     750:	53                   	push   %ebx
     751:	e8 76 32 00 00       	call   39cc <close>
  if(unlink("big") < 0){
     756:	c7 04 24 c7 40 00 00 	movl   $0x40c7,(%esp)
     75d:	e8 92 32 00 00       	call   39f4 <unlink>
  ...
  printf(stdout, "big files ok\n");
     ...
     775:	ff 35 d4 5f 00 00    	push   0x5fd4
     ...
     844:	bb 30 00 00 00       	mov    $0x30,%ebx
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     ...
     851:	ff 35 d4 5f 00 00    	push   0x5fd4
  ...
  for(i = 0; i < 52; i++){
    ...
    fd = open(name, O_CREATE|O_RDWR);
     ...
     886:	e8 59 31 00 00       	call   39e4 <open>
    close(fd);
     88b:	89 04 24             	mov    %eax,(%esp)
     88e:	e8 39 31 00 00       	call   39cc <close>
  for(i = 0; i < 52; i++){
  ...
  for(i = 0; i < 52; i++){
    ...
    unlink(name);
     ...
     8c1:	e8 2e 31 00 00       	call   39f4 <unlink>
  for(i = 0; i < 52; i++){
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     8d6:	ff 35 d4 5f 00 00    	push   0x5fd4
...
000008f0 <dirtest>:
{
  ...
  if(chdir("dir0") < 0){
     ...
     921:	e8 ee 30 00 00       	call   3a14 <chdir>
  ...
  if(chdir("..") < 0){
     ...
     939:	e8 d6 30 00 00       	call   3a14 <chdir>
  ...
  if(unlink("dir0") < 0){
     ...
     94d:	e8 a2 30 00 00       	call   39f4 <unlink>
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     961:	ff 35 d4 5f 00 00    	push   0x5fd4
    ...
    printf(stdout, "mkdir failed\n");
     ...
     978:	ff 35 d4 5f 00 00    	push   0x5fd4
     97e:	e8 8d 31 00 00       	call   3b10 <printf>
    exit();
     983:	e8 1c 30 00 00       	call   39a4 <exit>
    printf(stdout, "unlink dir0 failed\n");
     988:	50                   	push   %eax
     989:	50                   	push   %eax
     98a:	68 31 41 00 00       	push   $0x4131
     98f:	ff 35 d4 5f 00 00    	push   0x5fd4
     995:	e8 76 31 00 00       	call   3b10 <printf>
    exit();
     99a:	e8 05 30 00 00       	call   39a4 <exit>
    printf(stdout, "chdir .. failed\n");
     99f:	52                   	push   %edx
     9a0:	52                   	push   %edx
     9a1:	68 20 41 00 00       	push   $0x4120
     9a6:	ff 35 d4 5f 00 00    	push   0x5fd4
     9ac:	e8 5f 31 00 00       	call   3b10 <printf>
    exit();
     9b1:	e8 ee 2f 00 00       	call   39a4 <exit>
    printf(stdout, "chdir dir0 failed\n");
     9b6:	51                   	push   %ecx
     9b7:	51                   	push   %ecx
     9b8:	68 0d 41 00 00       	push   $0x410d
     9bd:	ff 35 d4 5f 00 00    	push   0x5fd4
     9c3:	e8 48 31 00 00       	call   3b10 <printf>
    exit();
     9c8:	e8 d7 2f 00 00       	call   39a4 <exit>
...
000009d0 <exectest>:
{
  ...
  printf(stdout, "exec test\n");
     ...
     9db:	ff 35 d4 5f 00 00    	push   0x5fd4
     9e1:	e8 2a 31 00 00       	call   3b10 <printf>
  if(exec("echo", echoargv) < 0){
     9e6:	5a                   	pop    %edx
     9e7:	59                   	pop    %ecx
     9e8:	68 d8 5f 00 00       	push   $0x5fd8
     9ed:	68 1d 3f 00 00       	push   $0x3f1d
     9f2:	e8 e5 2f 00 00       	call   39dc <exec>
    ...
    printf(stdout, "exec echo failed\n");
     ...
     a07:	ff 35 d4 5f 00 00    	push   0x5fd4
     a0d:	e8 fe 30 00 00       	call   3b10 <printf>
    exit();
     a12:	e8 8d 2f 00 00       	call   39a4 <exit>
     ...
     a25:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  ...
  seq = 0;
    ...
    close(fds[1]);
     a5d:	e8 6a 2f 00 00       	call   39cc <close>
    total = 0;
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a78:	e8 3f 2f 00 00       	call   39bc <read>
  ...
  seq = 0;
    ...
    close(fds[0]);
     ad7:	e8 f0 2e 00 00       	call   39cc <close>
     ...
     b11:	e8 ae 2e 00 00       	call   39c4 <write>
    ...
    exit();
     b28:	e8 77 2e 00 00       	call   39a4 <exit>
    if(total != 5 * 1033){
    ...
    close(fds[0]);
     ...
     b3c:	e8 8b 2e 00 00       	call   39cc <close>
    wait();
     b41:	e8 66 2e 00 00       	call   39ac <wait>
  printf(1, "pipe1 ok\n");
     b46:	5a                   	pop    %edx
     b47:	59                   	pop    %ecx
     ...
     b67:	e8 a4 2f 00 00       	call   3b10 <printf>
      exit();
     b6c:	e8 33 2e 00 00       	call   39a4 <exit>
    ...
    exit();
     b7f:	e8 20 2e 00 00       	call   39a4 <exit>
    ...
    exit();
     b92:	e8 0d 2e 00 00       	call   39a4 <exit>
     ...
     ba0:	e8 6b 2f 00 00       	call   3b10 <printf>
        exit();
     ba5:	e8 fa 2d 00 00       	call   39a4 <exit>
...
00000bb0 <preempt>:
{
  ...
  pid1 = fork();
     bc5:	e8 d2 2d 00 00       	call   399c <fork>
  if(pid1 == 0)
  ...
  pid2 = fork();
     bda:	e8 bd 2d 00 00       	call   399c <fork>
  ...
  pipe(pfds);
     ...
     bf6:	50                   	push   %eax
     bf7:	e8 b8 2d 00 00       	call   39b4 <pipe>
  pid3 = fork();
     bfc:	e8 9b 2d 00 00       	call   399c <fork>
  if(pid3 == 0){
  ...
  if(pid3 == 0){
    ...
    close(pfds[1]);
     ...
     c39:	e8 8e 2d 00 00       	call   39cc <close>
  ...
  close(pfds[0]);
     ...
     c76:	e8 51 2d 00 00       	call   39cc <close>
  printf(1, "kill... ");
     c7b:	58                   	pop    %eax
     c7c:	5a                   	pop    %edx
  ...
  kill(pid1);
     ...
     c8c:	e8 43 2d 00 00       	call   39d4 <kill>
  kill(pid2);
     c91:	89 34 24             	mov    %esi,(%esp)
     c94:	e8 3b 2d 00 00       	call   39d4 <kill>
  kill(pid3);
     c99:	89 3c 24             	mov    %edi,(%esp)
     c9c:	e8 33 2d 00 00       	call   39d4 <kill>
  printf(1, "wait... ");
     ca1:	59                   	pop    %ecx
     ca2:	5b                   	pop    %ebx
  ...
  wait();
     caf:	e8 f8 2c 00 00       	call   39ac <wait>
  wait();
     cb4:	e8 f3 2c 00 00       	call   39ac <wait>
  wait();
     cb9:	e8 ee 2c 00 00       	call   39ac <wait>
  printf(1, "preempt ok\n");
     cbe:	5e                   	pop    %esi
     cbf:	5f                   	pop    %edi
...
00000d10 <exitwait>:
{
    ...
    if(pid){
     d20:	74 68                	je     d8a <exitwait+0x7a>
      if(wait() != pid){
     d22:	e8 85 2c 00 00       	call   39ac <wait>
  ...
  for(i = 0; i < 100; i++){
    ...
    pid = fork();
     d30:	e8 67 2c 00 00       	call   399c <fork>
  ...
  printf(1, "exitwait ok\n");
     ...
     d89:	c3                   	ret    
      exit();
     d8a:	e8 15 2c 00 00       	call   39a4 <exit>
     d8f:	90                   	nop
...
00000d90 <mem>:
{
  ...
  ppid = getpid();
     da6:	e8 79 2c 00 00       	call   3a24 <getpid>
     dab:	89 c3                	mov    %eax,%ebx
  if((pid = fork()) == 0){
     dad:	e8 ea 2b 00 00       	call   399c <fork>
    ...
    exit();
     e1f:	e8 80 2b 00 00       	call   39a4 <exit>
     ...
     e3a:	e8 95 2b 00 00       	call   39d4 <kill>
      exit();
     e3f:	e8 60 2b 00 00       	call   39a4 <exit>
     ...
     e4d:	5d                   	pop    %ebp
    wait();
     e4e:	e9 59 2b 00 00       	jmp    39ac <wait>
...
00000e60 <sharedfd>:
{
  ...
  unlink("sharedfd");
     ...
     e7c:	e8 73 2b 00 00       	call   39f4 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     e81:	5b                   	pop    %ebx
     e82:	5e                   	pop    %esi
     e83:	68 02 02 00 00       	push   $0x202
     e88:	68 73 42 00 00       	push   $0x4273
     e8d:	e8 52 2b 00 00       	call   39e4 <open>
  if(fd < 0){
  ...
  pid = fork();
     ea7:	e8 f0 2a 00 00       	call   399c <fork>
  memset(buf, pid==0?'c':'p', sizeof(buf));
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     eda:	56                   	push   %esi
     edb:	57                   	push   %edi
     edc:	e8 e3 2a 00 00       	call   39c4 <write>
  ...
  if(pid == 0)
    ...
    wait();
     f06:	e8 a1 2a 00 00       	call   39ac <wait>
  close(fd);
  ...
  close(fd);
     ...
     f14:	e8 b3 2a 00 00       	call   39cc <close>
  fd = open("sharedfd", 0);
     f19:	58                   	pop    %eax
     f1a:	5a                   	pop    %edx
     f1b:	6a 00                	push   $0x0
     f1d:	68 73 42 00 00       	push   $0x4273
     f22:	e8 bd 2a 00 00       	call   39e4 <open>
  if(fd < 0){
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     f4c:	e8 6b 2a 00 00       	call   39bc <read>
  ...
  close(fd);
     ...
     f86:	e8 41 2a 00 00       	call   39cc <close>
  unlink("sharedfd");
     f8b:	c7 04 24 73 42 00 00 	movl   $0x4273,(%esp)
     f92:	e8 5d 2a 00 00       	call   39f4 <unlink>
  if(nc == 10000 && np == 10000){
    ...
    return;
     ...
     ffa:	c3                   	ret    
    exit();
     ffb:	e8 a4 29 00 00       	call   39a4 <exit>
    ...
    exit();
    100e:	e8 91 29 00 00       	call   39a4 <exit>
    ...
    102b:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fourfiles test\n");
    ...
    105e:	56                   	push   %esi
    105f:	e8 90 29 00 00       	call   39f4 <unlink>
    pid = fork();
    1064:	e8 33 29 00 00       	call   399c <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    1088:	e8 1f 29 00 00       	call   39ac <wait>
  for(i = 0; i < 2; i++){
    108d:	31 f6                	xor    %esi,%esi
    wait();
    108f:	e8 18 29 00 00       	call   39ac <wait>
    1094:	e8 13 29 00 00       	call   39ac <wait>
    1099:	e8 0e 29 00 00       	call   39ac <wait>
    fname = names[i];
    ...
    fd = open(fname, 0);
    10ad:	e8 32 29 00 00       	call   39e4 <open>
    while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    10d0:	e8 e7 28 00 00       	call   39bc <read>
    ...
    1104:	e8 c3 28 00 00       	call   39cc <close>
    if(total != 12*500){
    ...
    111e:	e8 d1 28 00 00       	call   39f4 <unlink>
  for(i = 0; i < 2; i++){
  ...
  printf(1, "fourfiles ok\n");
    ...
    1159:	e8 b2 29 00 00       	call   3b10 <printf>
          exit();
    115e:	e8 41 28 00 00       	call   39a4 <exit>
      fd = open(fname, O_CREATE | O_RDWR);
    1163:	83 ec 08             	sub    $0x8,%esp
    1166:	68 02 02 00 00       	push   $0x202
    116b:	56                   	push   %esi
    116c:	e8 73 28 00 00       	call   39e4 <open>
      if(fd < 0){
    ...
    11a5:	56                   	push   %esi
    11a6:	e8 19 28 00 00       	call   39c4 <write>
    ...
    11b8:	75 de                	jne    1198 <fourfiles+0x178>
      exit();
    11ba:	e8 e5 27 00 00       	call   39a4 <exit>
    ...
    11c8:	e8 43 29 00 00       	call   3b10 <printf>
        exit();
    11cd:	e8 d2 27 00 00       	call   39a4 <exit>
    ...
    11e2:	e8 29 29 00 00       	call   3b10 <printf>
      exit();
    11e7:	e8 b8 27 00 00       	call   39a4 <exit>
    ...
    11f5:	e8 16 29 00 00       	call   3b10 <printf>
      exit();
    11fa:	e8 a5 27 00 00       	call   39a4 <exit>
    ...
    1208:	e8 03 29 00 00       	call   3b10 <printf>
          exit();
    120d:	e8 92 27 00 00       	call   39a4 <exit>
    ...
    1226:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "createdelete test\n");
    ...
    pid = fork();
    123a:	e8 5d 27 00 00       	call   399c <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    1255:	e8 52 27 00 00       	call   39ac <wait>
  for(i = 0; i < N; i++){
    125a:	31 f6                	xor    %esi,%esi
    125c:	8d 7d c8             	lea    -0x38(%ebp),%edi
    wait();
    125f:	e8 48 27 00 00       	call   39ac <wait>
    1264:	e8 43 27 00 00       	call   39ac <wait>
    1269:	e8 3e 27 00 00       	call   39ac <wait>
  ...
  for(i = 0; i < N; i++){
    ...
    12a6:	88 45 c9             	mov    %al,-0x37(%ebp)
      fd = open(name, 0);
    12a9:	e8 36 27 00 00       	call   39e4 <open>
      if((i == 0 || i >= N/2) && fd < 0){
    ...
    12cc:	50                   	push   %eax
    12cd:	e8 fa 26 00 00       	call   39cc <close>
  ...
  for(i = 0; i < N; i++){
    ...
    1308:	88 45 c9             	mov    %al,-0x37(%ebp)
      unlink(name);
    130b:	e8 e4 26 00 00       	call   39f4 <unlink>
    for(pi = 0; pi < 4; pi++){
  ...
  printf(1, "createdelete ok\n");
    ...
    134d:	e8 be 27 00 00       	call   3b10 <printf>
        exit();
    1352:	e8 4d 26 00 00       	call   39a4 <exit>
    ...
    1397:	88 45 c9             	mov    %al,-0x37(%ebp)
        fd = open(name, O_CREATE | O_RDWR);
    139a:	e8 45 26 00 00       	call   39e4 <open>
        if(fd < 0){
    ...
    13a9:	50                   	push   %eax
    13aa:	e8 1d 26 00 00       	call   39cc <close>
        if(i > 0 && (i % 2 ) == 0){
    ...
    13c6:	88 45 c9             	mov    %al,-0x37(%ebp)
          if(unlink(name) < 0){
    13c9:	e8 26 26 00 00       	call   39f4 <unlink>
    ...
    13de:	e8 2d 27 00 00       	call   3b10 <printf>
            exit();
    13e3:	e8 bc 25 00 00       	call   39a4 <exit>
    13e8:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    13ef:	90                   	nop
      exit();
    13f0:	e8 af 25 00 00       	call   39a4 <exit>
    ...
    1400:	e8 0b 27 00 00       	call   3b10 <printf>
        exit();
    1405:	e8 9a 25 00 00       	call   39a4 <exit>
      printf(1, "fork failed\n");
    ...
    1414:	e8 f7 26 00 00       	call   3b10 <printf>
      exit();
    1419:	e8 86 25 00 00       	call   39a4 <exit>
          printf(1, "create failed\n");
    ...
    1428:	e8 e3 26 00 00       	call   3b10 <printf>
          exit();
    142d:	e8 72 25 00 00       	call   39a4 <exit>
...
00001440 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    1460:	e8 7f 25 00 00       	call   39e4 <open>
  if(fd < 0){
  ...
  write(fd, "hello", 5);
    ...
    147c:	50                   	push   %eax
    147d:	e8 42 25 00 00       	call   39c4 <write>
  close(fd);
    1482:	89 1c 24             	mov    %ebx,(%esp)
    1485:	e8 42 25 00 00       	call   39cc <close>
  fd = open("unlinkread", O_RDWR);
    148a:	58                   	pop    %eax
    148b:	5a                   	pop    %edx
    148c:	6a 02                	push   $0x2
    148e:	68 25 43 00 00       	push   $0x4325
    1493:	e8 4c 25 00 00       	call   39e4 <open>
  if(fd < 0){
  ...
  if(unlink("unlinkread") != 0){
    ...
    14ad:	e8 42 25 00 00       	call   39f4 <unlink>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    14ca:	e8 15 25 00 00       	call   39e4 <open>
  write(fd1, "yyy", 3);
  ...
  if(write(fd, buf, 10) != 10){
    ...
    151b:	53                   	push   %ebx
    151c:	e8 a3 24 00 00       	call   39c4 <write>
  ...
  close(fd);
    ...
    152c:	53                   	push   %ebx
    152d:	e8 9a 24 00 00       	call   39cc <close>
  unlink("unlinkread");
    1532:	c7 04 24 25 43 00 00 	movl   $0x4325,(%esp)
    1539:	e8 b6 24 00 00       	call   39f4 <unlink>
  printf(1, "unlinkread ok\n");
    ...
    exit();
    1564:	e8 3b 24 00 00       	call   39a4 <exit>
    ...
    exit();
    1577:	e8 28 24 00 00       	call   39a4 <exit>
    ...
    exit();
    158a:	e8 15 24 00 00       	call   39a4 <exit>
    ...
    exit();
    159d:	e8 02 24 00 00       	call   39a4 <exit>
    ...
    exit();
    15b0:	e8 ef 23 00 00       	call   39a4 <exit>
    ...
    exit();
    15c3:	e8 dc 23 00 00       	call   39a4 <exit>
...
000015d0 <linktest>:
{
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    1623:	50                   	push   %eax
    1624:	e8 9b 23 00 00       	call   39c4 <write>
  ...
  close(fd);
    ...
    1638:	53                   	push   %ebx
    1639:	e8 8e 23 00 00       	call   39cc <close>
  if(link("lf1", "lf2") < 0){
    163e:	5b                   	pop    %ebx
    163f:	58                   	pop    %eax
    1640:	68 ea 43 00 00       	push   $0x43ea
    1645:	68 e6 43 00 00       	push   $0x43e6
    164a:	e8 b5 23 00 00       	call   3a04 <link>
  ...
  unlink("lf1");
    ...
    1662:	e8 8d 23 00 00       	call   39f4 <unlink>
  if(open("lf1", 0) >= 0){
    1667:	58                   	pop    %eax
    1668:	5a                   	pop    %edx
    1669:	6a 00                	push   $0x0
    166b:	68 e6 43 00 00       	push   $0x43e6
    1670:	e8 6f 23 00 00       	call   39e4 <open>
  ...
  fd = open("lf2", 0);
    ...
    168a:	e8 55 23 00 00       	call   39e4 <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    16a9:	50                   	push   %eax
    16aa:	e8 0d 23 00 00       	call   39bc <read>
  ...
  close(fd);
    ...
    16be:	53                   	push   %ebx
    16bf:	e8 08 23 00 00       	call   39cc <close>
  if(link("lf2", "lf2") >= 0){
    16c4:	58                   	pop    %eax
    16c5:	5a                   	pop    %edx
    16c6:	68 ea 43 00 00       	push   $0x43ea
    16cb:	68 ea 43 00 00       	push   $0x43ea
    16d0:	e8 2f 23 00 00       	call   3a04 <link>
  ...
  unlink("lf2");
    ...
    16e8:	e8 07 23 00 00       	call   39f4 <unlink>
  if(link("lf2", "lf1") >= 0){
    16ed:	59                   	pop    %ecx
    16ee:	5b                   	pop    %ebx
    16ef:	68 e6 43 00 00       	push   $0x43e6
    16f4:	68 ea 43 00 00       	push   $0x43ea
    16f9:	e8 06 23 00 00       	call   3a04 <link>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1712:	e8 ed 22 00 00       	call   3a04 <link>
  ...
  printf(1, "linktest ok\n");
    ...
    exit();
    1743:	e8 5c 22 00 00       	call   39a4 <exit>
    ...
    exit();
    1756:	e8 49 22 00 00       	call   39a4 <exit>
    ...
    exit();
    1769:	e8 36 22 00 00       	call   39a4 <exit>
    ...
    exit();
    177c:	e8 23 22 00 00       	call   39a4 <exit>
    ...
    exit();
    178f:	e8 10 22 00 00       	call   39a4 <exit>
    ...
    exit();
    17a2:	e8 fd 21 00 00       	call   39a4 <exit>
    ...
    exit();
    17b5:	e8 ea 21 00 00       	call   39a4 <exit>
    ...
    exit();
    17c8:	e8 d7 21 00 00       	call   39a4 <exit>
    ...
    exit();
    17db:	e8 c4 21 00 00       	call   39a4 <exit>
    ...
    17e5:	31 f6                	xor    %esi,%esi
{
  ...
  for(i = 0; i < 40; i++){
    ...
    1829:	53                   	push   %ebx
    182a:	e8 b5 21 00 00       	call   39e4 <open>
      if(fd < 0){
  ...
  for(i = 0; i < 40; i++){
    1839:	83 c6 01             	add    $0x1,%esi
      close(fd);
    183c:	50                   	push   %eax
    183d:	e8 8a 21 00 00       	call   39cc <close>
    1842:	83 c4 10             	add    $0x10,%esp
      wait();
    1845:	e8 62 21 00 00       	call   39ac <wait>
  for(i = 0; i < 40; i++){
    ...
    unlink(file);
    185d:	e8 92 21 00 00       	call   39f4 <unlink>
    pid = fork();
    1862:	e8 35 21 00 00       	call   399c <fork>
    if(pid && (i % 3) == 1){
    ...
    1884:	53                   	push   %ebx
    1885:	e8 5a 21 00 00       	call   39e4 <open>
      if(fd < 0){
  ...
  for(i = 0; i < 40; i++){
    ...
    18dc:	e8 23 21 00 00       	call   3a04 <link>
    18e1:	83 c4 10             	add    $0x10,%esp
      wait();
    18e4:	e8 c3 20 00 00       	call   39ac <wait>
  for(i = 0; i < 40; i++){
  ...
  fd = open(".", 0);
    ...
    190e:	e8 d1 20 00 00       	call   39e4 <open>
  n = 0;
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1925:	57                   	push   %edi
    1926:	56                   	push   %esi
    1927:	e8 90 20 00 00       	call   39bc <read>
  ...
  close(fd);
    ...
    1973:	56                   	push   %esi
    1974:	e8 53 20 00 00       	call   39cc <close>
  if(n != 40){
  ...
  for(i = 0; i < 40; i++){
    ...
    199c:	53                   	push   %ebx
    199d:	e8 52 20 00 00       	call   39f4 <unlink>
      unlink(file);
    19a2:	89 1c 24             	mov    %ebx,(%esp)
    19a5:	e8 4a 20 00 00       	call   39f4 <unlink>
      unlink(file);
    19aa:	89 1c 24             	mov    %ebx,(%esp)
    19ad:	e8 42 20 00 00       	call   39f4 <unlink>
      unlink(file);
    19b2:	89 1c 24             	mov    %ebx,(%esp)
    19b5:	e8 3a 20 00 00       	call   39f4 <unlink>
    19ba:	83 c4 10             	add    $0x10,%esp
    if(pid == 0)
    19bd:	85 ff                	test   %edi,%edi
    19bf:	0f 84 fc fe ff ff    	je     18c1 <concreate+0xe1>
      wait();
    19c5:	e8 e2 1f 00 00       	call   39ac <wait>
  for(i = 0; i < 40; i++){
    ...
    pid = fork();
    19dc:	e8 bb 1f 00 00       	call   399c <fork>
    ...
    1a08:	6a 00                	push   $0x0
    1a0a:	53                   	push   %ebx
    1a0b:	e8 d4 1f 00 00       	call   39e4 <open>
    1a10:	89 04 24             	mov    %eax,(%esp)
    1a13:	e8 b4 1f 00 00       	call   39cc <close>
      close(open(file, 0));
    1a18:	58                   	pop    %eax
    1a19:	5a                   	pop    %edx
    1a1a:	6a 00                	push   $0x0
    1a1c:	53                   	push   %ebx
    1a1d:	e8 c2 1f 00 00       	call   39e4 <open>
    1a22:	89 04 24             	mov    %eax,(%esp)
    1a25:	e8 a2 1f 00 00       	call   39cc <close>
      close(open(file, 0));
    1a2a:	59                   	pop    %ecx
    1a2b:	58                   	pop    %eax
    1a2c:	6a 00                	push   $0x0
    1a2e:	53                   	push   %ebx
    1a2f:	e8 b0 1f 00 00       	call   39e4 <open>
    1a34:	89 04 24             	mov    %eax,(%esp)
    1a37:	e8 90 1f 00 00       	call   39cc <close>
      close(open(file, 0));
    1a3c:	58                   	pop    %eax
    1a3d:	5a                   	pop    %edx
    1a3e:	6a 00                	push   $0x0
    1a40:	53                   	push   %ebx
    1a41:	e8 9e 1f 00 00       	call   39e4 <open>
    1a46:	89 04 24             	mov    %eax,(%esp)
    1a49:	e8 7e 1f 00 00       	call   39cc <close>
  ...
  printf(1, "concreate ok\n");
    ...
    1a81:	e8 8a 20 00 00       	call   3b10 <printf>
      exit();
    1a86:	e8 19 1f 00 00       	call   39a4 <exit>
    ...
    exit();
    1a99:	e8 06 1f 00 00       	call   39a4 <exit>
    ...
    1aac:	e8 5f 20 00 00       	call   3b10 <printf>
        exit();
    1ab1:	e8 ee 1e 00 00       	call   39a4 <exit>
    ...
    1ac4:	e8 47 20 00 00       	call   3b10 <printf>
        exit();
    1ac9:	e8 d6 1e 00 00       	call   39a4 <exit>
      close(fd);
    1ace:	83 ec 0c             	sub    $0xc,%esp
    1ad1:	50                   	push   %eax
    1ad2:	e8 f5 1e 00 00       	call   39cc <close>
...
00001ae0 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1afc:	e8 f3 1e 00 00       	call   39f4 <unlink>
  pid = fork();
    1b01:	e8 96 1e 00 00       	call   399c <fork>
  if(pid < 0){
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1b3d:	e8 b2 1e 00 00       	call   39f4 <unlink>
  ...
  for(i = 0; i < 100; i++){
    ...
    1b76:	e8 69 1e 00 00       	call   39e4 <open>
    1b7b:	89 04 24             	mov    %eax,(%esp)
    1b7e:	e8 49 1e 00 00       	call   39cc <close>
  ...
  if(pid)
    ...
    wait();
    1b92:	e8 15 1e 00 00       	call   39ac <wait>
  printf(1, "linkunlink ok\n");
    ...
    1bbd:	e8 42 1e 00 00       	call   3a04 <link>
    ...
    exit();
    1bd8:	e8 c7 1d 00 00       	call   39a4 <exit>
    exit();
    1bdd:	e8 c2 1d 00 00       	call   39a4 <exit>
...
00001bf0 <bigdir>:
{
  ...
  unlink("bd");
    ...
    1c0c:	e8 e3 1d 00 00       	call   39f4 <unlink>
  fd = open("bd", O_CREATE);
    1c11:	5a                   	pop    %edx
    1c12:	59                   	pop    %ecx
    1c13:	68 00 02 00 00       	push   $0x200
    1c18:	68 35 45 00 00       	push   $0x4535
    1c1d:	e8 c2 1d 00 00       	call   39e4 <open>
  if(fd < 0){
  ...
  close(fd);
    1c35:	50                   	push   %eax
    1c36:	e8 91 1d 00 00       	call   39cc <close>
    ...
    if(link("bd", name) != 0){
    1c67:	e8 98 1d 00 00       	call   3a04 <link>
  ...
  unlink("bd");
    ...
    1c88:	e8 67 1d 00 00       	call   39f4 <unlink>
    ...
    if(unlink(name) != 0){
    1cb2:	e8 3d 1d 00 00       	call   39f4 <unlink>
  ...
  printf(1, "bigdir ok\n");
    ...
    1ced:	e8 1e 1e 00 00       	call   3b10 <printf>
      exit();
    1cf2:	e8 ad 1c 00 00       	call   39a4 <exit>
    ...
    1d01:	e8 0a 1e 00 00       	call   3b10 <printf>
      exit();
    1d06:	e8 99 1c 00 00       	call   39a4 <exit>
    ...
    exit();
    1d19:	e8 86 1c 00 00       	call   39a4 <exit>
...
00001d20 <subdir>:
{
  ...
  unlink("ff");
    ...
    1d3a:	e8 b5 1c 00 00       	call   39f4 <unlink>
  if(mkdir("dd") != 0){
    1d3f:	c7 04 24 a8 46 00 00 	movl   $0x46a8,(%esp)
    1d46:	e8 c1 1c 00 00       	call   3a0c <mkdir>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d63:	e8 7c 1c 00 00       	call   39e4 <open>
  if(fd < 0){
  ...
  write(fd, "ff", 2);
    ...
    1d7f:	50                   	push   %eax
    1d80:	e8 3f 1c 00 00       	call   39c4 <write>
  close(fd);
    1d85:	89 1c 24             	mov    %ebx,(%esp)
    1d88:	e8 3f 1c 00 00       	call   39cc <close>
  if(unlink("dd") >= 0){
    1d8d:	c7 04 24 a8 46 00 00 	movl   $0x46a8,(%esp)
    1d94:	e8 5b 1c 00 00       	call   39f4 <unlink>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    1dac:	e8 5b 1c 00 00       	call   3a0c <mkdir>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1dc9:	e8 16 1c 00 00       	call   39e4 <open>
  if(fd < 0){
  ...
  write(fd, "FF", 2);
    ...
    1de5:	50                   	push   %eax
    1de6:	e8 d9 1b 00 00       	call   39c4 <write>
  close(fd);
    1deb:	89 1c 24             	mov    %ebx,(%esp)
    1dee:	e8 d9 1b 00 00       	call   39cc <close>
  fd = open("dd/dd/../ff", 0);
    1df3:	58                   	pop    %eax
    1df4:	5a                   	pop    %edx
    1df5:	6a 00                	push   $0x0
    1df7:	68 02 46 00 00       	push   $0x4602
    1dfc:	e8 e3 1b 00 00       	call   39e4 <open>
  if(fd < 0){
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1e1b:	50                   	push   %eax
    1e1c:	e8 9b 1b 00 00       	call   39bc <read>
  if(cc != 2 || buf[0] != 'f'){
  ...
  close(fd);
    ...
    1e3d:	53                   	push   %ebx
    1e3e:	e8 89 1b 00 00       	call   39cc <close>
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    1e43:	59                   	pop    %ecx
    1e44:	5b                   	pop    %ebx
    1e45:	68 42 46 00 00       	push   $0x4642
    1e4a:	68 de 45 00 00       	push   $0x45de
    1e4f:	e8 b0 1b 00 00       	call   3a04 <link>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    1e67:	e8 88 1b 00 00       	call   39f4 <unlink>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1e81:	e8 5e 1b 00 00       	call   39e4 <open>
  ...
  if(chdir("dd") != 0){
    ...
    1e99:	e8 76 1b 00 00       	call   3a14 <chdir>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    1eb1:	e8 5e 1b 00 00       	call   3a14 <chdir>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    1ec9:	e8 46 1b 00 00       	call   3a14 <chdir>
  ...
  if(chdir("./..") != 0){
    ...
    1ee1:	e8 2e 1b 00 00       	call   3a14 <chdir>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1efb:	e8 e4 1a 00 00       	call   39e4 <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    1f1a:	50                   	push   %eax
    1f1b:	e8 9c 1a 00 00       	call   39bc <read>
  ...
  close(fd);
    ...
    1f2f:	53                   	push   %ebx
    1f30:	e8 97 1a 00 00       	call   39cc <close>
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    1f35:	58                   	pop    %eax
    1f36:	5a                   	pop    %edx
    1f37:	6a 00                	push   $0x0
    1f39:	68 de 45 00 00       	push   $0x45de
    1f3e:	e8 a1 1a 00 00       	call   39e4 <open>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f5b:	e8 84 1a 00 00       	call   39e4 <open>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f78:	e8 67 1a 00 00       	call   39e4 <open>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    1f95:	e8 4a 1a 00 00       	call   39e4 <open>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    1faf:	e8 30 1a 00 00       	call   39e4 <open>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    1fc9:	e8 16 1a 00 00       	call   39e4 <open>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    1fe6:	e8 19 1a 00 00       	call   3a04 <link>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    2003:	e8 fc 19 00 00       	call   3a04 <link>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    2020:	e8 df 19 00 00       	call   3a04 <link>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    2038:	e8 cf 19 00 00       	call   3a0c <mkdir>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    2050:	e8 b7 19 00 00       	call   3a0c <mkdir>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    2068:	e8 9f 19 00 00       	call   3a0c <mkdir>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    2080:	e8 6f 19 00 00       	call   39f4 <unlink>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    2098:	e8 57 19 00 00       	call   39f4 <unlink>
  ...
  if(chdir("dd/ff") == 0){
    ...
    20b0:	e8 5f 19 00 00       	call   3a14 <chdir>
  ...
  if(chdir("dd/xx") == 0){
    ...
    20c8:	e8 47 19 00 00       	call   3a14 <chdir>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    20e0:	e8 0f 19 00 00       	call   39f4 <unlink>
  ...
  if(unlink("dd/ff") != 0){
    ...
    20f8:	e8 f7 18 00 00       	call   39f4 <unlink>
  ...
  if(unlink("dd") == 0){
    ...
    2110:	e8 df 18 00 00       	call   39f4 <unlink>
  ...
  if(unlink("dd/dd") < 0){
    ...
    2128:	e8 c7 18 00 00       	call   39f4 <unlink>
  ...
  if(unlink("dd") < 0){
    ...
    2140:	e8 af 18 00 00       	call   39f4 <unlink>
  ...
  printf(1, "subdir ok\n");
    ...
    exit();
    2175:	e8 2a 18 00 00       	call   39a4 <exit>
    ...
    exit();
    2188:	e8 17 18 00 00       	call   39a4 <exit>
    ...
    exit();
    219b:	e8 04 18 00 00       	call   39a4 <exit>
    ...
    exit();
    21ae:	e8 f1 17 00 00       	call   39a4 <exit>
    ...
    exit();
    21c1:	e8 de 17 00 00       	call   39a4 <exit>
    ...
    exit();
    21d4:	e8 cb 17 00 00       	call   39a4 <exit>
    ...
    exit();
    21e7:	e8 b8 17 00 00       	call   39a4 <exit>
    ...
    exit();
    21fa:	e8 a5 17 00 00       	call   39a4 <exit>
    ...
    exit();
    220d:	e8 92 17 00 00       	call   39a4 <exit>
    ...
    exit();
    2220:	e8 7f 17 00 00       	call   39a4 <exit>
    ...
    exit();
    2233:	e8 6c 17 00 00       	call   39a4 <exit>
    ...
    exit();
    2246:	e8 59 17 00 00       	call   39a4 <exit>
    ...
    exit();
    2259:	e8 46 17 00 00       	call   39a4 <exit>
    ...
    exit();
    226c:	e8 33 17 00 00       	call   39a4 <exit>
    ...
    exit();
    227f:	e8 20 17 00 00       	call   39a4 <exit>
    ...
    exit();
    2292:	e8 0d 17 00 00       	call   39a4 <exit>
    ...
    exit();
    22a5:	e8 fa 16 00 00       	call   39a4 <exit>
    ...
    exit();
    22b8:	e8 e7 16 00 00       	call   39a4 <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded\n");
    22bd:	50                   	push   %eax
    22be:	50                   	push   %eax
    ...
    exit();
    22cb:	e8 d4 16 00 00       	call   39a4 <exit>
    ...
    exit();
    22de:	e8 c1 16 00 00       	call   39a4 <exit>
    ...
    exit();
    22f1:	e8 ae 16 00 00       	call   39a4 <exit>
    ...
    exit();
    2304:	e8 9b 16 00 00       	call   39a4 <exit>
    ...
    exit();
    2317:	e8 88 16 00 00       	call   39a4 <exit>
    ...
    exit();
    232a:	e8 75 16 00 00       	call   39a4 <exit>
    ...
    exit();
    233d:	e8 62 16 00 00       	call   39a4 <exit>
    ...
    exit();
    2350:	e8 4f 16 00 00       	call   39a4 <exit>
    ...
    exit();
    2363:	e8 3c 16 00 00       	call   39a4 <exit>
    ...
    exit();
    2376:	e8 29 16 00 00       	call   39a4 <exit>
    ...
    exit();
    2389:	e8 16 16 00 00       	call   39a4 <exit>
    ...
    exit();
    239c:	e8 03 16 00 00       	call   39a4 <exit>
    ...
    exit();
    23af:	e8 f0 15 00 00       	call   39a4 <exit>
    ...
    exit();
    23c2:	e8 dd 15 00 00       	call   39a4 <exit>
    ...
    exit();
    23d5:	e8 ca 15 00 00       	call   39a4 <exit>
    ...
    exit();
    23e8:	e8 b7 15 00 00       	call   39a4 <exit>
    ...
    exit();
    23fb:	e8 a4 15 00 00       	call   39a4 <exit>
...
00002400 <bigwrite>:
{
  ...
  unlink("bigwrite");
    ...
    2420:	e8 cf 15 00 00       	call   39f4 <unlink>
    ...
    243d:	e8 a2 15 00 00       	call   39e4 <open>
    if(fd < 0){
    ...
    2454:	50                   	push   %eax
    2455:	e8 6a 15 00 00       	call   39c4 <write>
      if(cc != sz){
    ...
    246a:	56                   	push   %esi
    246b:	e8 54 15 00 00       	call   39c4 <write>
      if(cc != sz){
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    close(fd);
    2480:	56                   	push   %esi
    2481:	e8 46 15 00 00       	call   39cc <close>
    unlink("bigwrite");
    2486:	c7 04 24 a4 48 00 00 	movl   $0x48a4,(%esp)
    248d:	e8 62 15 00 00       	call   39f4 <unlink>
  for(sz = 499; sz < 12*512; sz += 471){
  ...
  printf(1, "bigwrite ok\n");
    ...
    24bf:	e8 4c 16 00 00       	call   3b10 <printf>
        exit();
    24c4:	e8 db 14 00 00       	call   39a4 <exit>
    ...
    24d3:	e8 38 16 00 00       	call   3b10 <printf>
      exit();
    24d8:	e8 c7 14 00 00       	call   39a4 <exit>
...
000024e0 <bigfile>:
{
  ...
  unlink("bigfile");
    ...
    24fc:	e8 f3 14 00 00       	call   39f4 <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    2501:	58                   	pop    %eax
    2502:	5a                   	pop    %edx
    2503:	68 02 02 00 00       	push   $0x202
    2508:	68 00 49 00 00       	push   $0x4900
    250d:	e8 d2 14 00 00       	call   39e4 <open>
  if(fd < 0){
  ...
  for(i = 0; i < 20; i++){
    ...
    2548:	56                   	push   %esi
    2549:	e8 76 14 00 00       	call   39c4 <write>
  ...
  close(fd);
    ...
    2567:	56                   	push   %esi
    2568:	e8 5f 14 00 00       	call   39cc <close>
  fd = open("bigfile", 0);
    256d:	5e                   	pop    %esi
    256e:	5f                   	pop    %edi
    256f:	6a 00                	push   $0x0
    2571:	68 00 49 00 00       	push   $0x4900
    2576:	e8 69 14 00 00       	call   39e4 <open>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    25cb:	56                   	push   %esi
    25cc:	e8 eb 13 00 00       	call   39bc <read>
    if(cc < 0){
  ...
  close(fd);
    ...
    25dd:	56                   	push   %esi
    25de:	e8 e9 13 00 00       	call   39cc <close>
  if(total != 20*600){
  ...
  unlink("bigfile");
    ...
    25fa:	e8 f5 13 00 00       	call   39f4 <unlink>
  printf(1, "bigfile test ok\n");
    ...
    2622:	e8 e9 14 00 00       	call   3b10 <printf>
      exit();
    2627:	e8 78 13 00 00       	call   39a4 <exit>
    ...
    2636:	e8 d5 14 00 00       	call   3b10 <printf>
      exit();
    263b:	e8 64 13 00 00       	call   39a4 <exit>
    ...
    264a:	e8 c1 14 00 00       	call   3b10 <printf>
      exit();
    264f:	e8 50 13 00 00       	call   39a4 <exit>
    ...
    265e:	e8 ad 14 00 00       	call   3b10 <printf>
      exit();
    2663:	e8 3c 13 00 00       	call   39a4 <exit>
    ...
    exit();
    2676:	e8 29 13 00 00       	call   39a4 <exit>
    ...
    exit();
    2689:	e8 16 13 00 00       	call   39a4 <exit>
    ...
    exit();
    269c:	e8 03 13 00 00       	call   39a4 <exit>
...
000026b0 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    26c9:	e8 3e 13 00 00       	call   3a0c <mkdir>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    26e1:	e8 26 13 00 00       	call   3a0c <mkdir>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    26fe:	e8 e1 12 00 00       	call   39e4 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    2711:	50                   	push   %eax
    2712:	e8 b5 12 00 00       	call   39cc <close>
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    2717:	58                   	pop    %eax
    2718:	5a                   	pop    %edx
    2719:	6a 00                	push   $0x0
    271b:	68 58 52 00 00       	push   $0x5258
    2720:	e8 bf 12 00 00       	call   39e4 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    272f:	50                   	push   %eax
    2730:	e8 97 12 00 00       	call   39cc <close>
  if(mkdir("12345678901234/12345678901234") == 0){
    2735:	c7 04 24 cc 49 00 00 	movl   $0x49cc,(%esp)
    273c:	e8 cb 12 00 00       	call   3a0c <mkdir>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2750:	e8 b7 12 00 00       	call   3a0c <mkdir>
  ...
  printf(1, "fourteen ok\n");
    ...
    exit();
    277e:	e8 21 12 00 00       	call   39a4 <exit>
    ...
    exit();
    2791:	e8 0e 12 00 00       	call   39a4 <exit>
    ...
    exit();
    27a4:	e8 fb 11 00 00       	call   39a4 <exit>
    ...
    exit();
    27b7:	e8 e8 11 00 00       	call   39a4 <exit>
    ...
    exit();
    27ca:	e8 d5 11 00 00       	call   39a4 <exit>
    ...
    exit();
    27dd:	e8 c2 11 00 00       	call   39a4 <exit>
...
000027f0 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    2809:	e8 fe 11 00 00       	call   3a0c <mkdir>
  ...
  if(chdir("dots") != 0){
    ...
    2821:	e8 ee 11 00 00       	call   3a14 <chdir>
  ...
  if(unlink(".") == 0){
    ...
    2839:	e8 b6 11 00 00       	call   39f4 <unlink>
  ...
  if(unlink("..") == 0){
    ...
    2851:	e8 9e 11 00 00       	call   39f4 <unlink>
  ...
  if(chdir("/") != 0){
    ...
    2869:	e8 a6 11 00 00       	call   3a14 <chdir>
  ...
  if(unlink("dots/.") == 0){
    ...
    2881:	e8 6e 11 00 00       	call   39f4 <unlink>
  ...
  if(unlink("dots/..") == 0){
    ...
    2895:	e8 5a 11 00 00       	call   39f4 <unlink>
  ...
  if(unlink("dots") != 0){
    ...
    28a9:	e8 46 11 00 00       	call   39f4 <unlink>
  ...
  printf(1, "rmdot ok\n");
    ...
    exit();
    28d7:	e8 c8 10 00 00       	call   39a4 <exit>
    ...
    exit();
    28ea:	e8 b5 10 00 00       	call   39a4 <exit>
    ...
    exit();
    28fd:	e8 a2 10 00 00       	call   39a4 <exit>
    printf(1, "unlink dots/. worked!\n");
    2902:	51                   	push   %ecx
    2903:	51                   	push   %ecx
    ...
    exit();
    2910:	e8 8f 10 00 00       	call   39a4 <exit>
    printf(1, "chdir / failed\n");
    2915:	50                   	push   %eax
    2916:	50                   	push   %eax
    ...
    exit();
    2923:	e8 7c 10 00 00       	call   39a4 <exit>
    printf(1, "rm .. worked!\n");
    2928:	50                   	push   %eax
    2929:	50                   	push   %eax
    ...
    exit();
    2936:	e8 69 10 00 00       	call   39a4 <exit>
    printf(1, "rm . worked!\n");
    293b:	50                   	push   %eax
    293c:	50                   	push   %eax
    ...
    exit();
    2949:	e8 56 10 00 00       	call   39a4 <exit>
    ...
    exit();
    295c:	e8 43 10 00 00       	call   39a4 <exit>
...
00002970 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    298f:	e8 50 10 00 00       	call   39e4 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    29a2:	50                   	push   %eax
    29a3:	e8 24 10 00 00       	call   39cc <close>
  if(chdir("dirfile") == 0){
    29a8:	c7 04 24 b5 4a 00 00 	movl   $0x4ab5,(%esp)
    29af:	e8 60 10 00 00       	call   3a14 <chdir>
  ...
  fd = open("dirfile/xx", 0);
    ...
    29c9:	e8 16 10 00 00       	call   39e4 <open>
  if(fd >= 0){
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    29e6:	e8 f9 0f 00 00       	call   39e4 <open>
  if(fd >= 0){
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    29fe:	e8 09 10 00 00       	call   3a0c <mkdir>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    2a16:	e8 d9 0f 00 00       	call   39f4 <unlink>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2a33:	e8 cc 0f 00 00       	call   3a04 <link>
  ...
  if(unlink("dirfile") != 0){
    ...
    2a4b:	e8 a4 0f 00 00       	call   39f4 <unlink>
  ...
  fd = open(".", O_RDWR);
    ...
    2a65:	e8 7a 0f 00 00       	call   39e4 <open>
  if(fd >= 0){
  ...
  fd = open(".", 0);
    ...
    2a7f:	e8 60 0f 00 00       	call   39e4 <open>
  if(write(fd, "x", 1) > 0){
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2a90:	50                   	push   %eax
    2a91:	e8 2e 0f 00 00       	call   39c4 <write>
  ...
  close(fd);
    ...
    2aa0:	53                   	push   %ebx
    2aa1:	e8 26 0f 00 00       	call   39cc <close>
  printf(1, "dir vs file OK\n");
    ...
    exit();
    2aca:	e8 d5 0e 00 00       	call   39a4 <exit>
    ...
    exit();
    2add:	e8 c2 0e 00 00       	call   39a4 <exit>
    ...
    exit();
    2af0:	e8 af 0e 00 00       	call   39a4 <exit>
    ...
    exit();
    2b03:	e8 9c 0e 00 00       	call   39a4 <exit>
    ...
    exit();
    2b16:	e8 89 0e 00 00       	call   39a4 <exit>
    ...
    exit();
    2b29:	e8 76 0e 00 00       	call   39a4 <exit>
    ...
    exit();
    2b3c:	e8 63 0e 00 00       	call   39a4 <exit>
    ...
    exit();
    2b4f:	e8 50 0e 00 00       	call   39a4 <exit>
    ...
    exit();
    2b62:	e8 3d 0e 00 00       	call   39a4 <exit>
    ...
    2b74:	bb 33 00 00 00       	mov    $0x33,%ebx
{
  ...
  printf(1, "empty file name\n");
    ...
    2b98:	e8 6f 0e 00 00       	call   3a0c <mkdir>
    ...
    2bb0:	e8 5f 0e 00 00       	call   3a14 <chdir>
    ...
    2c1e:	50                   	push   %eax
    2c1f:	e8 a8 0d 00 00       	call   39cc <close>
    2c24:	83 c4 10             	add    $0x10,%esp
    unlink("xx");
    2c27:	83 ec 0c             	sub    $0xc,%esp
    2c2a:	68 90 47 00 00       	push   $0x4790
    2c2f:	e8 c0 0d 00 00       	call   39f4 <unlink>
  for(i = 0; i < 50 + 1; i++){
  ...
  chdir("/");
    ...
    2c48:	e8 c7 0d 00 00       	call   3a14 <chdir>
  printf(1, "empty file name OK\n");
    ...
    2c6d:	e8 9e 0e 00 00       	call   3b10 <printf>
      exit();
    2c72:	e8 2d 0d 00 00       	call   39a4 <exit>
    ...
    2c81:	e8 8a 0e 00 00       	call   3b10 <printf>
      exit();
    2c86:	e8 19 0d 00 00       	call   39a4 <exit>
    ...
    2c94:	31 db                	xor    %ebx,%ebx
{
  ...
  for(n=0; n<1000; n++){
    ...
    pid = fork();
    2cbd:	e8 da 0c 00 00       	call   399c <fork>
    if(pid < 0)
  ...
  for(; n > 0; n--){
    ...
    if(wait() < 0){
    2cd0:	e8 d7 0c 00 00       	call   39ac <wait>
  ...
  if(wait() != -1){
    2cde:	e8 c9 0c 00 00       	call   39ac <wait>
  ...
  printf(1, "fork test OK\n");
    ...
    2cfb:	c3                   	ret    
      exit();
    2cfc:	e8 a3 0c 00 00       	call   39a4 <exit>
    ...
    2d0b:	e8 00 0e 00 00       	call   3b10 <printf>
      exit();
    2d10:	e8 8f 0c 00 00       	call   39a4 <exit>
    ...
    exit();
    2d23:	e8 7c 0c 00 00       	call   39a4 <exit>
    ...
    exit();
    2d36:	e8 69 0c 00 00       	call   39a4 <exit>
    ...
    2d45:	31 f6                	xor    %esi,%esi
{
  ...
  for(i = 0; i < 5000; i++){
    ...
    2d85:	6a 01                	push   $0x1
    2d87:	e8 a0 0c 00 00       	call   3a2c <sbrk>
    if(b != a){
  ...
  pid = fork();
    2da8:	e8 ef 0b 00 00       	call   399c <fork>
  ...
  c = sbrk(1);
    2dbd:	6a 01                	push   $0x1
    2dbf:	e8 68 0c 00 00       	call   3a2c <sbrk>
  c = sbrk(1);
    2dc4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2dcb:	e8 5c 0c 00 00       	call   3a2c <sbrk>
  if(c != a + 1){
  ...
  wait();
    2de3:	e8 c4 0b 00 00       	call   39ac <wait>
  a = sbrk(0);
    2de8:	83 ec 0c             	sub    $0xc,%esp
    2deb:	6a 00                	push   $0x0
    2ded:	e8 3a 0c 00 00       	call   3a2c <sbrk>
  ...
  p = sbrk(amt);
    ...
    2dfe:	e8 29 0c 00 00       	call   3a2c <sbrk>
  if (p != a) {
  ...
  a = sbrk(0);
    ...
    2e11:	6a 00                	push   $0x0
    2e13:	e8 14 0c 00 00       	call   3a2c <sbrk>
  c = sbrk(-4096);
    2e18:	c7 04 24 00 f0 ff ff 	movl   $0xfffff000,(%esp)
  a = sbrk(0);
    2e1f:	89 c3                	mov    %eax,%ebx
  c = sbrk(-4096);
    2e21:	e8 06 0c 00 00       	call   3a2c <sbrk>
  ...
  c = sbrk(0);
    ...
    2e35:	6a 00                	push   $0x0
    2e37:	e8 f0 0b 00 00       	call   3a2c <sbrk>
  if(c != a - 4096){
  ...
  a = sbrk(0);
    ...
    2e50:	6a 00                	push   $0x0
    2e52:	e8 d5 0b 00 00       	call   3a2c <sbrk>
  c = sbrk(4096);
    2e57:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
  a = sbrk(0);
    2e5e:	89 c3                	mov    %eax,%ebx
  c = sbrk(4096);
    2e60:	e8 c7 0b 00 00       	call   3a2c <sbrk>
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    2e75:	6a 00                	push   $0x0
    2e77:	e8 b0 0b 00 00       	call   3a2c <sbrk>
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    ppid = getpid();
    2ed8:	e8 47 0b 00 00       	call   3a24 <getpid>
    2edd:	89 c6                	mov    %eax,%esi
    pid = fork();
    2edf:	e8 b8 0a 00 00       	call   399c <fork>
    if(pid < 0){
    ...
    wait();
    2ef2:	e8 b5 0a 00 00       	call   39ac <wait>
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
  ...
  if(pipe(fds) != 0){
    ...
    2f0b:	50                   	push   %eax
    2f0c:	e8 a3 0a 00 00       	call   39b4 <pipe>
    ...
    if((pids[i] = fork()) == 0){
    2f28:	e8 6f 0a 00 00       	call   399c <fork>
    ...
    2f48:	e8 6f 0a 00 00       	call   39bc <read>
  ...
  c = sbrk(4096);
    ...
    2f5f:	e8 c8 0a 00 00       	call   3a2c <sbrk>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    2f7a:	50                   	push   %eax
    2f7b:	e8 54 0a 00 00       	call   39d4 <kill>
    wait();
    2f80:	e8 27 0a 00 00       	call   39ac <wait>
  ...
  if(sbrk(0) > oldbrk)
    ...
    2f9b:	6a 00                	push   $0x0
    2f9d:	e8 8a 0a 00 00       	call   3a2c <sbrk>
    2fa2:	83 c4 10             	add    $0x10,%esp
    2fa5:	39 45 a4             	cmp    %eax,-0x5c(%ebp)
    2fa8:	72 68                	jb     3012 <sbrktest+0x2d2>
  printf(stdout, "sbrk test OK\n");
    2faa:	83 ec 08             	sub    $0x8,%esp
    2fad:	68 d0 4c 00 00       	push   $0x4cd0
    2fb2:	ff 35 d4 5f 00 00    	push   0x5fd4
    2fb8:	e8 53 0b 00 00       	call   3b10 <printf>
}
    ...
    exit();
    310c:	e8 93 08 00 00       	call   39a4 <exit>
    exit();
    3111:	e8 8e 08 00 00       	call   39a4 <exit>
    printf(stdout, "sbrk test failed post-fork\n");
    3116:	57                   	push   %edi
    3117:	57                   	push   %edi
    3118:	68 65 4c 00 00       	push   $0x4c65
    311d:	ff 35 d4 5f 00 00    	push   0x5fd4
    3123:	e8 e8 09 00 00       	call   3b10 <printf>
    exit();
    3128:	e8 77 08 00 00       	call   39a4 <exit>
    printf(stdout, "sbrk re-allocation failed, a %x c %x\n", a, c);
    312d:	56                   	push   %esi
    312e:	53                   	push   %ebx
    312f:	68 24 54 00 00       	push   $0x5424
    3134:	ff 35 d4 5f 00 00    	push   0x5fd4
    313a:	e8 d1 09 00 00       	call   3b10 <printf>
    exit();
    313f:	e8 60 08 00 00       	call   39a4 <exit>
    printf(stdout, "sbrk deallocation produced wrong address, a %x c %x\n", a, c);
    3144:	50                   	push   %eax
    3145:	53                   	push   %ebx
    3146:	68 ec 53 00 00       	push   $0x53ec
    314b:	ff 35 d4 5f 00 00    	push   0x5fd4
    3151:	e8 ba 09 00 00       	call   3b10 <printf>
    exit();
    3156:	e8 49 08 00 00       	call   39a4 <exit>
    printf(stdout, "sbrk could not deallocate\n");
    315b:	53                   	push   %ebx
    315c:	53                   	push   %ebx
    315d:	68 81 4c 00 00       	push   $0x4c81
    3162:	ff 35 d4 5f 00 00    	push   0x5fd4
    3168:	e8 a3 09 00 00       	call   3b10 <printf>
    exit();
    316d:	e8 32 08 00 00       	call   39a4 <exit>
    ...
    3194:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "validate test\n");
    ...
    31be:	6a 00                	push   $0x0
    31c0:	e8 6f 08 00 00       	call   3a34 <sleep>
    sleep(0);
    31c5:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    31cc:	e8 63 08 00 00       	call   3a34 <sleep>
    kill(pid);
    31d1:	89 1c 24             	mov    %ebx,(%esp)
    31d4:	e8 fb 07 00 00       	call   39d4 <kill>
    wait();
    31d9:	e8 ce 07 00 00       	call   39ac <wait>
    if(link("nosuchfile", (char*)p) != -1){
    31de:	58                   	pop    %eax
    31df:	5a                   	pop    %edx
    31e0:	56                   	push   %esi
    31e1:	68 ed 4c 00 00       	push   $0x4ced
    31e6:	e8 19 08 00 00       	call   3a04 <link>
  ...
  printf(stdout, "validate ok\n");
    ...
    3209:	ff 35 d4 5f 00 00    	push   0x5fd4
    ...
    321d:	c3                   	ret    
      exit();
    321e:	e8 81 07 00 00       	call   39a4 <exit>
      printf(stdout, "link should not succeed\n");
    3223:	83 ec 08             	sub    $0x8,%esp
    3226:	68 f8 4c 00 00       	push   $0x4cf8
    322b:	ff 35 d4 5f 00 00    	push   0x5fd4
    3231:	e8 da 08 00 00       	call   3b10 <printf>
      exit();
    3236:	e8 69 07 00 00       	call   39a4 <exit>
...
00003240 <bsstest>:
{
  ...
  printf(stdout, "bss test\n");
    ...
    324b:	ff 35 d4 5f 00 00    	push   0x5fd4
  ...
  printf(stdout, "bss test ok\n");
    ...
    327b:	ff 35 d4 5f 00 00    	push   0x5fd4
    ...
    3293:	ff 35 d4 5f 00 00    	push   0x5fd4
    3299:	e8 72 08 00 00       	call   3b10 <printf>
      exit();
    329e:	e8 01 07 00 00       	call   39a4 <exit>
...
000032b0 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    32bb:	e8 34 07 00 00       	call   39f4 <unlink>
  pid = fork();
    32c0:	e8 d7 06 00 00       	call   399c <fork>
  if(pid == 0){
  ...
  wait();
    32d2:	e8 d5 06 00 00       	call   39ac <wait>
  fd = open("bigarg-ok", 0);
    32d7:	83 ec 08             	sub    $0x8,%esp
    32da:	6a 00                	push   $0x0
    32dc:	68 46 4d 00 00       	push   $0x4d46
    32e1:	e8 fe 06 00 00       	call   39e4 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    32f4:	50                   	push   %eax
    32f5:	e8 d2 06 00 00       	call   39cc <close>
  unlink("bigarg-ok");
    32fa:	c7 04 24 46 4d 00 00 	movl   $0x4d46,(%esp)
    3301:	e8 ee 06 00 00       	call   39f4 <unlink>
}
    ...
    3310:	c7 04 85 20 a7 00 00 	movl   $0x54a0,0xa720(,%eax,4)
    3317:	a0 54 00 00 
    ...
    332a:	ff 35 d4 5f 00 00    	push   0x5fd4
    args[MAXARG-1] = 0;
    ...
    334b:	e8 8c 06 00 00       	call   39dc <exec>
    printf(stdout, "bigarg test ok\n");
    3350:	59                   	pop    %ecx
    3351:	58                   	pop    %eax
    3352:	68 5d 4d 00 00       	push   $0x4d5d
    3357:	ff 35 d4 5f 00 00    	push   0x5fd4
    ...
    336e:	e8 71 06 00 00       	call   39e4 <open>
    close(fd);
    3373:	89 04 24             	mov    %eax,(%esp)
    3376:	e8 51 06 00 00       	call   39cc <close>
    exit();
    337b:	e8 24 06 00 00       	call   39a4 <exit>
    printf(stdout, "bigarg test failed!\n");
    3380:	50                   	push   %eax
    3381:	50                   	push   %eax
    3382:	68 86 4d 00 00       	push   $0x4d86
    3387:	ff 35 d4 5f 00 00    	push   0x5fd4
    338d:	e8 7e 07 00 00       	call   3b10 <printf>
    exit();
    3392:	e8 0d 06 00 00       	call   39a4 <exit>
    printf(stdout, "bigargtest: fork failed\n");
    3397:	52                   	push   %edx
    3398:	52                   	push   %edx
    3399:	68 6d 4d 00 00       	push   $0x4d6d
    339e:	ff 35 d4 5f 00 00    	push   0x5fd4
    33a4:	e8 67 07 00 00       	call   3b10 <printf>
    exit();
    33a9:	e8 f6 05 00 00       	call   39a4 <exit>
    ...
    33b5:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "fsfull test\n");
    ...
    3458:	50                   	push   %eax
    3459:	e8 86 05 00 00       	call   39e4 <open>
    if(fd < 0){
    ...
    347f:	57                   	push   %edi
    3480:	e8 3f 05 00 00       	call   39c4 <write>
      if(cc < 512)
    ...
    34a2:	e8 25 05 00 00       	call   39cc <close>
    if(total == 0)
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    354b:	50                   	push   %eax
    354c:	e8 a3 04 00 00       	call   39f4 <unlink>
  while(nfiles >= 0){
...
00003580 <uio>:
{
  ...
  pid = fork();
    3592:	e8 05 04 00 00       	call   399c <fork>
  if(pid == 0){
  ...
  wait();
    35a0:	e8 07 04 00 00       	call   39ac <wait>
  printf(1, "uio test done\n");
    ...
    exit();
    35d8:	e8 c7 03 00 00       	call   39a4 <exit>
    printf (1, "fork failed\n");
    35dd:	50                   	push   %eax
    35de:	50                   	push   %eax
    ...
    exit();
    35eb:	e8 b4 03 00 00       	call   39a4 <exit>
...
000035f0 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    35fe:	e8 e1 03 00 00       	call   39e4 <open>
  if (fd < 0) {
  ...
  read(fd, sbrk(0) - 1, -1);
    ...
    360f:	6a 00                	push   $0x0
    3611:	e8 16 04 00 00       	call   3a2c <sbrk>
    3616:	83 c4 0c             	add    $0xc,%esp
    3619:	83 e8 01             	sub    $0x1,%eax
    361c:	6a ff                	push   $0xffffffff
    361e:	50                   	push   %eax
    361f:	53                   	push   %ebx
    3620:	e8 97 03 00 00       	call   39bc <read>
  close(fd);
    3625:	89 1c 24             	mov    %ebx,(%esp)
    3628:	e8 9f 03 00 00       	call   39cc <close>
    ...
    37a9:	31 db                	xor    %ebx,%ebx
{
  ...
  for(i=0; i+1 < max; ){
    ...
    37b5:	57                   	push   %edi
    37b6:	6a 00                	push   $0x0
    37b8:	e8 ff 01 00 00       	call   39bc <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
    ...
    381d:	e8 c2 01 00 00       	call   39e4 <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
    ...
    3831:	50                   	push   %eax
    3832:	e8 c5 01 00 00       	call   39fc <fstat>
  close(fd);
    3837:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
    383a:	89 c6                	mov    %eax,%esi
  close(fd);
    383c:	e8 8b 01 00 00       	call   39cc <close>
  return r;
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2) {
  ...
  if ((stack= malloc(2*PGSIZE)) == 0){
    38d6:	68 00 20 00 00       	push   $0x2000
    38db:	e8 60 04 00 00       	call   3d40 <malloc>
    38e0:	83 c4 10             	add    $0x10,%esp
    38e3:	85 c0                	test   %eax,%eax
    38e5:	74 25                	je     390c <thread_create+0x3c>
    return -1;
  }
  ...
  if((uint)stack % PGSIZE)
    ...
    38e9:	81 e2 ff 0f 00 00    	and    $0xfff,%edx
    38ef:	74 07                	je     38f8 <thread_create+0x28>
    stack = stack + (PGSIZE - (uint)stack % PGSIZE);
    38f1:	29 d0                	sub    %edx,%eax
    38f3:	05 00 10 00 00       	add    $0x1000,%eax

  int childPid = clone(start_routine, arg1, arg2, stack);
    38f8:	50                   	push   %eax
    38f9:	ff 75 10             	push   0x10(%ebp)
    38fc:	ff 75 0c             	push   0xc(%ebp)
    38ff:	ff 75 08             	push   0x8(%ebp)
    3902:	e8 3d 01 00 00       	call   3a44 <clone>
  ...
  return childPid;
    ...
    390c:	c9                   	leave  
    return -1;
    390d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
    3912:	c3                   	ret    
    3913:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    391a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
...
int thread_join() {
  ...
  int childpid = join(&stack);
    3924:	8d 45 f4             	lea    -0xc(%ebp),%eax
int thread_join() {
    3927:	83 ec 20             	sub    $0x20,%esp
  int childpid = join(&stack);
    392a:	50                   	push   %eax
    392b:	e8 1c 01 00 00       	call   3a4c <join>
    3930:	89 c3                	mov    %eax,%ebx
  free(stack);
    3932:	58                   	pop    %eax
    3933:	ff 75 f4             	push   -0xc(%ebp)
    3936:	e8 75 03 00 00       	call   3cb0 <free>
  return childpid;
}
    393b:	89 d8                	mov    %ebx,%eax
    393d:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    3940:	c9                   	leave  
    3941:	c3                   	ret    
    3942:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
void lock_init(lock_t *lock) {
  ...
  lock->turn = 0;
    395c:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
}
    3963:	5d                   	pop    %ebp
    3964:	c3                   	ret    
    3965:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    396c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

00003970 <lock_acquire>:

void lock_acquire(lock_t *lock) {
    3970:	55                   	push   %ebp
    3971:	89 e5                	mov    %esp,%ebp
    3973:	8b 55 08             	mov    0x8(%ebp),%edx
    __asm__ volatile("lock; xaddl %0, %1"
    3976:	8b 02                	mov    (%edx),%eax
    3978:	f0 0f c1 02          	lock xadd %eax,(%edx)
  int myturn = FetchAndAdd(&lock->ticket, lock->ticket);
  while (lock->turn != myturn)  ; // spin
    397c:	8b 52 04             	mov    0x4(%edx),%edx
    397f:	90                   	nop
    3980:	39 c2                	cmp    %eax,%edx
    3982:	75 fc                	jne    3980 <lock_acquire+0x10>
}
    3984:	5d                   	pop    %ebp
    3985:	c3                   	ret    
    3986:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    398d:	8d 76 00             	lea    0x0(%esi),%esi

00003990 <lock_release>:
...
void lock_release(lock_t *lock) {
  ...
  lock->turn = lock->turn + 1;
    3996:	83 40 04 01          	addl   $0x1,0x4(%eax)
    399a:	5d                   	pop    %ebp
    399b:	c3                   	ret    
...
SYSCALL(fork)
    399c:	b8 01 00 00 00       	mov    $0x1,%eax
    39a1:	cd 40                	int    $0x40
    39a3:	c3                   	ret    

000039a4 <exit>:
SYSCALL(exit)
    39a4:	b8 02 00 00 00       	mov    $0x2,%eax
    39a9:	cd 40                	int    $0x40
    39ab:	c3                   	ret    

000039ac <wait>:
SYSCALL(wait)
    39ac:	b8 03 00 00 00       	mov    $0x3,%eax
    39b1:	cd 40                	int    $0x40
    39b3:	c3                   	ret    

000039b4 <pipe>:
SYSCALL(pipe)
    39b4:	b8 04 00 00 00       	mov    $0x4,%eax
    39b9:	cd 40                	int    $0x40
    39bb:	c3                   	ret    

000039bc <read>:
SYSCALL(read)
    39bc:	b8 05 00 00 00       	mov    $0x5,%eax
    39c1:	cd 40                	int    $0x40
    39c3:	c3                   	ret    

000039c4 <write>:
SYSCALL(write)
    39c4:	b8 10 00 00 00       	mov    $0x10,%eax
    39c9:	cd 40                	int    $0x40
    39cb:	c3                   	ret    

000039cc <close>:
SYSCALL(close)
    39cc:	b8 15 00 00 00       	mov    $0x15,%eax
    39d1:	cd 40                	int    $0x40
    39d3:	c3                   	ret    

000039d4 <kill>:
SYSCALL(kill)
    39d4:	b8 06 00 00 00       	mov    $0x6,%eax
    39d9:	cd 40                	int    $0x40
    39db:	c3                   	ret    

000039dc <exec>:
SYSCALL(exec)
    39dc:	b8 07 00 00 00       	mov    $0x7,%eax
    39e1:	cd 40                	int    $0x40
    39e3:	c3                   	ret    

000039e4 <open>:
SYSCALL(open)
    39e4:	b8 0f 00 00 00       	mov    $0xf,%eax
    39e9:	cd 40                	int    $0x40
    39eb:	c3                   	ret    

000039ec <mknod>:
SYSCALL(mknod)
    39ec:	b8 11 00 00 00       	mov    $0x11,%eax
    39f1:	cd 40                	int    $0x40
    39f3:	c3                   	ret    

000039f4 <unlink>:
SYSCALL(unlink)
    39f4:	b8 12 00 00 00       	mov    $0x12,%eax
    39f9:	cd 40                	int    $0x40
    39fb:	c3                   	ret    

000039fc <fstat>:
SYSCALL(fstat)
    39fc:	b8 08 00 00 00       	mov    $0x8,%eax
    3a01:	cd 40                	int    $0x40
    3a03:	c3                   	ret    

00003a04 <link>:
SYSCALL(link)
    3a04:	b8 13 00 00 00       	mov    $0x13,%eax
    3a09:	cd 40                	int    $0x40
    3a0b:	c3                   	ret    

00003a0c <mkdir>:
SYSCALL(mkdir)
    3a0c:	b8 14 00 00 00       	mov    $0x14,%eax
    3a11:	cd 40                	int    $0x40
    3a13:	c3                   	ret    

00003a14 <chdir>:
SYSCALL(chdir)
    3a14:	b8 09 00 00 00       	mov    $0x9,%eax
    3a19:	cd 40                	int    $0x40
    3a1b:	c3                   	ret    

00003a1c <dup>:
SYSCALL(dup)
    3a1c:	b8 0a 00 00 00       	mov    $0xa,%eax
    3a21:	cd 40                	int    $0x40
    3a23:	c3                   	ret    

00003a24 <getpid>:
SYSCALL(getpid)
    3a24:	b8 0b 00 00 00       	mov    $0xb,%eax
    3a29:	cd 40                	int    $0x40
    3a2b:	c3                   	ret    

00003a2c <sbrk>:
SYSCALL(sbrk)
    3a2c:	b8 0c 00 00 00       	mov    $0xc,%eax
    3a31:	cd 40                	int    $0x40
    3a33:	c3                   	ret    

00003a34 <sleep>:
SYSCALL(sleep)
    3a34:	b8 0d 00 00 00       	mov    $0xd,%eax
    3a39:	cd 40                	int    $0x40
    3a3b:	c3                   	ret    

00003a3c <uptime>:
SYSCALL(uptime)
    3a3c:	b8 0e 00 00 00       	mov    $0xe,%eax
    3a41:	cd 40                	int    $0x40
    3a43:	c3                   	ret    

00003a44 <clone>:
SYSCALL(clone)
    3a44:	b8 16 00 00 00       	mov    $0x16,%eax
    3a49:	cd 40                	int    $0x40
    3a4b:	c3                   	ret    

00003a4c <join>:
SYSCALL(join)
    3a4c:	b8 17 00 00 00       	mov    $0x17,%eax
    3a51:	cd 40                	int    $0x40
    3a53:	c3                   	ret    
    ...
    3a6c:	89 d1                	mov    %edx,%ecx
{
  ...
  write(fd, &c, 1);
    ...
    3ade:	56                   	push   %esi
    3adf:	57                   	push   %edi
    3ae0:	e8 df fe ff ff       	call   39c4 <write>
  while(--i >= 0)
    ...
    3b19:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  write(fd, &c, 1);
    ...
    3b55:	57                   	push   %edi
    3b56:	56                   	push   %esi
    3b57:	e8 68 fe ff ff       	call   39c4 <write>
  ...
  write(fd, &c, 1);
    ...
    3bae:	e8 11 fe ff ff       	call   39c4 <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    3bbf:	57                   	push   %edi
    3bc0:	56                   	push   %esi
    3bc1:	e8 fe fd ff ff       	call   39c4 <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    3c2b:	57                   	push   %edi
    3c2c:	56                   	push   %esi
    3c2d:	e8 92 fd ff ff       	call   39c4 <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    3c6f:	e8 50 fd ff ff       	call   39c4 <write>
        ap++;
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3cb1:	a1 a0 a7 00 00       	mov    0xa7a0,%eax
{
  ...
  freep = p;
    ...
    3cf1:	5b                   	pop    %ebx
  freep = p;
    3cf2:	89 15 a0 a7 00 00    	mov    %edx,0xa7a0
}
    3cf8:	5e                   	pop    %esi
    3cf9:	5f                   	pop    %edi
    3cfa:	5d                   	pop    %ebp
  ...
  freep = p;
    3d2c:	89 15 a0 a7 00 00    	mov    %edx,0xa7a0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    3d4c:	8b 3d a0 a7 00 00    	mov    0xa7a0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    3d91:	8b 3d a0 a7 00 00    	mov    0xa7a0,%edi
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    3da3:	e8 84 fc ff ff       	call   3a2c <sbrk>
  if(p == (char*)-1)
  ...
  return freep;
    3dbf:	8b 15 a0 a7 00 00    	mov    0xa7a0,%edx
    ...
    3dec:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    3def:	89 15 a0 a7 00 00    	mov    %edx,0xa7a0
}
    ...
    3dff:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
    3e00:	c7 05 a0 a7 00 00 a4 	movl   $0xa7a4,0xa7a0
    3e07:	a7 00 00 
    base.s.size = 0;
    3e0a:	bf a4 a7 00 00       	mov    $0xa7a4,%edi
    base.s.ptr = freep = prevp = &base;
    3e0f:	c7 05 a4 a7 00 00 a4 	movl   $0xa7a4,0xa7a4
    3e16:	a7 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3e19:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
    3e1b:	c7 05 a8 a7 00 00 00 	movl   $0x0,0xa7a8
    3e22:	00 00 00 
    if(p->s.size >= nunits){
