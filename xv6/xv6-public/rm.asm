...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	push   (%ebx)
  35:	e8 ba 03 00 00       	call   3f4 <unlink>
  ...
  exit();
  4b:	e8 54 03 00 00       	call   3a4 <exit>
      printf(2, "rm: %s failed to delete\n", argv[i]);
  50:	50                   	push   %eax
  51:	ff 33                	push   (%ebx)
  ...
  6d:	e8 9e 04 00 00       	call   510 <printf>
    exit();
  72:	e8 2d 03 00 00       	call   3a4 <exit>
  77:	66 90                	xchg   %ax,%ax
  79:	66 90                	xchg   %ax,%ax
  7b:	66 90                	xchg   %ax,%ax
  7d:	66 90                	xchg   %ax,%ax
 ...
 1a9:	31 db                	xor    %ebx,%ebx
{
 ...
 1b5:	57                   	push   %edi
 1b6:	6a 00                	push   $0x0
 1b8:	e8 ff 01 00 00       	call   3bc <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 21d:	e8 c2 01 00 00       	call   3e4 <open>
  if(fd < 0)
 ...
 231:	50                   	push   %eax
 232:	e8 c5 01 00 00       	call   3fc <fstat>
  close(fd);
 237:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 23a:	89 c6                	mov    %eax,%esi
  close(fd);
 23c:	e8 8b 01 00 00       	call   3cc <close>
  return r;
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2) {
 ...
 2db:	e8 60 04 00 00       	call   740 <malloc>
 2e0:	83 c4 10             	add    $0x10,%esp
 2e3:	85 c0                	test   %eax,%eax
 2e5:	74 25                	je     30c <thread_create+0x3c>
    return -1;
  }
 ...
 2ef:	74 07                	je     2f8 <thread_create+0x28>
 ...
 302:	e8 3d 01 00 00       	call   444 <clone>
...
int thread_join() {
 327:	83 ec 20             	sub    $0x20,%esp
  int childpid = join(&stack);
 32a:	50                   	push   %eax
 32b:	e8 1c 01 00 00       	call   44c <join>
 330:	89 c3                	mov    %eax,%ebx
  free(stack);
 332:	58                   	pop    %eax
 333:	ff 75 f4             	push   -0xc(%ebp)
 336:	e8 75 03 00 00       	call   6b0 <free>
  return childpid;
}
...
void lock_acquire(lock_t *lock) {
 ...
 376:	8b 02                	mov    (%edx),%eax
 378:	f0 0f c1 02          	lock xadd %eax,(%edx)
  int myturn = FetchAndAdd(&lock->ticket, lock->ticket);
  while (lock->turn != myturn)  ; // spin
 37c:	8b 52 04             	mov    0x4(%edx),%edx
 37f:	90                   	nop
 380:	39 c2                	cmp    %eax,%edx
 382:	75 fc                	jne    380 <lock_acquire+0x10>
}
 384:	5d                   	pop    %ebp
 385:	c3                   	ret    
...
void lock_release(lock_t *lock) {
 ...
 396:	83 40 04 01          	addl   $0x1,0x4(%eax)
 39a:	5d                   	pop    %ebp
 39b:	c3                   	ret    
 ...
 46c:	89 d1                	mov    %edx,%ecx
{
 ...
 4de:	56                   	push   %esi
 4df:	57                   	push   %edi
 4e0:	e8 df fe ff ff       	call   3c4 <write>
  while(--i >= 0)
 ...
 519:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 555:	57                   	push   %edi
 556:	56                   	push   %esi
 557:	e8 68 fe ff ff       	call   3c4 <write>
 ...
 5ae:	e8 11 fe ff ff       	call   3c4 <write>
        putc(fd, c);
 ...
 5bf:	57                   	push   %edi
 5c0:	56                   	push   %esi
 5c1:	e8 fe fd ff ff       	call   3c4 <write>
        putc(fd, c);
 ...
 62b:	57                   	push   %edi
 62c:	56                   	push   %esi
 62d:	e8 92 fd ff ff       	call   3c4 <write>
        while(*s != 0){
 ...
 66c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 66f:	e8 50 fd ff ff       	call   3c4 <write>
        ap++;
...
free(void *ap)
{
 ...
 6b1:	a1 28 0c 00 00       	mov    0xc28,%eax
{
 ...
 6f1:	5b                   	pop    %ebx
  freep = p;
 6f2:	89 15 28 0c 00 00    	mov    %edx,0xc28
}
 6f8:	5e                   	pop    %esi
 6f9:	5f                   	pop    %edi
 6fa:	5d                   	pop    %ebp
 ...
 729:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 72c:	89 15 28 0c 00 00    	mov    %edx,0xc28
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 749:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 74c:	8b 3d 28 0c 00 00    	mov    0xc28,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 78f:	73 4f                	jae    7e0 <malloc+0xa0>
    ...
    if(p == freep)
 791:	8b 3d 28 0c 00 00    	mov    0xc28,%edi
 ...
 7a3:	e8 84 fc ff ff       	call   42c <sbrk>
  if(p == (char*)-1)
 ...
 7ba:	e8 f1 fe ff ff       	call   6b0 <free>
  return freep;
 7bf:	8b 15 28 0c 00 00    	mov    0xc28,%edx
 ...
 7ec:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7ef:	89 15 28 0c 00 00    	mov    %edx,0xc28
}
 ...
 7ff:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 800:	c7 05 28 0c 00 00 2c 	movl   $0xc2c,0xc28
 807:	0c 00 00 
    base.s.size = 0;
 80a:	bf 2c 0c 00 00       	mov    $0xc2c,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 819:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 81b:	c7 05 30 0c 00 00 00 	movl   $0x0,0xc30
 822:	00 00 00 
    if(p->s.size >= nunits){
