...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2) {
 ...
 302:	e8 2f 01 00 00       	call   436 <clone>
...
int thread_join() {
 327:	83 ec 20             	sub    $0x20,%esp
  int childpid = join(&stack);
 32a:	50                   	push   %eax
 32b:	e8 0e 01 00 00       	call   43e <join>
 330:	89 c3                	mov    %eax,%ebx
  free(stack);
 332:	58                   	pop    %eax
 333:	ff 75 f4             	push   -0xc(%ebp)
 336:	e8 65 03 00 00       	call   6a0 <free>
  return childpid;
}
...
free(void *ap)
{
 ...
 6a1:	a1 18 0c 00 00       	mov    0xc18,%eax
{
 ...
 6e1:	5b                   	pop    %ebx
  freep = p;
 6e2:	89 15 18 0c 00 00    	mov    %edx,0xc18
}
 6e8:	5e                   	pop    %esi
 6e9:	5f                   	pop    %edi
 6ea:	5d                   	pop    %ebp
 ...
 719:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 71c:	89 15 18 0c 00 00    	mov    %edx,0xc18
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 739:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 73c:	8b 3d 18 0c 00 00    	mov    0xc18,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 77f:	73 4f                	jae    7d0 <malloc+0xa0>
    ...
    if(p == freep)
 781:	8b 3d 18 0c 00 00    	mov    0xc18,%edi
 ...
 7aa:	e8 f1 fe ff ff       	call   6a0 <free>
  return freep;
 7af:	8b 15 18 0c 00 00    	mov    0xc18,%edx
 ...
 7dc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7df:	89 15 18 0c 00 00    	mov    %edx,0xc18
}
 ...
 7ef:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7f0:	c7 05 18 0c 00 00 1c 	movl   $0xc1c,0xc18
 7f7:	0c 00 00 
    base.s.size = 0;
 7fa:	bf 1c 0c 00 00       	mov    $0xc1c,%edi
    base.s.ptr = freep = prevp = &base;
 7ff:	c7 05 1c 0c 00 00 1c 	movl   $0xc1c,0xc1c
 806:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 809:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 80b:	c7 05 20 0c 00 00 00 	movl   $0x0,0xc20
 812:	00 00 00 
    if(p->s.size >= nunits){
