...
80103824:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103827:	c7 40 14 9f 5b 10 80 	movl   $0x80105b9f,0x14(%eax)
  p->context = (struct context*)sp;
...
80103c43:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103c49:	e8 e2 0a 00 00       	call   80104730 <popcli>
  if((np = allocproc()) == 0){
80103c4e:	e8 5d fb ff ff       	call   801037b0 <allocproc>
80103c53:	85 c0                	test   %eax,%eax
80103c55:	0f 84 20 01 00 00    	je     80103d7b <clone+0x14b>
  if((uint) stack % PGSIZE != 0){
80103c5b:	f7 45 14 ff 0f 00 00 	testl  $0xfff,0x14(%ebp)
80103c62:	0f 85 13 01 00 00    	jne    80103d7b <clone+0x14b>
80103c68:	89 c2                	mov    %eax,%edx
  np->pgdir = curproc->pgdir;
80103c6a:	8b 43 04             	mov    0x4(%ebx),%eax
  *np->tf = *curproc->tf;
80103c6d:	b9 13 00 00 00       	mov    $0x13,%ecx
  memmove((void*)sp, &arg2, sizeof(void *));
80103c72:	83 ec 04             	sub    $0x4,%esp
  *np->tf = *curproc->tf;
80103c75:	8b 7a 18             	mov    0x18(%edx),%edi
  np->tf->eax = 0;
80103c78:	89 55 d4             	mov    %edx,-0x2c(%ebp)
  np->pgdir = curproc->pgdir;
80103c7b:	89 42 04             	mov    %eax,0x4(%edx)
  np->sz = curproc->sz;
80103c7e:	8b 03                	mov    (%ebx),%eax
  np->parent = curproc;
80103c80:	89 5a 14             	mov    %ebx,0x14(%edx)
  np->sz = curproc->sz;
80103c83:	89 02                	mov    %eax,(%edx)
  *np->tf = *curproc->tf;
80103c85:	8b 73 18             	mov    0x18(%ebx),%esi
80103c88:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  np->tf->eax = 0;
80103c8a:	8b 42 18             	mov    0x18(%edx),%eax
80103c8d:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)
  memmove((void*)sp, &arg2, sizeof(void *));
80103c94:	8d 45 10             	lea    0x10(%ebp),%eax
80103c97:	6a 04                	push   $0x4
80103c99:	50                   	push   %eax
  sp -= sizeof(void *);
80103c9a:	8b 45 14             	mov    0x14(%ebp),%eax
80103c9d:	05 fc 0f 00 00       	add    $0xffc,%eax
  memmove((void*)sp, &arg2, sizeof(void *));
80103ca2:	50                   	push   %eax
80103ca3:	e8 e8 0c 00 00       	call   80104990 <memmove>
  memmove((void*)sp, &arg1, sizeof(void *));
80103ca8:	83 c4 0c             	add    $0xc,%esp
80103cab:	8d 45 0c             	lea    0xc(%ebp),%eax
80103cae:	6a 04                	push   $0x4
80103cb0:	50                   	push   %eax
  sp -= sizeof(void *);
80103cb1:	8b 45 14             	mov    0x14(%ebp),%eax
80103cb4:	05 f8 0f 00 00       	add    $0xff8,%eax
  memmove((void*)sp, &arg1, sizeof(void *));
80103cb9:	50                   	push   %eax
80103cba:	e8 d1 0c 00 00       	call   80104990 <memmove>
  sp -= 4;
80103cbf:	8b 45 14             	mov    0x14(%ebp),%eax
  memmove((void*)sp, &ret, 4);
80103cc2:	83 c4 0c             	add    $0xc,%esp
  unsigned int ret = 0xffffffff;
80103cc5:	c7 45 e4 ff ff ff ff 	movl   $0xffffffff,-0x1c(%ebp)
  memmove((void*)sp, &ret, 4);
80103ccc:	6a 04                	push   $0x4
  sp -= 4;
80103cce:	8d b0 f4 0f 00 00    	lea    0xff4(%eax),%esi
  memmove((void*)sp, &ret, 4);
80103cd4:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80103cd7:	50                   	push   %eax
80103cd8:	56                   	push   %esi
80103cd9:	e8 b2 0c 00 00       	call   80104990 <memmove>
  np->tf->esp = sp;
80103cde:	8b 55 d4             	mov    -0x2c(%ebp),%edx
  np->tf->eip = (uint)fcn;
80103ce1:	8b 4d 08             	mov    0x8(%ebp),%ecx
  curproc->numThreads++;
80103ce4:	83 c4 10             	add    $0x10,%esp
  np->tf->esp = sp;
80103ce7:	8b 42 18             	mov    0x18(%edx),%eax
  for(i = 0; i < NOFILE; i++)
80103cea:	89 d7                	mov    %edx,%edi
  np->tf->esp = sp;
80103cec:	89 70 44             	mov    %esi,0x44(%eax)
  np->tf->eip = (uint)fcn;
80103cef:	8b 42 18             	mov    0x18(%edx),%eax
  for(i = 0; i < NOFILE; i++)
80103cf2:	31 f6                	xor    %esi,%esi
  np->tf->eip = (uint)fcn;
80103cf4:	89 48 38             	mov    %ecx,0x38(%eax)
  curproc->numThreads++;
80103cf7:	83 43 7c 01          	addl   $0x1,0x7c(%ebx)
  for(i = 0; i < NOFILE; i++)
...
80103d06:	74 10                	je     80103d18 <clone+0xe8>
      np->ofile[i] = filedup(curproc->ofile[i]);
...
80103d1e:	75 e0                	jne    80103d00 <clone+0xd0>
  np->cwd = idup(curproc->cwd);
80103d20:	83 ec 0c             	sub    $0xc,%esp
80103d23:	ff 73 68             	push   0x68(%ebx)
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103d26:	83 c3 6c             	add    $0x6c,%ebx
  np->cwd = idup(curproc->cwd);
80103d29:	89 7d d4             	mov    %edi,-0x2c(%ebp)
...
80103d41:	e8 6a 0d 00 00       	call   80104ab0 <safestrcpy>
  pid = np->pid;
80103d46:	8b 55 d4             	mov    -0x2c(%ebp),%edx
80103d49:	8b 5a 10             	mov    0x10(%edx),%ebx
  acquire(&ptable.lock);
80103d4c:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80103d53:	e8 d8 0a 00 00       	call   80104830 <acquire>
  np->state = RUNNABLE;
80103d58:	8b 55 d4             	mov    -0x2c(%ebp),%edx
80103d5b:	c7 42 0c 03 00 00 00 	movl   $0x3,0xc(%edx)
  release(&ptable.lock);
80103d62:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80103d69:	e8 62 0a 00 00       	call   801047d0 <release>
  return pid;
80103d6e:	83 c4 10             	add    $0x10,%esp
}
80103d71:	8d 65 f4             	lea    -0xc(%ebp),%esp
80103d74:	89 d8                	mov    %ebx,%eax
80103d76:	5b                   	pop    %ebx
80103d77:	5e                   	pop    %esi
80103d78:	5f                   	pop    %edi
80103d79:	5d                   	pop    %ebp
...
80103d80:	eb ef                	jmp    80103d71 <clone+0x141>
...
80103d96:	83 ec 0c             	sub    $0xc,%esp
  struct cpu *c = mycpu();
80103d99:	e8 52 fb ff ff       	call   801038f0 <mycpu>
  c->proc = 0;
...
80103dbe:	e8 6d 0a 00 00       	call   80104830 <acquire>
...
80103de0:	e8 4b 2f 00 00       	call   80106d30 <switchuvm>
...
80103deb:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103df2:	e8 14 0d 00 00       	call   80104b0b <swtch>
      switchkvm();
...
80103e34:	53                   	push   %ebx
  pushcli();
80103e35:	e8 a6 08 00 00       	call   801046e0 <pushcli>
  c = mycpu();
80103e3a:	e8 b1 fa ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80103e3f:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103e45:	e8 e6 08 00 00       	call   80104730 <popcli>
  if(!holding(&ptable.lock))
80103e4a:	83 ec 0c             	sub    $0xc,%esp
80103e4d:	68 20 1d 11 80       	push   $0x80111d20
80103e52:	e8 39 09 00 00       	call   80104790 <holding>
80103e57:	83 c4 10             	add    $0x10,%esp
80103e5a:	85 c0                	test   %eax,%eax
80103e5c:	74 4f                	je     80103ead <sched+0x7d>
  if(mycpu()->ncli != 1)
80103e5e:	e8 8d fa ff ff       	call   801038f0 <mycpu>
...
80103e77:	75 41                	jne    80103eba <sched+0x8a>
  intena = mycpu()->intena;
80103e79:	e8 72 fa ff ff       	call   801038f0 <mycpu>
  swtch(&p->context, mycpu()->scheduler);
80103e7e:	83 c3 1c             	add    $0x1c,%ebx
  intena = mycpu()->intena;
80103e81:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103e87:	e8 64 fa ff ff       	call   801038f0 <mycpu>
80103e8c:	83 ec 08             	sub    $0x8,%esp
80103e8f:	ff 70 04             	push   0x4(%eax)
80103e92:	53                   	push   %ebx
80103e93:	e8 73 0c 00 00       	call   80104b0b <swtch>
  mycpu()->intena = intena;
80103e98:	e8 53 fa ff ff       	call   801038f0 <mycpu>
}
...
80103ef6:	83 ec 0c             	sub    $0xc,%esp
  struct proc *curproc = myproc();
80103ef9:	e8 72 fa ff ff       	call   80103970 <myproc>
  if(curproc == initproc)
80103efe:	39 05 54 3d 11 80    	cmp    %eax,0x80113d54
80103f04:	0f 84 04 01 00 00    	je     8010400e <exit+0x11e>
...
80103f22:	e8 c9 cf ff ff       	call   80100ef0 <fileclose>
      curproc->ofile[fd] = 0;
...
80103f35:	75 e1                	jne    80103f18 <exit+0x28>
  begin_op();
80103f37:	e8 24 ee ff ff       	call   80102d60 <begin_op>
  iput(curproc->cwd);
80103f3c:	83 ec 0c             	sub    $0xc,%esp
80103f3f:	ff 73 68             	push   0x68(%ebx)
80103f42:	e8 69 d9 ff ff       	call   801018b0 <iput>
  end_op();
80103f47:	e8 84 ee ff ff       	call   80102dd0 <end_op>
  curproc->cwd = 0;
80103f4c:	c7 43 68 00 00 00 00 	movl   $0x0,0x68(%ebx)
  acquire(&ptable.lock);
80103f53:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80103f5a:	e8 d1 08 00 00       	call   80104830 <acquire>
...
80103f8f:	3d 54 3d 11 80       	cmp    $0x80113d54,%eax
80103f94:	75 e4                	jne    80103f7a <exit+0x8a>
      p->parent = initproc;
80103f96:	8b 0d 54 3d 11 80    	mov    0x80113d54,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80103fa7:	90                   	nop
80103fa8:	83 ea 80             	sub    $0xffffff80,%edx
80103fab:	81 fa 54 3d 11 80    	cmp    $0x80113d54,%edx
...
80103fd3:	3d 54 3d 11 80       	cmp    $0x80113d54,%eax
...
80103fee:	8b 43 14             	mov    0x14(%ebx),%eax
80103ff1:	83 68 7c 01          	subl   $0x1,0x7c(%eax)
  curproc->state = ZOMBIE;
80103ff5:	c7 43 0c 05 00 00 00 	movl   $0x5,0xc(%ebx)
  sched();
80103ffc:	e8 2f fe ff ff       	call   80103e30 <sched>
  panic("zombie exit");
80104001:	83 ec 0c             	sub    $0xc,%esp
80104004:	68 a8 7a 10 80       	push   $0x80107aa8
80104009:	e8 72 c3 ff ff       	call   80100380 <panic>
    panic("init exiting");
8010400e:	83 ec 0c             	sub    $0xc,%esp
80104011:	68 9b 7a 10 80       	push   $0x80107a9b
80104016:	e8 65 c3 ff ff       	call   80100380 <panic>
...
80104024:	53                   	push   %ebx
  pushcli();
80104025:	e8 b6 06 00 00       	call   801046e0 <pushcli>
  c = mycpu();
8010402a:	e8 c1 f8 ff ff       	call   801038f0 <mycpu>
  p = c->proc;
8010402f:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104035:	e8 f6 06 00 00       	call   80104730 <popcli>
  acquire(&ptable.lock);
8010403a:	83 ec 0c             	sub    $0xc,%esp
8010403d:	68 20 1d 11 80       	push   $0x80111d20
80104042:	e8 e9 07 00 00       	call   80104830 <acquire>
80104047:	83 c4 10             	add    $0x10,%esp
    havekids = 0;
8010404a:	31 d2                	xor    %edx,%edx
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010404c:	b8 54 1d 11 80       	mov    $0x80111d54,%eax
80104051:	eb 0f                	jmp    80104062 <join+0x42>
80104053:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104057:	90                   	nop
80104058:	83 e8 80             	sub    $0xffffff80,%eax
8010405b:	3d 54 3d 11 80       	cmp    $0x80113d54,%eax
80104060:	74 22                	je     80104084 <join+0x64>
      if(p->parent != curproc || p->pgdir != curproc->pgdir)
80104062:	39 58 14             	cmp    %ebx,0x14(%eax)
80104065:	75 f1                	jne    80104058 <join+0x38>
80104067:	8b 4b 04             	mov    0x4(%ebx),%ecx
8010406a:	39 48 04             	cmp    %ecx,0x4(%eax)
8010406d:	75 e9                	jne    80104058 <join+0x38>
      if(p->state == ZOMBIE){
8010406f:	83 78 0c 05          	cmpl   $0x5,0xc(%eax)
80104073:	74 53                	je     801040c8 <join+0xa8>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104075:	83 e8 80             	sub    $0xffffff80,%eax
      havekids = 1;
80104078:	ba 01 00 00 00       	mov    $0x1,%edx
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010407d:	3d 54 3d 11 80       	cmp    $0x80113d54,%eax
80104082:	75 de                	jne    80104062 <join+0x42>
    if(!havekids || curproc->killed){
80104084:	85 d2                	test   %edx,%edx
80104086:	0f 84 84 00 00 00    	je     80104110 <join+0xf0>
8010408c:	8b 43 24             	mov    0x24(%ebx),%eax
8010408f:	85 c0                	test   %eax,%eax
80104091:	75 7d                	jne    80104110 <join+0xf0>
  pushcli();
80104093:	e8 48 06 00 00       	call   801046e0 <pushcli>
  c = mycpu();
80104098:	e8 53 f8 ff ff       	call   801038f0 <mycpu>
  p = c->proc;
8010409d:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
801040a3:	e8 88 06 00 00       	call   80104730 <popcli>
  if(p == 0)
801040a8:	85 f6                	test   %esi,%esi
801040aa:	74 7b                	je     80104127 <join+0x107>
  p->chan = chan;
801040ac:	89 5e 20             	mov    %ebx,0x20(%esi)
  p->state = SLEEPING;
801040af:	c7 46 0c 02 00 00 00 	movl   $0x2,0xc(%esi)
  sched();
801040b6:	e8 75 fd ff ff       	call   80103e30 <sched>
  p->chan = 0;
801040bb:	c7 46 20 00 00 00 00 	movl   $0x0,0x20(%esi)
}
801040c2:	eb 86                	jmp    8010404a <join+0x2a>
801040c4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        pid = p->pid;
801040c8:	8b 58 10             	mov    0x10(%eax),%ebx
        p->name[0] = 0;
801040cb:	c6 40 6c 00          	movb   $0x0,0x6c(%eax)
        kfree((char*)*stack); // not sure if it should be dereferenced or not
801040cf:	83 ec 0c             	sub    $0xc,%esp
        p->pid = 0;
801040d2:	c7 40 10 00 00 00 00 	movl   $0x0,0x10(%eax)
        p->parent = 0;
801040d9:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
        p->killed = 0;
801040e0:	c7 40 24 00 00 00 00 	movl   $0x0,0x24(%eax)
        p->state = UNUSED;
801040e7:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
        kfree((char*)*stack); // not sure if it should be dereferenced or not
801040ee:	8b 45 08             	mov    0x8(%ebp),%eax
801040f1:	ff 30                	push   (%eax)
801040f3:	e8 c8 e3 ff ff       	call   801024c0 <kfree>
        release(&ptable.lock);
801040f8:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
801040ff:	e8 cc 06 00 00       	call   801047d0 <release>
        return pid;
80104104:	83 c4 10             	add    $0x10,%esp
}
80104107:	8d 65 f8             	lea    -0x8(%ebp),%esp
8010410a:	89 d8                	mov    %ebx,%eax
8010410c:	5b                   	pop    %ebx
8010410d:	5e                   	pop    %esi
8010410e:	5d                   	pop    %ebp
8010410f:	c3                   	ret    
...
80104113:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
      release(&ptable.lock);
80104118:	68 20 1d 11 80       	push   $0x80111d20
8010411d:	e8 ae 06 00 00       	call   801047d0 <release>
      return -1;
80104122:	83 c4 10             	add    $0x10,%esp
80104125:	eb e0                	jmp    80104107 <join+0xe7>
    panic("sleep");
80104127:	83 ec 0c             	sub    $0xc,%esp
8010412a:	68 b4 7a 10 80       	push   $0x80107ab4
...
80104181:	74 23                	je     801041a6 <wait+0x66>
      if(p->parent != curproc || p->pgdir == curproc->pgdir)
80104183:	39 73 14             	cmp    %esi,0x14(%ebx)
80104186:	75 f0                	jne    80104178 <wait+0x38>
80104188:	8b 56 04             	mov    0x4(%esi),%edx
8010418b:	39 53 04             	cmp    %edx,0x4(%ebx)
8010418e:	74 e8                	je     80104178 <wait+0x38>
      if(p->state == ZOMBIE){
80104190:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
80104194:	74 62                	je     801041f8 <wait+0xb8>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104196:	83 eb 80             	sub    $0xffffff80,%ebx
      havekids = 1;
80104199:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010419e:	81 fb 54 3d 11 80    	cmp    $0x80113d54,%ebx
801041a4:	75 dd                	jne    80104183 <wait+0x43>
    if(!havekids || curproc->killed){
801041a6:	85 c0                	test   %eax,%eax
801041a8:	0f 84 ad 00 00 00    	je     8010425b <wait+0x11b>
801041ae:	8b 46 24             	mov    0x24(%esi),%eax
801041b1:	85 c0                	test   %eax,%eax
801041b3:	0f 85 a2 00 00 00    	jne    8010425b <wait+0x11b>
  pushcli();
801041b9:	e8 22 05 00 00       	call   801046e0 <pushcli>
  c = mycpu();
801041be:	e8 2d f7 ff ff       	call   801038f0 <mycpu>
  p = c->proc;
801041c3:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801041c9:	e8 62 05 00 00       	call   80104730 <popcli>
  if(p == 0)
801041ce:	85 db                	test   %ebx,%ebx
801041d0:	0f 84 9c 00 00 00    	je     80104272 <wait+0x132>
  p->chan = chan;
801041d6:	89 73 20             	mov    %esi,0x20(%ebx)
  p->state = SLEEPING;
801041d9:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
801041e0:	e8 4b fc ff ff       	call   80103e30 <sched>
  p->chan = 0;
801041e5:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
}
801041ec:	e9 79 ff ff ff       	jmp    8010416a <wait+0x2a>
801041f1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        if (p->numThreads==0){
801041f8:	8b 4b 7c             	mov    0x7c(%ebx),%ecx
        pid = p->pid;
801041fb:	8b 73 10             	mov    0x10(%ebx),%esi
        if (p->numThreads==0){
801041fe:	85 c9                	test   %ecx,%ecx
80104200:	74 39                	je     8010423b <wait+0xfb>
        release(&ptable.lock);
...
8010421e:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80104225:	68 20 1d 11 80       	push   $0x80111d20
8010422a:	e8 a1 05 00 00       	call   801047d0 <release>
        return pid;
8010422f:	83 c4 10             	add    $0x10,%esp
}
80104232:	8d 65 f8             	lea    -0x8(%ebp),%esp
80104235:	89 f0                	mov    %esi,%eax
80104237:	5b                   	pop    %ebx
80104238:	5e                   	pop    %esi
80104239:	5d                   	pop    %ebp
8010423a:	c3                   	ret    
...
8010423e:	ff 73 08             	push   0x8(%ebx)
80104241:	e8 7a e2 ff ff       	call   801024c0 <kfree>
          p->kstack = 0;
80104246:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
          freevm(p->pgdir);
8010424d:	5a                   	pop    %edx
8010424e:	ff 73 04             	push   0x4(%ebx)
80104251:	e8 ba 2e 00 00       	call   80107110 <freevm>
80104256:	83 c4 10             	add    $0x10,%esp
80104259:	eb a7                	jmp    80104202 <wait+0xc2>
      release(&ptable.lock);
8010425b:	83 ec 0c             	sub    $0xc,%esp
      return -1;
8010425e:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
80104263:	68 20 1d 11 80       	push   $0x80111d20
80104268:	e8 63 05 00 00       	call   801047d0 <release>
      return -1;
8010426d:	83 c4 10             	add    $0x10,%esp
80104270:	eb c0                	jmp    80104232 <wait+0xf2>
    panic("sleep");
80104272:	83 ec 0c             	sub    $0xc,%esp
80104275:	68 b4 7a 10 80       	push   $0x80107ab4
8010427a:	e8 01 c1 ff ff       	call   80100380 <panic>
8010427f:	90                   	nop
...
801042a6:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  sched();
801042ad:	e8 7e fb ff ff       	call   80103e30 <sched>
  release(&ptable.lock);
...
80104320:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
80104327:	e8 04 fb ff ff       	call   80103e30 <sched>
  p->chan = 0;
...
8010435b:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
80104362:	e8 c9 fa ff ff       	call   80103e30 <sched>
  p->chan = 0;
...
80105933:	83 ec 08             	sub    $0x8,%esp
  exit();
80105936:	e8 b5 e5 ff ff       	call   80103ef0 <exit>
...
{
  return wait();
80105940:	e9 fb e7 ff ff       	jmp    80104140 <wait>
...
80105ae8:	78 5e                	js     80105b48 <sys_clone+0x78>
...
80105aff:	78 47                	js     80105b48 <sys_clone+0x78>
...
80105b16:	78 30                	js     80105b48 <sys_clone+0x78>
80105b18:	83 ec 04             	sub    $0x4,%esp
80105b1b:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105b1e:	6a 01                	push   $0x1
...
80105b2d:	78 19                	js     80105b48 <sys_clone+0x78>
    return -1;
  return clone(fcn, arg1, arg2, stack);
80105b2f:	ff 75 f4             	push   -0xc(%ebp)
80105b32:	ff 75 f0             	push   -0x10(%ebp)
80105b35:	ff 75 ec             	push   -0x14(%ebp)
80105b38:	ff 75 e8             	push   -0x18(%ebp)
80105b3b:	e8 f0 e0 ff ff       	call   80103c30 <clone>
...
80105b5c:	6a 01                	push   $0x1
80105b5e:	e8 9d f0 ff ff       	call   80104c00 <argptr>
80105b63:	83 c4 10             	add    $0x10,%esp
80105b66:	85 c0                	test   %eax,%eax
80105b68:	78 16                	js     80105b80 <sys_join+0x30>
    return -1;
  return join(stack);
80105b6a:	83 ec 0c             	sub    $0xc,%esp
80105b6d:	ff 75 f4             	push   -0xc(%ebp)
80105b70:	e8 ab e4 ff ff       	call   80104020 <join>
...
80105e13:	5d                   	pop    %ebp
      exit();
80105e14:	e9 d7 e0 ff ff       	jmp    80103ef0 <exit>
