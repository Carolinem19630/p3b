   ...
   e:	be 0a 00 00 00       	mov    $0xa,%esi
{
  ...
  15:	83 ec 0c             	sub    $0xc,%esp
   ppid = getpid();
  18:	e8 37 05 00 00       	call   554 <getpid>
  1d:	a3 00 0e 00 00       	mov    %eax,0xe00

   int i, thread_pid, join_pid;
   for(i = 0; i < 10; i++) {
  22:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      global = 1;
  28:	c7 05 fc 0d 00 00 01 	movl   $0x1,0xdfc
  2f:	00 00 00 
  ...
  53:	0f 85 84 00 00 00    	jne    dd <main+0xdd>
      assert(global == 5);
  59:	a1 fc 0d 00 00       	mov    0xdfc,%eax
...
//	  printf(1, "%d\n", (uint)sbrk(0));
  ...
  6a:	6a 00                	push   $0x0
  6c:	e8 eb 04 00 00       	call   55c <sbrk>
  ...
  84:	50                   	push   %eax
  85:	50                   	push   %eax
  86:	68 d9 09 00 00       	push   $0x9d9
  8b:	6a 01                	push   $0x1
  8d:	e8 ae 05 00 00       	call   640 <printf>
   exit();
  92:	e8 3d 04 00 00       	call   4d4 <exit>
      assert(thread_pid > 0);
  97:	6a 20                	push   $0x20
  99:	68 68 09 00 00       	push   $0x968
  9e:	68 72 09 00 00       	push   $0x972
  a3:	6a 01                	push   $0x1
  a5:	e8 96 05 00 00       	call   640 <printf>
  aa:	83 c4 0c             	add    $0xc,%esp
  ad:	68 a7 09 00 00       	push   $0x9a7
      assert(join_pid == thread_pid);
  b2:	68 86 09 00 00       	push   $0x986
  b7:	6a 01                	push   $0x1
  b9:	e8 82 05 00 00       	call   640 <printf>
  be:	5a                   	pop    %edx
  bf:	59                   	pop    %ecx
  c0:	68 9a 09 00 00       	push   $0x99a
  c5:	6a 01                	push   $0x1
  c7:	e8 74 05 00 00       	call   640 <printf>
  cc:	5b                   	pop    %ebx
  cd:	ff 35 00 0e 00 00    	push   0xe00
  d3:	e8 2c 04 00 00       	call   504 <kill>
  d8:	e8 f7 03 00 00       	call   4d4 <exit>
  dd:	6a 22                	push   $0x22
  df:	68 68 09 00 00       	push   $0x968
  e4:	68 72 09 00 00       	push   $0x972
  e9:	6a 01                	push   $0x1
  eb:	e8 50 05 00 00       	call   640 <printf>
  f0:	83 c4 0c             	add    $0xc,%esp
  f3:	68 b6 09 00 00       	push   $0x9b6
  f8:	eb b8                	jmp    b2 <main+0xb2>
      assert(global == 5);
  fa:	6a 23                	push   $0x23
  fc:	68 68 09 00 00       	push   $0x968
 101:	68 72 09 00 00       	push   $0x972
 106:	6a 01                	push   $0x1
 108:	e8 33 05 00 00       	call   640 <printf>
 10d:	83 c4 0c             	add    $0xc,%esp
 110:	68 cd 09 00 00       	push   $0x9cd
 115:	eb 9b                	jmp    b2 <main+0xb2>
      assert((uint)sbrk(0) < (150 * 4096) && "shouldn't even come close");
 117:	6a 25                	push   $0x25
 119:	68 68 09 00 00       	push   $0x968
 11e:	68 72 09 00 00       	push   $0x972
 123:	6a 01                	push   $0x1
 125:	e8 16 05 00 00       	call   640 <printf>
 12a:	83 c4 0c             	add    $0xc,%esp
 12d:	68 e8 09 00 00       	push   $0x9e8
...
worker(void *arg1, void *arg2) {
 ...
 143:	83 ec 08             	sub    $0x8,%esp
   assert(global == 1);
 146:	a1 fc 0d 00 00       	mov    0xdfc,%eax
 14b:	83 f8 01             	cmp    $0x1,%eax
 14e:	74 46                	je     196 <worker+0x56>
 150:	6a 2e                	push   $0x2e
 152:	68 68 09 00 00       	push   $0x968
 157:	68 72 09 00 00       	push   $0x972
 15c:	6a 01                	push   $0x1
 15e:	e8 dd 04 00 00       	call   640 <printf>
 163:	83 c4 0c             	add    $0xc,%esp
 166:	68 7a 09 00 00       	push   $0x97a
 16b:	68 86 09 00 00       	push   $0x986
 170:	6a 01                	push   $0x1
 172:	e8 c9 04 00 00       	call   640 <printf>
 177:	58                   	pop    %eax
 178:	5a                   	pop    %edx
 179:	68 9a 09 00 00       	push   $0x99a
 17e:	6a 01                	push   $0x1
 180:	e8 bb 04 00 00       	call   640 <printf>
 185:	59                   	pop    %ecx
 186:	ff 35 00 0e 00 00    	push   0xe00
 18c:	e8 73 03 00 00       	call   504 <kill>
 191:	e8 3e 03 00 00       	call   4d4 <exit>
   global += 4;
 196:	a1 fc 0d 00 00       	mov    0xdfc,%eax
 19b:	83 c0 04             	add    $0x4,%eax
 19e:	a3 fc 0d 00 00       	mov    %eax,0xdfc
   exit();
 1a3:	e8 2c 03 00 00       	call   4d4 <exit>
 ...
 59c:	89 d1                	mov    %edx,%ecx
{
 ...
 5c9:	0f b6 92 84 0a 00 00 	movzbl 0xa84(%edx),%edx
 ...
 649:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 6b9:	ff 24 85 2c 0a 00 00 	jmp    *0xa2c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 7c7:	90                   	nop
          s = "(null)";
 7c8:	ba 24 0a 00 00       	mov    $0xa24,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 7e1:	a1 04 0e 00 00       	mov    0xe04,%eax
{
 ...
 821:	5b                   	pop    %ebx
  freep = p;
 822:	89 15 04 0e 00 00    	mov    %edx,0xe04
}
 828:	5e                   	pop    %esi
 829:	5f                   	pop    %edi
 82a:	5d                   	pop    %ebp
 ...
 859:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 85c:	89 15 04 0e 00 00    	mov    %edx,0xe04
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 879:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 87c:	8b 3d 04 0e 00 00    	mov    0xe04,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 8bf:	73 4f                	jae    910 <malloc+0xa0>
    ...
    if(p == freep)
 8c1:	8b 3d 04 0e 00 00    	mov    0xe04,%edi
 ...
 8ea:	e8 f1 fe ff ff       	call   7e0 <free>
  return freep;
 8ef:	8b 15 04 0e 00 00    	mov    0xe04,%edx
 ...
 91c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 91f:	89 15 04 0e 00 00    	mov    %edx,0xe04
}
 ...
 92f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 930:	c7 05 04 0e 00 00 08 	movl   $0xe08,0xe04
 937:	0e 00 00 
    base.s.size = 0;
 93a:	bf 08 0e 00 00       	mov    $0xe08,%edi
    base.s.ptr = freep = prevp = &base;
 93f:	c7 05 08 0e 00 00 08 	movl   $0xe08,0xe08
 946:	0e 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 949:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 94b:	c7 05 0c 0e 00 00 00 	movl   $0x0,0xe0c
 952:	00 00 00 
    if(p->s.size >= nunits){
