...
main(int argc, char *argv[])
{
   ...
   e:	51                   	push   %ecx
   ppid = getpid();
   f:	e8 02 05 00 00       	call   516 <getpid>

   lock_init(&lock);
  14:	83 ec 0c             	sub    $0xc,%esp
  17:	68 80 0d 00 00       	push   $0xd80
   ppid = getpid();
  ...
  26:	a1 7c 0d 00 00       	mov    0xd7c,%eax
  ...
  40:	a1 7c 0d 00 00       	mov    0xd7c,%eax
  ...
  a0:	e8 21 04 00 00       	call   4c6 <kill>
  a5:	e8 ec 03 00 00       	call   496 <exit>
   for (i = 0; i < num_threads; i++) {
  ...
  b8:	a1 7c 0d 00 00       	mov    0xd7c,%eax
  ...
  ea:	0f af 05 78 0d 00 00 	imul   0xd78,%eax
 ...
 122:	e8 d9 04 00 00       	call   600 <printf>
   exit();
 127:	e8 6a 03 00 00       	call   496 <exit>
...
worker(void *arg1, void *arg2) {
 ...
 134:	83 ec 04             	sub    $0x4,%esp
   int i, j, tmp;
   for (i = 0; i < loops; i++) {
 137:	a1 78 0d 00 00       	mov    0xd78,%eax
 ...
 16e:	39 1d 78 0d 00 00    	cmp    %ebx,0xd78
 174:	7f d2                	jg     148 <worker+0x18>
   }
   exit();
 176:	e8 1b 03 00 00       	call   496 <exit>
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2) {
 ...
 402:	e8 2f 01 00 00       	call   536 <clone>
...
int thread_join() {
 427:	83 ec 20             	sub    $0x20,%esp
  int childpid = join(&stack);
 42a:	50                   	push   %eax
 42b:	e8 0e 01 00 00       	call   53e <join>
 430:	89 c3                	mov    %eax,%ebx
  free(stack);
 432:	58                   	pop    %eax
 433:	ff 75 f4             	push   -0xc(%ebp)
 436:	e8 65 03 00 00       	call   7a0 <free>
  return childpid;
}
