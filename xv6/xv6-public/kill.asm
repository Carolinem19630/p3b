...
main(int argc, char **argv)
{
  ...
  39:	e8 76 03 00 00       	call   3b4 <kill>
  for(i=1; i<argc; i++)
  3e:	83 c4 10             	add    $0x10,%esp
  41:	39 de                	cmp    %ebx,%esi
  43:	75 e3                	jne    28 <main+0x28>
  exit();
  45:	e8 3a 03 00 00       	call   384 <exit>
    printf(2, "usage: kill pid...\n");
  4a:	50                   	push   %eax
  4b:	50                   	push   %eax
  ...
  53:	e8 98 04 00 00       	call   4f0 <printf>
    exit();
  58:	e8 27 03 00 00       	call   384 <exit>
  5d:	66 90                	xchg   %ax,%ax
  5f:	90                   	nop
 ...
 189:	31 db                	xor    %ebx,%ebx
{
 ...
 195:	57                   	push   %edi
 196:	6a 00                	push   $0x0
 198:	e8 ff 01 00 00       	call   39c <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1fd:	e8 c2 01 00 00       	call   3c4 <open>
  if(fd < 0)
 ...
 211:	50                   	push   %eax
 212:	e8 c5 01 00 00       	call   3dc <fstat>
  close(fd);
 217:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 21a:	89 c6                	mov    %eax,%esi
  close(fd);
 21c:	e8 8b 01 00 00       	call   3ac <close>
  return r;
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2) {
 ...
 2bb:	e8 60 04 00 00       	call   720 <malloc>
...
int thread_join() {
 ...
 316:	e8 75 03 00 00       	call   690 <free>
  return childpid;
}
...
void lock_acquire(lock_t *lock) {
 ...
 356:	8b 02                	mov    (%edx),%eax
 358:	f0 0f c1 02          	lock xadd %eax,(%edx)
  int myturn = FetchAndAdd(&lock->ticket, lock->ticket);
  while (lock->turn != myturn)  ; // spin
 35c:	8b 52 04             	mov    0x4(%edx),%edx
 35f:	90                   	nop
 360:	39 c2                	cmp    %eax,%edx
 362:	75 fc                	jne    360 <lock_acquire+0x10>
}
 364:	5d                   	pop    %ebp
 365:	c3                   	ret    
...
free(void *ap)
{
 ...
 691:	a1 f0 0b 00 00       	mov    0xbf0,%eax
{
 ...
 6d1:	5b                   	pop    %ebx
  freep = p;
 6d2:	89 15 f0 0b 00 00    	mov    %edx,0xbf0
}
 6d8:	5e                   	pop    %esi
 6d9:	5f                   	pop    %edi
 6da:	5d                   	pop    %ebp
 ...
 709:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 70c:	89 15 f0 0b 00 00    	mov    %edx,0xbf0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 729:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 72c:	8b 3d f0 0b 00 00    	mov    0xbf0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 76f:	73 4f                	jae    7c0 <malloc+0xa0>
    ...
    if(p == freep)
 771:	8b 3d f0 0b 00 00    	mov    0xbf0,%edi
 ...
 79a:	e8 f1 fe ff ff       	call   690 <free>
  return freep;
 79f:	8b 15 f0 0b 00 00    	mov    0xbf0,%edx
 ...
 7cc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7cf:	89 15 f0 0b 00 00    	mov    %edx,0xbf0
}
 ...
 7df:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7e0:	c7 05 f0 0b 00 00 f4 	movl   $0xbf4,0xbf0
 7e7:	0b 00 00 
    base.s.size = 0;
 7ea:	bf f4 0b 00 00       	mov    $0xbf4,%edi
    base.s.ptr = freep = prevp = &base;
 7ef:	c7 05 f4 0b 00 00 f4 	movl   $0xbf4,0xbf4
 7f6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7f9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7fb:	c7 05 f8 0b 00 00 00 	movl   $0x0,0xbf8
 802:	00 00 00 
    if(p->s.size >= nunits){
