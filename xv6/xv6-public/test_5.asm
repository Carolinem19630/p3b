...
main(int argc, char *argv[])
{
  ...
  11:	83 ec 18             	sub    $0x18,%esp
   ppid = getpid();
  14:	e8 fa 04 00 00       	call   513 <getpid>

   void *stack, *p = malloc(PGSIZE * 2);
  19:	83 ec 0c             	sub    $0xc,%esp
  1c:	68 00 20 00 00       	push   $0x2000
   ppid = getpid();
  21:	a3 0c 0d 00 00       	mov    %eax,0xd0c
   void *stack, *p = malloc(PGSIZE * 2);
  26:	e8 05 08 00 00       	call   830 <malloc>
   assert(p != NULL);
  ...
  60:	c7 45 e0 18 00 00 00 	movl   $0x18,-0x20(%ebp)
   int clone_pid = clone(worker, &arg1, &arg2, stack);
  67:	e8 c7 04 00 00       	call   533 <clone>
   assert(clone_pid > 0);
  ...
  7b:	50                   	push   %eax
  7c:	e8 ba 04 00 00       	call   53b <join>
  ...
  8f:	68 31 09 00 00       	push   $0x931
  94:	6a 01                	push   $0x1
  96:	e8 65 05 00 00       	call   600 <printf>
  9b:	83 c4 0c             	add    $0xc,%esp
  9e:	68 94 09 00 00       	push   $0x994
   assert(clone_pid > 0);
  a3:	68 44 09 00 00       	push   $0x944
  a8:	6a 01                	push   $0x1
  aa:	e8 51 05 00 00       	call   600 <printf>
  af:	5a                   	pop    %edx
  b0:	59                   	pop    %ecx
  b1:	68 58 09 00 00       	push   $0x958
  b6:	6a 01                	push   $0x1
  b8:	e8 43 05 00 00       	call   600 <printf>
  bd:	5b                   	pop    %ebx
  be:	ff 35 0c 0d 00 00    	push   0xd0c
  c4:	e8 fa 03 00 00       	call   4c3 <kill>
  c9:	e8 c5 03 00 00       	call   493 <exit>
  ce:	6a 25                	push   $0x25
  d0:	68 28 09 00 00       	push   $0x928
  d5:	68 31 09 00 00       	push   $0x931
  da:	6a 01                	push   $0x1
  dc:	e8 1f 05 00 00       	call   600 <printf>
  e1:	83 c4 0c             	add    $0xc,%esp
  e4:	68 86 09 00 00       	push   $0x986
  e9:	eb b8                	jmp    a3 <main+0xa3>
   assert(stack == join_stack);
  eb:	39 7d e4             	cmp    %edi,-0x1c(%ebp)
  ee:	74 1d                	je     10d <main+0x10d>
  f0:	6a 2a                	push   $0x2a
  f2:	68 28 09 00 00       	push   $0x928
  f7:	68 31 09 00 00       	push   $0x931
  fc:	6a 01                	push   $0x1
  fe:	e8 fd 04 00 00       	call   600 <printf>
 103:	83 c4 0c             	add    $0xc,%esp
 106:	68 aa 09 00 00       	push   $0x9aa
 10b:	eb 96                	jmp    a3 <main+0xa3>
   assert(global == 2);
 10d:	83 3d 08 0d 00 00 02 	cmpl   $0x2,0xd08
 114:	74 40                	je     156 <main+0x156>
 116:	6a 2b                	push   $0x2b
 118:	68 28 09 00 00       	push   $0x928
 11d:	68 31 09 00 00       	push   $0x931
 122:	6a 01                	push   $0x1
 124:	e8 d7 04 00 00       	call   600 <printf>
 129:	83 c4 0c             	add    $0xc,%esp
 12c:	68 be 09 00 00       	push   $0x9be
 131:	e9 6d ff ff ff       	jmp    a3 <main+0xa3>
   assert(p != NULL);
 136:	6a 1d                	push   $0x1d
 138:	68 28 09 00 00       	push   $0x928
 13d:	68 31 09 00 00       	push   $0x931
 142:	6a 01                	push   $0x1
 144:	e8 b7 04 00 00       	call   600 <printf>
 149:	83 c4 0c             	add    $0xc,%esp
 14c:	68 7c 09 00 00       	push   $0x97c
 151:	e9 4d ff ff ff       	jmp    a3 <main+0xa3>
   
   printf(1, "TEST PASSED\n");
 156:	50                   	push   %eax
 157:	50                   	push   %eax
 158:	68 ca 09 00 00       	push   $0x9ca
 15d:	6a 01                	push   $0x1
 15f:	e8 9c 04 00 00       	call   600 <printf>
   free(p);
 164:	89 1c 24             	mov    %ebx,(%esp)
 167:	e8 34 06 00 00       	call   7a0 <free>
   exit();
 16c:	e8 22 03 00 00       	call   493 <exit>
...
worker(void *arg1, void *arg2) {
 ...
 196:	75 2a                	jne    1c2 <worker+0x42>
   assert(global == 1);
 198:	83 3d 08 0d 00 00 01 	cmpl   $0x1,0xd08
 19f:	0f 84 80 00 00 00    	je     225 <worker+0xa5>
 1a5:	6a 38                	push   $0x38
 1a7:	68 28 09 00 00       	push   $0x928
 1ac:	68 31 09 00 00       	push   $0x931
 1b1:	6a 01                	push   $0x1
 1b3:	e8 48 04 00 00       	call   600 <printf>
 1b8:	83 c4 0c             	add    $0xc,%esp
 1bb:	68 70 09 00 00       	push   $0x970
 1c0:	eb 1b                	jmp    1dd <worker+0x5d>
   assert(tmp2 == 24);
 1c2:	6a 37                	push   $0x37
 1c4:	68 28 09 00 00       	push   $0x928
 1c9:	68 31 09 00 00       	push   $0x931
 1ce:	6a 01                	push   $0x1
 1d0:	e8 2b 04 00 00       	call   600 <printf>
 1d5:	83 c4 0c             	add    $0xc,%esp
 1d8:	68 65 09 00 00       	push   $0x965
 1dd:	68 44 09 00 00       	push   $0x944
 1e2:	6a 01                	push   $0x1
 1e4:	e8 17 04 00 00       	call   600 <printf>
 1e9:	58                   	pop    %eax
 1ea:	5a                   	pop    %edx
 1eb:	68 58 09 00 00       	push   $0x958
 1f0:	6a 01                	push   $0x1
 1f2:	e8 09 04 00 00       	call   600 <printf>
 1f7:	59                   	pop    %ecx
 1f8:	ff 35 0c 0d 00 00    	push   0xd0c
 1fe:	e8 c0 02 00 00       	call   4c3 <kill>
 203:	e8 8b 02 00 00       	call   493 <exit>
   assert(tmp1 == 42);
 208:	6a 36                	push   $0x36
 20a:	68 28 09 00 00       	push   $0x928
 20f:	68 31 09 00 00       	push   $0x931
 214:	6a 01                	push   $0x1
 216:	e8 e5 03 00 00       	call   600 <printf>
 21b:	83 c4 0c             	add    $0xc,%esp
 21e:	68 39 09 00 00       	push   $0x939
 223:	eb b8                	jmp    1dd <worker+0x5d>
   global++;
 225:	c7 05 08 0d 00 00 02 	movl   $0x2,0xd08
 22c:	00 00 00 
   exit();
 22f:	e8 5f 02 00 00       	call   493 <exit>
 ...
 609:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 787:	90                   	nop
          s = "(null)";
 788:	ba d7 09 00 00       	mov    $0x9d7,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 7a1:	a1 10 0d 00 00       	mov    0xd10,%eax
{
 ...
 7e1:	5b                   	pop    %ebx
  freep = p;
 7e2:	89 15 10 0d 00 00    	mov    %edx,0xd10
}
 7e8:	5e                   	pop    %esi
 7e9:	5f                   	pop    %edi
 7ea:	5d                   	pop    %ebp
 ...
 819:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 81c:	89 15 10 0d 00 00    	mov    %edx,0xd10
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 839:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 83c:	8b 3d 10 0d 00 00    	mov    0xd10,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 87f:	73 4f                	jae    8d0 <malloc+0xa0>
    ...
    if(p == freep)
 881:	8b 3d 10 0d 00 00    	mov    0xd10,%edi
 ...
 8aa:	e8 f1 fe ff ff       	call   7a0 <free>
  return freep;
 8af:	8b 15 10 0d 00 00    	mov    0xd10,%edx
 ...
 8dc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 8df:	89 15 10 0d 00 00    	mov    %edx,0xd10
}
 ...
 8ef:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 8f0:	c7 05 10 0d 00 00 14 	movl   $0xd14,0xd10
 8f7:	0d 00 00 
    base.s.size = 0;
 8fa:	bf 14 0d 00 00       	mov    $0xd14,%edi
    base.s.ptr = freep = prevp = &base;
 8ff:	c7 05 14 0d 00 00 14 	movl   $0xd14,0xd14
 906:	0d 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 909:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 90b:	c7 05 18 0d 00 00 00 	movl   $0x0,0xd18
 912:	00 00 00 
    if(p->s.size >= nunits){
