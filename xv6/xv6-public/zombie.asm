...
main(void)
{
  ...
  if(fork() > 0)
  11:	e8 36 03 00 00       	call   34c <fork>
  16:	85 c0                	test   %eax,%eax
  18:	7e 0d                	jle    27 <main+0x27>
    sleep(5);  // Let child exit before parent.
  1a:	83 ec 0c             	sub    $0xc,%esp
  1d:	6a 05                	push   $0x5
  1f:	e8 c0 03 00 00       	call   3e4 <sleep>
  24:	83 c4 10             	add    $0x10,%esp
  exit();
  27:	e8 28 03 00 00       	call   354 <exit>
  2c:	66 90                	xchg   %ax,%ax
  2e:	66 90                	xchg   %ax,%ax
 ...
 159:	31 db                	xor    %ebx,%ebx
{
 ...
 165:	57                   	push   %edi
 166:	6a 00                	push   $0x0
 168:	e8 ff 01 00 00       	call   36c <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1cd:	e8 c2 01 00 00       	call   394 <open>
  if(fd < 0)
 ...
 1e1:	50                   	push   %eax
 1e2:	e8 c5 01 00 00       	call   3ac <fstat>
  close(fd);
 1e7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 1ea:	89 c6                	mov    %eax,%esi
  close(fd);
 1ec:	e8 8b 01 00 00       	call   37c <close>
  return r;
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2) {
 ...
 28b:	e8 60 04 00 00       	call   6f0 <malloc>
 290:	83 c4 10             	add    $0x10,%esp
 293:	85 c0                	test   %eax,%eax
 295:	74 25                	je     2bc <thread_create+0x3c>
    return -1;
  }
 ...
 299:	81 e2 ff 0f 00 00    	and    $0xfff,%edx
 29f:	74 07                	je     2a8 <thread_create+0x28>
    stack = stack + (PGSIZE - (uint)stack % PGSIZE);
 2a1:	29 d0                	sub    %edx,%eax
 2a3:	05 00 10 00 00       	add    $0x1000,%eax

  int childPid = clone(start_routine, arg1, arg2, stack);
 2a8:	50                   	push   %eax
 2a9:	ff 75 10             	push   0x10(%ebp)
 2ac:	ff 75 0c             	push   0xc(%ebp)
 2af:	ff 75 08             	push   0x8(%ebp)
 2b2:	e8 3d 01 00 00       	call   3f4 <clone>
...
int thread_join() {
 ...
 2d4:	8d 45 f4             	lea    -0xc(%ebp),%eax
int thread_join() {
 2d7:	83 ec 20             	sub    $0x20,%esp
  int childpid = join(&stack);
 2da:	50                   	push   %eax
 2db:	e8 1c 01 00 00       	call   3fc <join>
 2e0:	89 c3                	mov    %eax,%ebx
  free(stack);
 2e2:	58                   	pop    %eax
 2e3:	ff 75 f4             	push   -0xc(%ebp)
 2e6:	e8 75 03 00 00       	call   660 <free>
  return childpid;
}
 2eb:	89 d8                	mov    %ebx,%eax
 2ed:	8b 5d fc             	mov    -0x4(%ebp),%ebx
 2f0:	c9                   	leave  
 2f1:	c3                   	ret    
...
void lock_init(lock_t *lock) {
 ...
 306:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  lock->turn = 0;
 30c:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
}
 313:	5d                   	pop    %ebp
 314:	c3                   	ret    
...
void lock_acquire(lock_t *lock) {
 ...
 326:	8b 02                	mov    (%edx),%eax
 328:	f0 0f c1 02          	lock xadd %eax,(%edx)
  int myturn = FetchAndAdd(&lock->ticket, lock->ticket);
  while (lock->turn != myturn)  ; // spin
 32c:	8b 52 04             	mov    0x4(%edx),%edx
 32f:	90                   	nop
 330:	39 c2                	cmp    %eax,%edx
 332:	75 fc                	jne    330 <lock_acquire+0x10>
}
 334:	5d                   	pop    %ebp
 335:	c3                   	ret    
...
void lock_release(lock_t *lock) {
 ...
 346:	83 40 04 01          	addl   $0x1,0x4(%eax)
 34a:	5d                   	pop    %ebp
 34b:	c3                   	ret    
 ...
 41c:	89 d1                	mov    %edx,%ecx
{
 ...
 48e:	56                   	push   %esi
 48f:	57                   	push   %edi
 490:	e8 df fe ff ff       	call   374 <write>
  while(--i >= 0)
 ...
 4c9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 505:	57                   	push   %edi
 506:	56                   	push   %esi
 507:	e8 68 fe ff ff       	call   374 <write>
 ...
 55e:	e8 11 fe ff ff       	call   374 <write>
        putc(fd, c);
 ...
 56f:	57                   	push   %edi
 570:	56                   	push   %esi
 571:	e8 fe fd ff ff       	call   374 <write>
        putc(fd, c);
 ...
 5db:	57                   	push   %edi
 5dc:	56                   	push   %esi
 5dd:	e8 92 fd ff ff       	call   374 <write>
        while(*s != 0){
 ...
 61c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 61f:	e8 50 fd ff ff       	call   374 <write>
        ap++;
...
free(void *ap)
{
 ...
 661:	a1 9c 0b 00 00       	mov    0xb9c,%eax
{
 ...
 6a1:	5b                   	pop    %ebx
  freep = p;
 6a2:	89 15 9c 0b 00 00    	mov    %edx,0xb9c
}
 6a8:	5e                   	pop    %esi
 6a9:	5f                   	pop    %edi
 6aa:	5d                   	pop    %ebp
 ...
 6d9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6dc:	89 15 9c 0b 00 00    	mov    %edx,0xb9c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6fc:	8b 3d 9c 0b 00 00    	mov    0xb9c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 73f:	73 4f                	jae    790 <malloc+0xa0>
    ...
    if(p == freep)
 741:	8b 3d 9c 0b 00 00    	mov    0xb9c,%edi
 ...
 753:	e8 84 fc ff ff       	call   3dc <sbrk>
  if(p == (char*)-1)
 ...
 76a:	e8 f1 fe ff ff       	call   660 <free>
  return freep;
 76f:	8b 15 9c 0b 00 00    	mov    0xb9c,%edx
 ...
 7b7:	0b 00 00 
    base.s.size = 0;
 7ba:	bf a0 0b 00 00       	mov    $0xba0,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 7c9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7cb:	c7 05 a4 0b 00 00 00 	movl   $0x0,0xba4
 7d2:	00 00 00 
    if(p->s.size >= nunits){
