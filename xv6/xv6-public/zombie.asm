...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2) {
 ...
 2b2:	e8 2f 01 00 00       	call   3e6 <clone>
...
int thread_join() {
 2d7:	83 ec 20             	sub    $0x20,%esp
  int childpid = join(&stack);
 2da:	50                   	push   %eax
 2db:	e8 0e 01 00 00       	call   3ee <join>
 2e0:	89 c3                	mov    %eax,%ebx
  free(stack);
 2e2:	58                   	pop    %eax
 2e3:	ff 75 f4             	push   -0xc(%ebp)
 2e6:	e8 65 03 00 00       	call   650 <free>
  return childpid;
}
...
free(void *ap)
{
 ...
 651:	a1 8c 0b 00 00       	mov    0xb8c,%eax
{
 ...
 691:	5b                   	pop    %ebx
  freep = p;
 692:	89 15 8c 0b 00 00    	mov    %edx,0xb8c
}
 698:	5e                   	pop    %esi
 699:	5f                   	pop    %edi
 69a:	5d                   	pop    %ebp
 ...
 6c9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6cc:	89 15 8c 0b 00 00    	mov    %edx,0xb8c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ec:	8b 3d 8c 0b 00 00    	mov    0xb8c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 72f:	73 4f                	jae    780 <malloc+0xa0>
    ...
    if(p == freep)
 731:	8b 3d 8c 0b 00 00    	mov    0xb8c,%edi
 ...
 75a:	e8 f1 fe ff ff       	call   650 <free>
  return freep;
 75f:	8b 15 8c 0b 00 00    	mov    0xb8c,%edx
 ...
 78c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 78f:	89 15 8c 0b 00 00    	mov    %edx,0xb8c
}
 ...
 79f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7a0:	c7 05 8c 0b 00 00 90 	movl   $0xb90,0xb8c
 7a7:	0b 00 00 
    base.s.size = 0;
 7aa:	bf 90 0b 00 00       	mov    $0xb90,%edi
    base.s.ptr = freep = prevp = &base;
 7af:	c7 05 90 0b 00 00 90 	movl   $0xb90,0xb90
 7b6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7b9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7bb:	c7 05 94 0b 00 00 00 	movl   $0x0,0xb94
 7c2:	00 00 00 
    if(p->s.size >= nunits){
