...
main(int argc, char *argv[])
{
  ...
  10:	83 ec 0c             	sub    $0xc,%esp
   ppid = getpid();
  13:	e8 8b 04 00 00       	call   4a3 <getpid>
   void *stack, *p = malloc(PGSIZE * 2);
  18:	83 ec 0c             	sub    $0xc,%esp
  1b:	68 00 20 00 00       	push   $0x2000
   ppid = getpid();
  20:	a3 94 0c 00 00       	mov    %eax,0xc94
   void *stack, *p = malloc(PGSIZE * 2);
  25:	e8 96 07 00 00       	call   7c0 <malloc>
   assert(p != NULL);
  ...
  4d:	e8 71 04 00 00       	call   4c3 <clone>
  52:	83 c4 10             	add    $0x10,%esp
  55:	83 f8 ff             	cmp    $0xffffffff,%eax
  58:	74 46                	je     a0 <main+0xa0>
  5a:	6a 21                	push   $0x21
  5c:	68 b8 08 00 00       	push   $0x8b8
  61:	68 c1 08 00 00       	push   $0x8c1
  66:	6a 01                	push   $0x1
  68:	e8 23 05 00 00       	call   590 <printf>
  6d:	83 c4 0c             	add    $0xc,%esp
  70:	68 1c 09 00 00       	push   $0x91c
  75:	68 d3 08 00 00       	push   $0x8d3
  7a:	6a 01                	push   $0x1
  7c:	e8 0f 05 00 00       	call   590 <printf>
  81:	5a                   	pop    %edx
  82:	59                   	pop    %ecx
  83:	68 e7 08 00 00       	push   $0x8e7
  88:	6a 01                	push   $0x1
  8a:	e8 01 05 00 00       	call   590 <printf>
  8f:	5b                   	pop    %ebx
  90:	ff 35 94 0c 00 00    	push   0xc94
  96:	e8 b8 03 00 00       	call   453 <kill>
  9b:	e8 83 03 00 00       	call   423 <exit>

   stack = sbrk(0);
  a0:	83 ec 0c             	sub    $0xc,%esp
  a3:	6a 00                	push   $0x0
  a5:	e8 01 04 00 00       	call   4ab <sbrk>
  ...
  f6:	68 c1 08 00 00       	push   $0x8c1
  fb:	6a 01                	push   $0x1
  fd:	e8 8e 04 00 00       	call   590 <printf>
 ...
 159:	e9 17 ff ff ff       	jmp    75 <main+0x75>
   assert(p != NULL);
 15e:	6a 1b                	push   $0x1b
 160:	68 b8 08 00 00       	push   $0x8b8
 165:	68 c1 08 00 00       	push   $0x8c1
 16a:	6a 01                	push   $0x1
 16c:	e8 1f 04 00 00       	call   590 <printf>
 171:	83 c4 0c             	add    $0xc,%esp
 174:	68 c9 08 00 00       	push   $0x8c9
 ...
 188:	e8 36 03 00 00       	call   4c3 <clone>
 ...
 19c:	50                   	push   %eax
 19d:	50                   	push   %eax
 19e:	68 0e 09 00 00       	push   $0x90e
 1a3:	6a 01                	push   $0x1
 1a5:	e8 e6 03 00 00       	call   590 <printf>
   free(p);
 1aa:	89 1c 24             	mov    %ebx,(%esp)
 1ad:	e8 7e 05 00 00       	call   730 <free>
   exit();
...
worker(void *arg1, void *arg2) {
 ...
 1c3:	83 ec 08             	sub    $0x8,%esp
   exit();
 1c6:	e8 58 02 00 00       	call   423 <exit>
 ...
 4ec:	89 d1                	mov    %edx,%ecx
{
 ...
 519:	0f b6 92 c8 09 00 00 	movzbl 0x9c8(%edx),%edx
 ...
 599:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 609:	ff 24 85 70 09 00 00 	jmp    *0x970(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 717:	90                   	nop
          s = "(null)";
 718:	ba 68 09 00 00       	mov    $0x968,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 731:	a1 98 0c 00 00       	mov    0xc98,%eax
{
 ...
 771:	5b                   	pop    %ebx
  freep = p;
 772:	89 15 98 0c 00 00    	mov    %edx,0xc98
}
 778:	5e                   	pop    %esi
 779:	5f                   	pop    %edi
 77a:	5d                   	pop    %ebp
 ...
 7a9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 7ac:	89 15 98 0c 00 00    	mov    %edx,0xc98
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7cc:	8b 3d 98 0c 00 00    	mov    0xc98,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 80f:	73 4f                	jae    860 <malloc+0xa0>
    ...
    if(p == freep)
 811:	8b 3d 98 0c 00 00    	mov    0xc98,%edi
 ...
 83a:	e8 f1 fe ff ff       	call   730 <free>
  return freep;
 83f:	8b 15 98 0c 00 00    	mov    0xc98,%edx
 ...
 887:	0c 00 00 
    base.s.size = 0;
 88a:	bf 9c 0c 00 00       	mov    $0xc9c,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 899:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 89b:	c7 05 a0 0c 00 00 00 	movl   $0x0,0xca0
 8a2:	00 00 00 
    if(p->s.size >= nunits){
