...
main(int argc, char *argv[])
{
 ...
 165:	68 8f 09 00 00       	push   $0x98f
 16a:	6a 01                	push   $0x1
 16c:	e8 ef 04 00 00       	call   660 <printf>
 171:	83 c4 0c             	add    $0xc,%esp
 174:	68 97 09 00 00       	push   $0x997
