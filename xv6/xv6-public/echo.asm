...
main(int argc, char *argv[])
{
  ...
  exit();
  65:	e8 2a 03 00 00       	call   394 <exit>
  6a:	66 90                	xchg   %ax,%ax
  6c:	66 90                	xchg   %ax,%ax
  6e:	66 90                	xchg   %ax,%ax
 ...
 199:	31 db                	xor    %ebx,%ebx
{
 ...
 1a5:	57                   	push   %edi
 1a6:	6a 00                	push   $0x0
 1a8:	e8 ff 01 00 00       	call   3ac <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 20d:	e8 c2 01 00 00       	call   3d4 <open>
  if(fd < 0)
 ...
 221:	50                   	push   %eax
 222:	e8 c5 01 00 00       	call   3ec <fstat>
  close(fd);
 227:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 22a:	89 c6                	mov    %eax,%esi
  close(fd);
 22c:	e8 8b 01 00 00       	call   3bc <close>
  return r;
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2) {
 ...
 2cb:	e8 60 04 00 00       	call   730 <malloc>
 2d0:	83 c4 10             	add    $0x10,%esp
 2d3:	85 c0                	test   %eax,%eax
 2d5:	74 25                	je     2fc <thread_create+0x3c>
    return -1;
  }
 ...
 2d9:	81 e2 ff 0f 00 00    	and    $0xfff,%edx
 2df:	74 07                	je     2e8 <thread_create+0x28>
    stack = stack + (PGSIZE - (uint)stack % PGSIZE);
 2e1:	29 d0                	sub    %edx,%eax
 2e3:	05 00 10 00 00       	add    $0x1000,%eax
 ...
 2f2:	e8 3d 01 00 00       	call   434 <clone>
...
int thread_join() {
 317:	83 ec 20             	sub    $0x20,%esp
  int childpid = join(&stack);
 31a:	50                   	push   %eax
 31b:	e8 1c 01 00 00       	call   43c <join>
 320:	89 c3                	mov    %eax,%ebx
  free(stack);
 322:	58                   	pop    %eax
 323:	ff 75 f4             	push   -0xc(%ebp)
 326:	e8 75 03 00 00       	call   6a0 <free>
  return childpid;
}
...
void lock_acquire(lock_t *lock) {
 ...
 366:	8b 02                	mov    (%edx),%eax
 368:	f0 0f c1 02          	lock xadd %eax,(%edx)
  int myturn = FetchAndAdd(&lock->ticket, lock->ticket);
  while (lock->turn != myturn)  ; // spin
 36c:	8b 52 04             	mov    0x4(%edx),%edx
 36f:	90                   	nop
 370:	39 c2                	cmp    %eax,%edx
 372:	75 fc                	jne    370 <lock_acquire+0x10>
}
 374:	5d                   	pop    %ebp
 375:	c3                   	ret    
...
void lock_release(lock_t *lock) {
 ...
 386:	83 40 04 01          	addl   $0x1,0x4(%eax)
 38a:	5d                   	pop    %ebp
 38b:	c3                   	ret    
 ...
 45c:	89 d1                	mov    %edx,%ecx
{
 ...
 4ce:	56                   	push   %esi
 4cf:	57                   	push   %edi
 4d0:	e8 df fe ff ff       	call   3b4 <write>
  while(--i >= 0)
 ...
 509:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 545:	57                   	push   %edi
 546:	56                   	push   %esi
 547:	e8 68 fe ff ff       	call   3b4 <write>
 ...
 59e:	e8 11 fe ff ff       	call   3b4 <write>
        putc(fd, c);
 ...
 5af:	57                   	push   %edi
 5b0:	56                   	push   %esi
 5b1:	e8 fe fd ff ff       	call   3b4 <write>
        putc(fd, c);
 ...
 61b:	57                   	push   %edi
 61c:	56                   	push   %esi
 61d:	e8 92 fd ff ff       	call   3b4 <write>
        while(*s != 0){
 ...
 65c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 65f:	e8 50 fd ff ff       	call   3b4 <write>
        ap++;
...
free(void *ap)
{
 ...
 6a1:	a1 f0 0b 00 00       	mov    0xbf0,%eax
{
 ...
 6e1:	5b                   	pop    %ebx
  freep = p;
 6e2:	89 15 f0 0b 00 00    	mov    %edx,0xbf0
}
 6e8:	5e                   	pop    %esi
 6e9:	5f                   	pop    %edi
 6ea:	5d                   	pop    %ebp
 ...
 719:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 71c:	89 15 f0 0b 00 00    	mov    %edx,0xbf0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 739:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 73c:	8b 3d f0 0b 00 00    	mov    0xbf0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 77f:	73 4f                	jae    7d0 <malloc+0xa0>
    ...
    if(p == freep)
 781:	8b 3d f0 0b 00 00    	mov    0xbf0,%edi
 ...
 793:	e8 84 fc ff ff       	call   41c <sbrk>
  if(p == (char*)-1)
 ...
 7aa:	e8 f1 fe ff ff       	call   6a0 <free>
  return freep;
 7af:	8b 15 f0 0b 00 00    	mov    0xbf0,%edx
 ...
 7dc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7df:	89 15 f0 0b 00 00    	mov    %edx,0xbf0
}
 ...
 7ef:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7f0:	c7 05 f0 0b 00 00 f4 	movl   $0xbf4,0xbf0
 7f7:	0b 00 00 
    base.s.size = 0;
 7fa:	bf f4 0b 00 00       	mov    $0xbf4,%edi
    base.s.ptr = freep = prevp = &base;
 7ff:	c7 05 f4 0b 00 00 f4 	movl   $0xbf4,0xbf4
 806:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
