...
main(int argc, char *argv[])
{
  ...
  11:	83 ec 28             	sub    $0x28,%esp
   ppid = getpid();
  14:	e8 4a 05 00 00       	call   563 <getpid>
  ...
  21:	a3 90 0d 00 00       	mov    %eax,0xd90
   void *stack, *p = malloc(PGSIZE * 2);
  26:	e8 55 08 00 00       	call   880 <malloc>
   assert(p != NULL);
  ...
  60:	c7 45 e4 18 00 00 00 	movl   $0x18,-0x1c(%ebp)
   int clone_pid = clone(worker, &arg1, &arg2, stack);
  67:	e8 17 05 00 00       	call   583 <clone>
   assert(clone_pid > 0);
  ...
  7d:	e8 e9 04 00 00       	call   56b <sbrk>
   void **join_stack = (void**) ((uint)sbrk(0) - 4);
  82:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  89:	e8 dd 04 00 00       	call   56b <sbrk>
  8e:	89 45 d4             	mov    %eax,-0x2c(%ebp)
   assert(join((void**)((uint)join_stack + 2)) == -1);
  91:	83 e8 02             	sub    $0x2,%eax
  94:	89 04 24             	mov    %eax,(%esp)
  97:	e8 ef 04 00 00       	call   58b <join>
  9c:	83 c4 10             	add    $0x10,%esp
  9f:	83 c0 01             	add    $0x1,%eax
  a2:	0f 84 80 00 00 00    	je     128 <main+0x128>
  a8:	6a 29                	push   $0x29
  aa:	68 78 09 00 00       	push   $0x978
  af:	68 81 09 00 00       	push   $0x981
  b4:	6a 01                	push   $0x1
  b6:	e8 95 05 00 00       	call   650 <printf>
  bb:	83 c4 0c             	add    $0xc,%esp
  be:	68 30 0a 00 00       	push   $0xa30
   assert(clone_pid > 0);
  c3:	68 94 09 00 00       	push   $0x994
  c8:	6a 01                	push   $0x1
  ca:	e8 81 05 00 00       	call   650 <printf>
  cf:	5a                   	pop    %edx
  d0:	59                   	pop    %ecx
  d1:	68 a8 09 00 00       	push   $0x9a8
  d6:	6a 01                	push   $0x1
  d8:	e8 73 05 00 00       	call   650 <printf>
  dd:	5b                   	pop    %ebx
  de:	ff 35 90 0d 00 00    	push   0xd90
  e4:	e8 2a 04 00 00       	call   513 <kill>
  e9:	e8 f5 03 00 00       	call   4e3 <exit>
  ee:	6a 25                	push   $0x25
  f0:	68 78 09 00 00       	push   $0x978
  f5:	68 81 09 00 00       	push   $0x981
  fa:	6a 01                	push   $0x1
  fc:	e8 4f 05 00 00       	call   650 <printf>
 101:	83 c4 0c             	add    $0xc,%esp
 104:	68 d6 09 00 00       	push   $0x9d6
 109:	eb b8                	jmp    c3 <main+0xc3>
   assert(p != NULL);
 10b:	6a 1d                	push   $0x1d
 10d:	68 78 09 00 00       	push   $0x978
 112:	68 81 09 00 00       	push   $0x981
 117:	6a 01                	push   $0x1
 119:	e8 32 05 00 00       	call   650 <printf>
 11e:	83 c4 0c             	add    $0xc,%esp
 121:	68 cc 09 00 00       	push   $0x9cc
 ...
 12e:	83 e8 04             	sub    $0x4,%eax
   assert(join(join_stack) == clone_pid);
 131:	50                   	push   %eax
 132:	e8 54 04 00 00       	call   58b <join>
 ...
 166:	6a 2b                	push   $0x2b
 168:	68 78 09 00 00       	push   $0x978
 16d:	68 81 09 00 00       	push   $0x981
 172:	6a 01                	push   $0x1
 174:	e8 d7 04 00 00       	call   650 <printf>
 179:	83 c4 0c             	add    $0xc,%esp
 17c:	68 02 0a 00 00       	push   $0xa02
 181:	e9 3d ff ff ff       	jmp    c3 <main+0xc3>
   assert(global == 2);
 186:	83 3d 8c 0d 00 00 02 	cmpl   $0x2,0xd8c
 18d:	74 20                	je     1af <main+0x1af>
 18f:	6a 2c                	push   $0x2c
 191:	68 78 09 00 00       	push   $0x978
 196:	68 81 09 00 00       	push   $0x981
 19b:	6a 01                	push   $0x1
 19d:	e8 ae 04 00 00       	call   650 <printf>
 1a2:	83 c4 0c             	add    $0xc,%esp
 1a5:	68 17 0a 00 00       	push   $0xa17
 1aa:	e9 14 ff ff ff       	jmp    c3 <main+0xc3>

   printf(1, "TEST PASSED\n");
 1af:	50                   	push   %eax
 1b0:	50                   	push   %eax
 1b1:	68 23 0a 00 00       	push   $0xa23
 1b6:	6a 01                	push   $0x1
 1b8:	e8 93 04 00 00       	call   650 <printf>
   free(p);
 1bd:	89 1c 24             	mov    %ebx,(%esp)
 1c0:	e8 2b 06 00 00       	call   7f0 <free>
   exit();
 1c5:	e8 19 03 00 00       	call   4e3 <exit>
...
worker(void *arg1, void *arg2) {
 ...
 1e6:	75 2a                	jne    212 <worker+0x42>
   assert(global == 1);
 1e8:	83 3d 8c 0d 00 00 01 	cmpl   $0x1,0xd8c
 1ef:	0f 84 80 00 00 00    	je     275 <worker+0xa5>
 1f5:	6a 39                	push   $0x39
 1f7:	68 78 09 00 00       	push   $0x978
 1fc:	68 81 09 00 00       	push   $0x981
 201:	6a 01                	push   $0x1
 203:	e8 48 04 00 00       	call   650 <printf>
 208:	83 c4 0c             	add    $0xc,%esp
 20b:	68 c0 09 00 00       	push   $0x9c0
 210:	eb 1b                	jmp    22d <worker+0x5d>
   assert(tmp2 == 24);
 212:	6a 38                	push   $0x38
 214:	68 78 09 00 00       	push   $0x978
 219:	68 81 09 00 00       	push   $0x981
 21e:	6a 01                	push   $0x1
 220:	e8 2b 04 00 00       	call   650 <printf>
 225:	83 c4 0c             	add    $0xc,%esp
 228:	68 b5 09 00 00       	push   $0x9b5
 22d:	68 94 09 00 00       	push   $0x994
 232:	6a 01                	push   $0x1
 234:	e8 17 04 00 00       	call   650 <printf>
 239:	58                   	pop    %eax
 23a:	5a                   	pop    %edx
 23b:	68 a8 09 00 00       	push   $0x9a8
 240:	6a 01                	push   $0x1
 242:	e8 09 04 00 00       	call   650 <printf>
 247:	59                   	pop    %ecx
 248:	ff 35 90 0d 00 00    	push   0xd90
 24e:	e8 c0 02 00 00       	call   513 <kill>
 253:	e8 8b 02 00 00       	call   4e3 <exit>
   assert(tmp1 == 42);
 258:	6a 37                	push   $0x37
 25a:	68 78 09 00 00       	push   $0x978
 25f:	68 81 09 00 00       	push   $0x981
 264:	6a 01                	push   $0x1
 266:	e8 e5 03 00 00       	call   650 <printf>
 26b:	83 c4 0c             	add    $0xc,%esp
 26e:	68 89 09 00 00       	push   $0x989
 273:	eb b8                	jmp    22d <worker+0x5d>
   global++;
 275:	c7 05 8c 0d 00 00 02 	movl   $0x2,0xd8c
 27c:	00 00 00 
   exit();
 27f:	e8 5f 02 00 00       	call   4e3 <exit>
 ...
 5ac:	89 d1                	mov    %edx,%ecx
{
 ...
 5d9:	0f b6 92 bc 0a 00 00 	movzbl 0xabc(%edx),%edx
 ...
 659:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 6c9:	ff 24 85 64 0a 00 00 	jmp    *0xa64(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 7d7:	90                   	nop
          s = "(null)";
 7d8:	ba 5b 0a 00 00       	mov    $0xa5b,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 7f1:	a1 94 0d 00 00       	mov    0xd94,%eax
{
 ...
 831:	5b                   	pop    %ebx
  freep = p;
 832:	89 15 94 0d 00 00    	mov    %edx,0xd94
}
 838:	5e                   	pop    %esi
 839:	5f                   	pop    %edi
 83a:	5d                   	pop    %ebp
 ...
 869:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 86c:	89 15 94 0d 00 00    	mov    %edx,0xd94
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 889:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 88c:	8b 3d 94 0d 00 00    	mov    0xd94,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 8cf:	73 4f                	jae    920 <malloc+0xa0>
    ...
    if(p == freep)
 8d1:	8b 3d 94 0d 00 00    	mov    0xd94,%edi
 ...
 8fa:	e8 f1 fe ff ff       	call   7f0 <free>
  return freep;
 8ff:	8b 15 94 0d 00 00    	mov    0xd94,%edx
 ...
 92c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 92f:	89 15 94 0d 00 00    	mov    %edx,0xd94
}
 ...
 93f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 940:	c7 05 94 0d 00 00 98 	movl   $0xd98,0xd94
 947:	0d 00 00 
    base.s.size = 0;
 94a:	bf 98 0d 00 00       	mov    $0xd98,%edi
    base.s.ptr = freep = prevp = &base;
 94f:	c7 05 98 0d 00 00 98 	movl   $0xd98,0xd98
 956:	0d 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 959:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 95b:	c7 05 9c 0d 00 00 00 	movl   $0x0,0xd9c
 962:	00 00 00 
    if(p->s.size >= nunits){
