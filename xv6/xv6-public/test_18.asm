...
main(int argc, char *argv[])
{
   ...
   e:	51                   	push   %ecx
   ppid = getpid();
   f:	e8 c2 05 00 00       	call   5d6 <getpid>

   lock_init(&lock);
  14:	83 ec 0c             	sub    $0xc,%esp
  17:	68 88 0e 00 00       	push   $0xe88
   ppid = getpid();
  ...
  26:	a1 84 0e 00 00       	mov    0xe84,%eax
  ...
  40:	a1 84 0e 00 00       	mov    0xe84,%eax
  ...
  a0:	e8 e1 04 00 00       	call   586 <kill>
  a5:	e8 ac 04 00 00       	call   556 <exit>
   for (i = 0; i < num_threads; i++) {
  ...
  b8:	a1 84 0e 00 00       	mov    0xe84,%eax
 ...
 11d:	e8 9e 05 00 00       	call   6c0 <printf>
   exit();
 122:	e8 2f 04 00 00       	call   556 <exit>
...
worker(void *arg1, void *arg2) {
 ...
 1eb:	e8 96 03 00 00       	call   586 <kill>
 1f0:	e8 61 03 00 00       	call   556 <exit>
    assert(nested_thread_pid > 0);
 1f5:	6a 47                	push   $0x47
