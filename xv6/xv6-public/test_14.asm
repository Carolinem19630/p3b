...
main(int argc, char *argv[])
{
   ...
   ppid = getpid();
  12:	e8 2f 05 00 00       	call   546 <getpid>
  ...
  1a:	c7 45 f0 2a 00 00 00 	movl   $0x2a,-0x10(%ebp)
   ppid = getpid();
  21:	a3 cc 0d 00 00       	mov    %eax,0xdcc
   int thread_pid = thread_create(worker, &arg1, &arg2);
  ...
  4f:	75 2a                	jne    7b <main+0x7b>
   assert(global == 2);
  51:	83 3d c8 0d 00 00 02 	cmpl   $0x2,0xdc8
  ...
  b0:	5b                   	pop    %ebx
  b1:	ff 35 cc 0d 00 00    	push   0xdcc
  b7:	e8 3a 04 00 00       	call   4f6 <kill>
  bc:	e8 05 04 00 00       	call   4c6 <exit>
   assert(thread_pid > 0);
  c1:	6a 1e                	push   $0x1e
  ...
  e7:	e8 44 05 00 00       	call   630 <printf>
   exit();
  ec:	e8 d5 03 00 00       	call   4c6 <exit>
  f1:	66 90                	xchg   %ax,%ax
  f3:	66 90                	xchg   %ax,%ax
  f5:	66 90                	xchg   %ax,%ax
  f7:	66 90                	xchg   %ax,%ax
...
worker(void *arg1, void *arg2) {
 ...
 116:	75 78                	jne    190 <worker+0x90>
   assert(global == 1);
 118:	83 3d c8 0d 00 00 01 	cmpl   $0x1,0xdc8
 11f:	75 52                	jne    173 <worker+0x73>
   global++;
 121:	c7 05 c8 0d 00 00 02 	movl   $0x2,0xdc8
 128:	00 00 00 
   // no exit() in thread
}
 12b:	c9                   	leave  
 ...
 162:	59                   	pop    %ecx
 163:	ff 35 cc 0d 00 00    	push   0xdcc
 169:	e8 88 03 00 00       	call   4f6 <kill>
 16e:	e8 53 03 00 00       	call   4c6 <exit>
   assert(global == 1);
 173:	6a 2e                	push   $0x2e
...
free(void *ap)
{
 ...
 7d1:	a1 d0 0d 00 00       	mov    0xdd0,%eax
{
 ...
 811:	5b                   	pop    %ebx
  freep = p;
 812:	89 15 d0 0d 00 00    	mov    %edx,0xdd0
}
 818:	5e                   	pop    %esi
 819:	5f                   	pop    %edi
 81a:	5d                   	pop    %ebp
 ...
 849:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 84c:	89 15 d0 0d 00 00    	mov    %edx,0xdd0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 869:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 86c:	8b 3d d0 0d 00 00    	mov    0xdd0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 8af:	73 4f                	jae    900 <malloc+0xa0>
    ...
    if(p == freep)
 8b1:	8b 3d d0 0d 00 00    	mov    0xdd0,%edi
 ...
 8da:	e8 f1 fe ff ff       	call   7d0 <free>
  return freep;
 8df:	8b 15 d0 0d 00 00    	mov    0xdd0,%edx
 ...
 90c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 90f:	89 15 d0 0d 00 00    	mov    %edx,0xdd0
}
 ...
 91f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 920:	c7 05 d0 0d 00 00 d4 	movl   $0xdd4,0xdd0
 927:	0d 00 00 
    base.s.size = 0;
 92a:	bf d4 0d 00 00       	mov    $0xdd4,%edi
    base.s.ptr = freep = prevp = &base;
 92f:	c7 05 d4 0d 00 00 d4 	movl   $0xdd4,0xdd4
 936:	0d 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 939:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 93b:	c7 05 d8 0d 00 00 00 	movl   $0x0,0xdd8
 942:	00 00 00 
    if(p->s.size >= nunits){
