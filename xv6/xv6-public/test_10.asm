...
main(int argc, char *argv[])
{
   ...
   ppid = getpid();
  12:	e8 3f 05 00 00       	call   556 <getpid>
  ...
  b7:	e8 4a 04 00 00       	call   506 <kill>
  bc:	e8 15 04 00 00       	call   4d6 <exit>
   assert(thread_pid > 0);
  c1:	6a 1f                	push   $0x1f
  ...
  e7:	e8 54 05 00 00       	call   640 <printf>
   exit();
  ec:	e8 e5 03 00 00       	call   4d6 <exit>
  f1:	66 90                	xchg   %ax,%ax
  f3:	66 90                	xchg   %ax,%ax
  f5:	66 90                	xchg   %ax,%ax
  f7:	66 90                	xchg   %ax,%ax
...
worker(void *arg1, void *arg2) {
 ...
 177:	59                   	pop    %ecx
 178:	ff 35 dc 0d 00 00    	push   0xddc
 17e:	e8 83 03 00 00       	call   506 <kill>
 183:	e8 4e 03 00 00       	call   4d6 <exit>
   assert(arg1_int == 35);
 188:	6a 2d                	push   $0x2d
 ...
 1a3:	eb b8                	jmp    15d <worker+0x5d>
   global++;
 1a5:	c7 05 d8 0d 00 00 02 	movl   $0x2,0xdd8
 1ac:	00 00 00 
   exit();
 1af:	e8 22 03 00 00       	call   4d6 <exit>
 ...
 2e9:	31 db                	xor    %ebx,%ebx
{
 ...
 2f5:	57                   	push   %edi
 2f6:	6a 00                	push   $0x0
 2f8:	e8 f1 01 00 00       	call   4ee <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 35d:	e8 b4 01 00 00       	call   516 <open>
  if(fd < 0)
 ...
 371:	50                   	push   %eax
 372:	e8 b7 01 00 00       	call   52e <fstat>
  close(fd);
 377:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 37a:	89 c6                	mov    %eax,%esi
  close(fd);
 37c:	e8 7d 01 00 00       	call   4fe <close>
  return r;
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2) {
 ...
 425:	74 25                	je     44c <thread_create+0x3c>
    return -1;
  }

  // stack - page aligned
  if((uint)stack % PGSIZE)
 427:	89 c2                	mov    %eax,%edx
 429:	81 e2 ff 0f 00 00    	and    $0xfff,%edx
 42f:	74 07                	je     438 <thread_create+0x28>
    stack = stack + (PGSIZE - (uint)stack % PGSIZE);
 431:	29 d0                	sub    %edx,%eax
 433:	05 00 10 00 00       	add    $0x1000,%eax

  int childPid = clone(start_routine, arg1, arg2, stack);
 438:	50                   	push   %eax
 439:	ff 75 10             	push   0x10(%ebp)
 43c:	ff 75 0c             	push   0xc(%ebp)
 43f:	ff 75 08             	push   0x8(%ebp)
 442:	e8 2f 01 00 00       	call   576 <clone>
...
int thread_join() {
 467:	83 ec 20             	sub    $0x20,%esp
  int childpid = join(&stack);
 46a:	50                   	push   %eax
 46b:	e8 0e 01 00 00       	call   57e <join>
 470:	89 c3                	mov    %eax,%ebx
  free(stack);
 472:	58                   	pop    %eax
 473:	ff 75 f4             	push   -0xc(%ebp)
 476:	e8 65 03 00 00       	call   7e0 <free>
  return childpid;
}
