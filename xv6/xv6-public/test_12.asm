...
int main(int argc, char *argv[])
{
  ...
  1c:	c7 45 e0 0b 00 00 00 	movl   $0xb,-0x20(%ebp)
   lock_init(&lock);
  23:	68 34 10 00 00       	push   $0x1034
   ppid = getpid();
  28:	a3 44 10 00 00       	mov    %eax,0x1044
   int arg1 = 11, arg2 = 22;
  2d:	c7 45 e4 16 00 00 00 	movl   $0x16,-0x1c(%ebp)
   lock_init(&lock);
  34:	e8 77 06 00 00       	call   6b0 <lock_init>
   lock_init(&lock2);
  39:	c7 04 24 2c 10 00 00 	movl   $0x102c,(%esp)
  40:	e8 6b 06 00 00       	call   6b0 <lock_init>
   lock_acquire(&lock);
  45:	c7 04 24 34 10 00 00 	movl   $0x1034,(%esp)
  4c:	e8 7f 06 00 00       	call   6d0 <lock_acquire>
   lock_acquire(&lock2);
  51:	c7 04 24 2c 10 00 00 	movl   $0x102c,(%esp)
  58:	e8 73 06 00 00       	call   6d0 <lock_acquire>

   for (int i = 0; i < num_threads; i++) {
  5d:	8b 35 28 10 00 00    	mov    0x1028,%esi
  ...
  7b:	39 1d 28 10 00 00    	cmp    %ebx,0x1028
  ...
  a0:	68 a2 0b 00 00       	push   $0xba2
  a5:	6a 01                	push   $0x1
  a7:	e8 c4 07 00 00       	call   870 <printf>
  ac:	83 c4 0c             	add    $0xc,%esp
  af:	68 e9 0b 00 00       	push   $0xbe9
   }
   lock_release(&lock2);
   ...
   for (int i = 0; i < num_threads; i++) {
      ...
      assert(join_pid > 0);
  b4:	68 c8 0b 00 00       	push   $0xbc8
  b9:	6a 01                	push   $0x1
  bb:	e8 b0 07 00 00       	call   870 <printf>
  c0:	5a                   	pop    %edx
  c1:	59                   	pop    %ecx
  c2:	68 dc 0b 00 00       	push   $0xbdc
  c7:	6a 01                	push   $0x1
  c9:	e8 a2 07 00 00       	call   870 <printf>
  ce:	5b                   	pop    %ebx
  cf:	ff 35 44 10 00 00    	push   0x1044
  ...
  e9:	83 c4 10             	add    $0x10,%esp
   size = (unsigned int)sbrk(0);
  ec:	a3 3c 10 00 00       	mov    %eax,0x103c
   while (global < num_threads) {
  f1:	a1 28 10 00 00       	mov    0x1028,%eax
  f6:	39 05 40 10 00 00    	cmp    %eax,0x1040
  fc:	7d 37                	jge    135 <main+0x135>
  fe:	66 90                	xchg   %ax,%ax
      lock_release(&lock);
 100:	83 ec 0c             	sub    $0xc,%esp
 103:	68 34 10 00 00       	push   $0x1034
 108:	e8 e3 05 00 00       	call   6f0 <lock_release>
      sleep(100);
 10d:	c7 04 24 64 00 00 00 	movl   $0x64,(%esp)
 114:	e8 7b 06 00 00       	call   794 <sleep>
      lock_acquire(&lock);
 119:	c7 04 24 34 10 00 00 	movl   $0x1034,(%esp)
 120:	e8 ab 05 00 00       	call   6d0 <lock_acquire>
   while (global < num_threads) {
 125:	a1 28 10 00 00       	mov    0x1028,%eax
 12a:	83 c4 10             	add    $0x10,%esp
 12d:	39 05 40 10 00 00    	cmp    %eax,0x1040
 133:	7c cb                	jl     100 <main+0x100>
   global = 0;
 135:	c7 05 40 10 00 00 00 	movl   $0x0,0x1040
 13c:	00 00 00 
   sbrk(10000);
 ...
 1db:	39 1d 28 10 00 00    	cmp    %ebx,0x1028
 ...
 1f3:	68 a2 0b 00 00       	push   $0xba2
 1f8:	6a 01                	push   $0x1
 1fa:	e8 71 06 00 00       	call   870 <printf>
 1ff:	83 c4 0c             	add    $0xc,%esp
 202:	68 f8 0b 00 00       	push   $0xbf8
...
void worker(void *arg1, void *arg2) {
 ...
 24e:	68 a2 0b 00 00       	push   $0xba2
 253:	6a 01                	push   $0x1
 255:	e8 16 06 00 00       	call   870 <printf>
 25a:	83 c4 0c             	add    $0xc,%esp
 25d:	68 aa 0b 00 00       	push   $0xbaa
 262:	68 c8 0b 00 00       	push   $0xbc8
 267:	6a 01                	push   $0x1
 269:	e8 02 06 00 00       	call   870 <printf>
 26e:	58                   	pop    %eax
 26f:	5a                   	pop    %edx
 270:	68 dc 0b 00 00       	push   $0xbdc
 275:	6a 01                	push   $0x1
 277:	e8 f4 05 00 00       	call   870 <printf>
 27c:	59                   	pop    %ecx
 27d:	ff 35 44 10 00 00    	push   0x1044
 283:	e8 ac 04 00 00       	call   734 <kill>
 288:	e8 77 04 00 00       	call   704 <exit>
   lock_release(&lock);
 28d:	83 ec 0c             	sub    $0xc,%esp
   global++;
 290:	83 05 40 10 00 00 01 	addl   $0x1,0x1040
   lock_release(&lock);
 297:	68 34 10 00 00       	push   $0x1034
 29c:	e8 4f 04 00 00       	call   6f0 <lock_release>
   lock_acquire(&lock2);
 2a1:	c7 04 24 2c 10 00 00 	movl   $0x102c,(%esp)
 ...
 2bc:	3b 05 3c 10 00 00    	cmp    0x103c,%eax
 ...
 2c8:	83 ec 0c             	sub    $0xc,%esp
   global++;
 2cb:	83 05 40 10 00 00 01 	addl   $0x1,0x1040
   sbrk(10000);
 ...
 2e3:	e8 a4 04 00 00       	call   78c <sbrk>
   lock_release(&lock2);
 2e8:	c7 04 24 2c 10 00 00 	movl   $0x102c,(%esp)
   size = (unsigned int)sbrk(0);
 2ef:	a3 3c 10 00 00       	mov    %eax,0x103c
   lock_release(&lock2);
 ...
 879:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 9f7:	90                   	nop
          s = "(null)";
 9f8:	ba 30 0c 00 00       	mov    $0xc30,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 a11:	a1 48 10 00 00       	mov    0x1048,%eax
{
 ...
 a51:	5b                   	pop    %ebx
  freep = p;
 a52:	89 15 48 10 00 00    	mov    %edx,0x1048
}
 a58:	5e                   	pop    %esi
 a59:	5f                   	pop    %edi
 a5a:	5d                   	pop    %ebp
 ...
 a89:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 a8c:	89 15 48 10 00 00    	mov    %edx,0x1048
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 aa9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 aac:	8b 3d 48 10 00 00    	mov    0x1048,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 aef:	73 4f                	jae    b40 <malloc+0xa0>
    ...
    if(p == freep)
 af1:	8b 3d 48 10 00 00    	mov    0x1048,%edi
 ...
 b1a:	e8 f1 fe ff ff       	call   a10 <free>
  return freep;
 b1f:	8b 15 48 10 00 00    	mov    0x1048,%edx
 ...
 b4c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 b4f:	89 15 48 10 00 00    	mov    %edx,0x1048
}
 ...
 b5f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 b60:	c7 05 48 10 00 00 4c 	movl   $0x104c,0x1048
 b67:	10 00 00 
    base.s.size = 0;
 b6a:	bf 4c 10 00 00       	mov    $0x104c,%edi
    base.s.ptr = freep = prevp = &base;
 b6f:	c7 05 4c 10 00 00 4c 	movl   $0x104c,0x104c
 b76:	10 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 b79:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 b7b:	c7 05 50 10 00 00 00 	movl   $0x0,0x1050
 b82:	00 00 00 
    if(p->s.size >= nunits){
