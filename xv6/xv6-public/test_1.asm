...
main(int argc, char *argv[])
{
  ...
  10:	83 ec 1c             	sub    $0x1c,%esp
   ppid = getpid();
  13:	e8 5b 04 00 00       	call   473 <getpid>
  ...
  20:	a3 30 0c 00 00       	mov    %eax,0xc30
   void *stack, *p = malloc(PGSIZE*2);
  25:	e8 66 07 00 00       	call   790 <malloc>
   assert(p != NULL);
  ...
  4f:	e8 3f 04 00 00       	call   493 <clone>
   assert(clone_pid > 0);
  ...
  61:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
   while(global != 5);
  68:	8b 15 2c 0c 00 00    	mov    0xc2c,%edx
  6e:	83 fa 05             	cmp    $0x5,%edx
  71:	75 f5                	jne    68 <main+0x68>
   printf(1, "TEST PASSED\n");
  73:	50                   	push   %eax
  74:	50                   	push   %eax
  75:	68 de 08 00 00       	push   $0x8de
  7a:	6a 01                	push   $0x1
  7c:	e8 df 04 00 00       	call   560 <printf>
   
   void *join_stack;
   int join_pid = join(&join_stack);
  81:	8d 45 e4             	lea    -0x1c(%ebp),%eax
  84:	89 04 24             	mov    %eax,(%esp)
  87:	e8 0f 04 00 00       	call   49b <join>
   assert(join_pid == clone_pid);
  8c:	83 c4 10             	add    $0x10,%esp
  8f:	39 c6                	cmp    %eax,%esi
  91:	74 52                	je     e5 <main+0xe5>
  93:	6a 29                	push   $0x29
  95:	68 88 08 00 00       	push   $0x888
  9a:	68 91 08 00 00       	push   $0x891
  9f:	6a 01                	push   $0x1
  a1:	e8 ba 04 00 00       	call   560 <printf>
  a6:	83 c4 0c             	add    $0xc,%esp
  a9:	68 eb 08 00 00       	push   $0x8eb
   assert(clone_pid > 0);
  ae:	68 a5 08 00 00       	push   $0x8a5
  b3:	6a 01                	push   $0x1
  b5:	e8 a6 04 00 00       	call   560 <printf>
  ba:	5a                   	pop    %edx
  bb:	59                   	pop    %ecx
  bc:	68 b9 08 00 00       	push   $0x8b9
  c1:	6a 01                	push   $0x1
  c3:	e8 98 04 00 00       	call   560 <printf>
  c8:	5b                   	pop    %ebx
  c9:	ff 35 30 0c 00 00    	push   0xc30
  cf:	e8 4f 03 00 00       	call   423 <kill>
  d4:	e8 1a 03 00 00       	call   3f3 <exit>
     stack = p + (PGSIZE - (uint)p % PGSIZE);
  ...
  e8:	53                   	push   %ebx
  e9:	e8 12 06 00 00       	call   700 <free>
   exit();
  ee:	e8 00 03 00 00       	call   3f3 <exit>
   assert(clone_pid > 0);
  f3:	6a 23                	push   $0x23
  f5:	68 88 08 00 00       	push   $0x888
  fa:	68 91 08 00 00       	push   $0x891
  ff:	6a 01                	push   $0x1
 101:	e8 5a 04 00 00       	call   560 <printf>
 106:	83 c4 0c             	add    $0xc,%esp
 109:	68 d0 08 00 00       	push   $0x8d0
 10e:	eb 9e                	jmp    ae <main+0xae>
   assert(p != NULL);
 110:	6a 1c                	push   $0x1c
 112:	68 88 08 00 00       	push   $0x888
 117:	68 91 08 00 00       	push   $0x891
 11c:	6a 01                	push   $0x1
 11e:	e8 3d 04 00 00       	call   560 <printf>
 123:	83 c4 0c             	add    $0xc,%esp
 126:	68 c6 08 00 00       	push   $0x8c6
...
worker(void *arg1, void *arg2) {
 ...
 133:	83 ec 08             	sub    $0x8,%esp
   assert(global == 1);
 136:	a1 2c 0c 00 00       	mov    0xc2c,%eax
 13b:	83 f8 01             	cmp    $0x1,%eax
 13e:	74 46                	je     186 <worker+0x56>
 140:	6a 30                	push   $0x30
 142:	68 88 08 00 00       	push   $0x888
 147:	68 91 08 00 00       	push   $0x891
 14c:	6a 01                	push   $0x1
 14e:	e8 0d 04 00 00       	call   560 <printf>
 153:	83 c4 0c             	add    $0xc,%esp
 156:	68 99 08 00 00       	push   $0x899
 15b:	68 a5 08 00 00       	push   $0x8a5
 160:	6a 01                	push   $0x1
 162:	e8 f9 03 00 00       	call   560 <printf>
 167:	58                   	pop    %eax
 168:	5a                   	pop    %edx
 169:	68 b9 08 00 00       	push   $0x8b9
 16e:	6a 01                	push   $0x1
 170:	e8 eb 03 00 00       	call   560 <printf>
 175:	59                   	pop    %ecx
 176:	ff 35 30 0c 00 00    	push   0xc30
 17c:	e8 a2 02 00 00       	call   423 <kill>
 181:	e8 6d 02 00 00       	call   3f3 <exit>
   global = 5;
 186:	c7 05 2c 0c 00 00 05 	movl   $0x5,0xc2c
 18d:	00 00 00 
   exit();
 190:	e8 5e 02 00 00       	call   3f3 <exit>
 ...
 4bc:	89 d1                	mov    %edx,%ecx
{
 ...
 4e9:	0f b6 92 60 09 00 00 	movzbl 0x960(%edx),%edx
 ...
 569:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5d9:	ff 24 85 08 09 00 00 	jmp    *0x908(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 6e7:	90                   	nop
          s = "(null)";
 6e8:	ba 01 09 00 00       	mov    $0x901,%edx
        while(*s != 0){
 ...
 701:	a1 34 0c 00 00       	mov    0xc34,%eax
{
 ...
 741:	5b                   	pop    %ebx
  freep = p;
 742:	89 15 34 0c 00 00    	mov    %edx,0xc34
}
 748:	5e                   	pop    %esi
 749:	5f                   	pop    %edi
 74a:	5d                   	pop    %ebp
 ...
 779:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 77c:	89 15 34 0c 00 00    	mov    %edx,0xc34
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 799:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 79c:	8b 3d 34 0c 00 00    	mov    0xc34,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7df:	73 4f                	jae    830 <malloc+0xa0>
    ...
    if(p == freep)
 7e1:	8b 3d 34 0c 00 00    	mov    0xc34,%edi
 ...
 80a:	e8 f1 fe ff ff       	call   700 <free>
  return freep;
 80f:	8b 15 34 0c 00 00    	mov    0xc34,%edx
 ...
 84f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 850:	c7 05 34 0c 00 00 38 	movl   $0xc38,0xc34
 857:	0c 00 00 
    base.s.size = 0;
 85a:	bf 38 0c 00 00       	mov    $0xc38,%edi
    base.s.ptr = freep = prevp = &base;
 85f:	c7 05 38 0c 00 00 38 	movl   $0xc38,0xc38
 866:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 869:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 86b:	c7 05 3c 0c 00 00 00 	movl   $0x0,0xc3c
 872:	00 00 00 
    if(p->s.size >= nunits){
